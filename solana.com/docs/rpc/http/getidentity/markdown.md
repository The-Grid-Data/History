...
# [getIdentity RPC Method](/docs/rpc/http/getidentity)
...
[Previous«
getHighestSnapshotSlot](/docs/rpc/http/gethighestsnapshotslot)[NextgetInflationGovernor
»](/docs/rpc/http/getinflationgovernor)
