...
# [requestAirdrop RPC Method](/docs/rpc/http/requestairdrop)
...
[Previous«
minimumLedgerSlot](/docs/rpc/http/minimumledgerslot)[NextsendTransaction
»](/docs/rpc/http/sendtransaction)
