...
# [getFeeForMessage RPC Method](/docs/rpc/http/getfeeformessage)
...
[Previous«
getEpochSchedule](/docs/rpc/http/getepochschedule)[NextgetFirstAvailableBlock
»](/docs/rpc/http/getfirstavailableblock)
