...
# [getTokenAccountBalance RPC Method](/docs/rpc/http/gettokenaccountbalance)
...
[Previous« getSupply](/docs/rpc/http/getsupply)[NextgetTokenAccountsByDelegate
»](/docs/rpc/http/gettokenaccountsbydelegate)
