...
# [getHighestSnapshotSlot RPC Method](/docs/rpc/http/gethighestsnapshotslot)
...
[Previous« getHealth](/docs/rpc/http/gethealth)[NextgetIdentity
»](/docs/rpc/http/getidentity)
