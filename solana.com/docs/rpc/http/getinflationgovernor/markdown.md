...
# [getInflationGovernor RPC Method](/docs/rpc/http/getinflationgovernor)
...
[Previous« getIdentity](/docs/rpc/http/getidentity)[NextgetInflationRate
»](/docs/rpc/http/getinflationrate)
