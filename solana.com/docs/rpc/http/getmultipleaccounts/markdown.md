...
# [getMultipleAccounts RPC Method](/docs/rpc/http/getmultipleaccounts)
...
[Previous«
getMinimumBalanceForRentExemption](/docs/rpc/http/getminimumbalanceforrentexemption)[NextgetProgramAccounts
»](/docs/rpc/http/getprogramaccounts)
