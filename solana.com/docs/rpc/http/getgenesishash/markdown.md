...
# [getGenesisHash RPC Method](/docs/rpc/http/getgenesishash)
...
[Previous«
getFirstAvailableBlock](/docs/rpc/http/getfirstavailableblock)[NextgetHealth
»](/docs/rpc/http/gethealth)
