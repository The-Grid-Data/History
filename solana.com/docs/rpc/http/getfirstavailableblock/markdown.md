...
# [getFirstAvailableBlock RPC Method](/docs/rpc/http/getfirstavailableblock)
...
[Previous«
getFeeForMessage](/docs/rpc/http/getfeeformessage)[NextgetGenesisHash
»](/docs/rpc/http/getgenesishash)
