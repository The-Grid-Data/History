...
# [minimumLedgerSlot RPC Method](/docs/rpc/http/minimumledgerslot)
...
[Previous«
isBlockhashValid](/docs/rpc/http/isblockhashvalid)[NextrequestAirdrop
»](/docs/rpc/http/requestairdrop)
