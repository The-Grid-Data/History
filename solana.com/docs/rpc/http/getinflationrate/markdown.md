...
# [getInflationRate RPC Method](/docs/rpc/http/getinflationrate)
...
[Previous«
getInflationGovernor](/docs/rpc/http/getinflationgovernor)[NextgetInflationReward
»](/docs/rpc/http/getinflationreward)
