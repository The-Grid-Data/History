...
# [getStakeActivation RPC Method](/docs/rpc/http/getstakeactivation)
...
[Previous«
getSlotLeaders](/docs/rpc/http/getslotleaders)[NextgetStakeMinimumDelegation
»](/docs/rpc/http/getstakeminimumdelegation)
