...
# [getBlockHeight RPC Method](/docs/rpc/http/getblockheight)
...
[Previous«
getBlockCommitment](/docs/rpc/http/getblockcommitment)[NextgetBlockProduction
»](/docs/rpc/http/getblockproduction)
