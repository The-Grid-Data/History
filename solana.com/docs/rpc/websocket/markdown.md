...
##### Table of Contents
  ...
  * [RPC PubSub WebSocket Endpoint](/docs/rpc/websocket#rpc-pubsub-websocket-endpoint)

[Scroll to Top](/docs/rpc/websocket#)
...
# [Solana RPC Websocket Methods](/docs/rpc/websocket)

After connecting to the RPC PubSub websocket at `ws://<ADDRESS>/`:

  * Submit subscription requests to the websocket using the methods below
  * Multiple subscriptions may be active at once
  * Many subscriptions take the optional [`commitment` parameter](/docs/rpc#configuring-state-commitment), defining how finalized a change should be to trigger a notification. For subscriptions, if commitment is unspecified, the default value is `finalized`.
...
[Previous«
simulateTransaction](/docs/rpc/http/simulatetransaction)[NextaccountSubscribe
»](/docs/rpc/websocket/accountsubscribe)
