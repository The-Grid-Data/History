...
Keypairs](/developers/cookbook/wallets/generate-mnemonic)
...
[Previous« How to Validate a Public Key](/developers/cookbook/wallets/check-
publickey)[NextHow to Restore a Keypair from a Mnemonic
»](/developers/cookbook/wallets/restore-from-mnemonic)
