...
# [Wallets Explained](/developers/guides/intro/wallets-explained)

updated June 15, 2022

[intro](/developers/guides?difficulty=intro)[wallets](/developers/guides?tags=wallets)

[![Wallets
Explained](https://solana.com/_next/image?url=%2Fopengraph%2Fdevelopers%2Fguides%2Fintro%2Fwallets-
explained&w=3840&q=75)](/developers/guides/intro/wallets-explained)
...
![A screenshot of a transaction on the solana explorer](https://solana-
...
Do you want to start building on Solana?
  ...
  * A gentle introduction to Solana: [https://solana.com/news/solana-scaffold-part-1-wallet-adapter](/news/solana-scaffold-part-1-wallet-adapter)
...
faucets)](/developers/guides/getstarted/solana-token-airdrop-and-
faucets)[NextCreating Compressed NFTs with JavaScript
»](/developers/guides/javascript/compressed-nfts)

##### Table of Contents

  * [Puzzle Piece 1: The Balance Myth](/developers/guides/intro/wallets-explained#puzzle-piece-1-the-balance-myth)
  * [Puzzle Piece 2: Blockchain](/developers/guides/intro/wallets-explained#puzzle-piece-2-blockchain)
  * [Puzzle Piece 3: Signing](/developers/guides/intro/wallets-explained#puzzle-piece-3-signing)
  * [Puzzle Piece 4: Transaction](/developers/guides/intro/wallets-explained#puzzle-piece-4-transaction)
  * [Puzzle Piece 5: Wallet Apps](/developers/guides/intro/wallets-explained#puzzle-piece-5-wallet-apps)
  * [Putting things back in order](/developers/guides/intro/wallets-explained#putting-things-back-in-order)
  * [What's Next](/developers/guides/intro/wallets-explained#what-s-next)
  * [Blockchain and blockchain](/developers/guides/intro/wallets-explained#blockchain-and-blockchain)
  * [Accounts](/developers/guides/intro/wallets-explained#accounts)
  * [Authentication](/developers/guides/intro/wallets-explained#authentication)

[Scroll to Top](/developers/guides/intro/wallets-explained#)
