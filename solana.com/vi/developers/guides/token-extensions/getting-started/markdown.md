...
# [Getting Started with Token Extensions](/vi/developers/guides/token-
extensions/getting-started)

updated 19 tháng 1, 2024
...
extensions%2Fgetting-started&w=3840&q=75)](/vi/developers/guides/token-
extensions/getting-started)
...
Tool Suite](/vi/developers/guides/getstarted/setup-local-development) to
...
Extension| CLI Flag  
---|---  
[Mint Close Authority](/vi/developers/guides/token-extensions/mint-close-
authority)| \--enable-close  
[Transfer Fees](/vi/developers/guides/token-extensions/transfer-fee)|
\--transfer-fee <basis points> <max fee>  
[Non-Transferable](/vi/developers/guides/token-extensions/non-transferable)|
\--enable-non-transferable  
[Interest-Bearing](/vi/developers/guides/token-extensions/interest-bearing-
tokens)| \--interest-rate <rate>  
[Permanent Delegate](/vi/developers/guides/token-extensions/permanent-
delegate)| \--enable-permanent-delegate  
[Transfer Hook](/vi/developers/guides/token-extensions/transfer-hook)|
\--transfer-hook <programID>  
[Metadata](/vi/developers/guides/token-extensions/metadata-pointer)|
\--enable-metadata  
[Metadata Pointer](/vi/developers/guides/token-extensions/metadata-pointer)|
...
Extension| CLI Flag  
---|---  
[Immutable Owner](/vi/developers/guides/token-extensions/immutable-owner)|
Included by default  
[Required Memo on Transfer](/vi/developers/guides/token-extensions/required-
memo)| enable-required-transfer-memos  
[CPI Guard](https://spl.solana.com/token-2022/extensions#cpi-guard)| enable-
cpi-guard  
[Default Account State](/vi/developers/guides/token-extensions/default-
...
today](/vi/developers/guides/token-extensions/metadata-pointer).
...
Extensions](/vi/developers/guides/token-extensions/dynamic-meta-data-
nft)[NextHow to use the Immutable Owner extension
»](/vi/developers/guides/token-extensions/immutable-owner)

##### Table of Contents

  * [How do I create a token with token extensions](/vi/developers/guides/token-extensions/getting-started#how-do-i-create-a-token-with-token-extensions)
  * [What extensions are compatible with each other](/vi/developers/guides/token-extensions/getting-started#what-extensions-are-compatible-with-each-other)
  * [How do I add custom logic to my tokens with token extensions](/vi/developers/guides/token-extensions/getting-started#how-do-i-add-custom-logic-to-my-tokens-with-token-extensions)
  * [Transfer Hooks](/vi/developers/guides/token-extensions/getting-started#transfer-hooks)
  * [Metadata](/vi/developers/guides/token-extensions/getting-started#metadata)
  * [How do I migrate tokens from one standard to another](/vi/developers/guides/token-extensions/getting-started#how-do-i-migrate-tokens-from-one-standard-to-another)
  * [What is the instruction layout for Token extensions](/vi/developers/guides/token-extensions/getting-started#what-is-the-instruction-layout-for-token-extensions)
  * [What is the layout of Mints and Accounts](/vi/developers/guides/token-extensions/getting-started#what-is-the-layout-of-mints-and-accounts)
  * [Where is the source code for Token extensions](/vi/developers/guides/token-extensions/getting-started#where-is-the-source-code-for-token-extensions)
  * [Has the token extensions program been audited](/vi/developers/guides/token-extensions/getting-started#has-the-token-extensions-program-been-audited)

[Scroll to Top](/vi/developers/guides/token-extensions/getting-started#)
