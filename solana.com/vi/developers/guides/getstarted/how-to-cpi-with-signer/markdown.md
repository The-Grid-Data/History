...
program](/vi/developers/guides/getstarted/how-to-cpi-with-signer)

updated 24 tháng 4, 2024

[beginner](/vi/developers/guides?difficulty=beginner)[rust](/vi/developers/guides?tags=rust)[anchor](/vi/developers/guides?tags=anchor)[cpi](/vi/developers/guides?tags=cpi)[pda](/vi/developers/guides?tags=pda)

[![How to CPI with a PDA Signer in a Solana
program](https://solana.com/_next/image?url=%2Fopengraph%2Fdevelopers%2Fguides%2Fgetstarted%2Fhow-
to-cpi-with-signer&w=3840&q=75)](/vi/developers/guides/getstarted/how-to-cpi-
with-signer)
...
Invocation (CPI)](/vi/docs/core/cpi) where the sender is a PDA that the
program must sign for.

A typical use case for this scenario is a program that manages [token
accounts](/vi/docs/core/tokens#token-account) on behalf of users. For
...
the [use of PDAs](/vi/docs/core/pda) as the owner of the protocol's token
...
browser)](/vi/developers/guides/getstarted/hello-world-in-your-
browser)[NextHow to CPI in a Solana program
»](/vi/developers/guides/getstarted/how-to-cpi)

##### Table of Contents

  * [Starter Code](/vi/developers/guides/getstarted/how-to-cpi-with-signer#starter-code)
  * [How to CPI with signers using Anchor](/vi/developers/guides/getstarted/how-to-cpi-with-signer#how-to-cpi-with-signers-using-anchor)
  * [Anchor CpiContext](/vi/developers/guides/getstarted/how-to-cpi-with-signer#anchor-cpicontext)
  * [Invoke with Crate Helper](/vi/developers/guides/getstarted/how-to-cpi-with-signer#invoke-with-crate-helper)

[Scroll to Top](/vi/developers/guides/getstarted/how-to-cpi-with-signer#)
