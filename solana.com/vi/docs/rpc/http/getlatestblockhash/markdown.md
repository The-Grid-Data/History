...
# [getLatestBlockhash RPC Method](/vi/docs/rpc/http/getlatestblockhash)
...
[getRecentBlockhash](/vi/docs/rpc/http/getrecentblockhash) for `solana-core`
v1.8 and below.
...
[Previous«
getLargestAccounts](/vi/docs/rpc/http/getlargestaccounts)[NextgetLeaderSchedule
»](/vi/docs/rpc/http/getleaderschedule)
