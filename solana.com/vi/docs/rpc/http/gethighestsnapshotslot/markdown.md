...
Method](/vi/docs/rpc/http/gethighestsnapshotslot)
...
[getSnapshotSlot](/vi/docs/rpc/http/getsnapshotslot) for `solana-core` v1.8
and below.
...
[Previous« getHealth](/vi/docs/rpc/http/gethealth)[NextgetIdentity
»](/vi/docs/rpc/http/getidentity)
