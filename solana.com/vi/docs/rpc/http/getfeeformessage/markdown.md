...
# [getFeeForMessage RPC Method](/vi/docs/rpc/http/getfeeformessage)
...
[getFees](/vi/docs/rpc/deprecated/getfees) for `solana-core` v1.8 and below.
...
[Previous«
getEpochSchedule](/vi/docs/rpc/http/getepochschedule)[NextgetFirstAvailableBlock
»](/vi/docs/rpc/http/getfirstavailableblock)
