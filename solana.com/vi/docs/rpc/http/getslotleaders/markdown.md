...
# [getSlotLeaders RPC Method](/vi/docs/rpc/http/getslotleaders)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getSlotLeaders.mdx)
...
[Previous«
getSlotLeader](/vi/docs/rpc/http/getslotleader)[NextgetStakeActivation
»](/vi/docs/rpc/http/getstakeactivation)
