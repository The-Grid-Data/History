...
# [getBlockProduction RPC Method](/vi/docs/rpc/http/getblockproduction)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getBlockProduction.mdx)
...
[Previous« getBlockHeight](/vi/docs/rpc/http/getblockheight)[NextgetBlockTime
»](/vi/docs/rpc/http/getblocktime)
