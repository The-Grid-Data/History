...
# [getIdentity RPC Method](/vi/docs/rpc/http/getidentity)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getIdentity.mdx)
...
[Previous«
getHighestSnapshotSlot](/vi/docs/rpc/http/gethighestsnapshotslot)[NextgetInflationGovernor
»](/vi/docs/rpc/http/getinflationgovernor)
