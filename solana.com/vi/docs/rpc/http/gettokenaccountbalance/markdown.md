...
Method](/vi/docs/rpc/http/gettokenaccountbalance)
...
Structure](/vi/docs/rpc/json-structures#token-balances) response from
[getBlock](/vi/docs/rpc/http/getblock) follows a similar structure.
...
[Previous«
getSupply](/vi/docs/rpc/http/getsupply)[NextgetTokenAccountsByDelegate
»](/vi/docs/rpc/http/gettokenaccountsbydelegate)
