...
# [getFeeRateGovernor RPC Method](/vi/docs/rpc/deprecated/getfeerategovernor)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/deprecated/getFeeRateGovernor.mdx)
...
The result will be an RpcResponse JSON object with `value` equal to an
...
[Previous«
getFeeCalculatorForBlockhash](/vi/docs/rpc/deprecated/getfeecalculatorforblockhash)[NextgetFees
»](/vi/docs/rpc/deprecated/getfees)
