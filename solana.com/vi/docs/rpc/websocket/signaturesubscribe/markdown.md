...
# [signatureSubscribe RPC Method](/vi/docs/rpc/websocket/signaturesubscribe)
...
(see [transaction id](/vi/docs/terminology#transaction-id) for more details).
...
[Previous«
rootUnsubscribe](/vi/docs/rpc/websocket/rootunsubscribe)[NextsignatureUnsubscribe
»](/vi/docs/rpc/websocket/signatureunsubscribe)
