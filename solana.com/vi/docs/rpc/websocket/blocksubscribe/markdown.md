...
# [blockSubscribe RPC Method](/vi/docs/rpc/websocket/blocksubscribe)
...
The notification will be an object with the following fields:
  ...
  * `block: <object|null>` \- A block object as seen in the [getBlock](/vi/docs/rpc/http/getblock) RPC HTTP method.
...
[Previous«
accountUnsubscribe](/vi/docs/rpc/websocket/accountunsubscribe)[NextblockUnsubscribe
»](/vi/docs/rpc/websocket/blockunsubscribe)
