...
# [voteUnsubscribe RPC Method](/de/docs/rpc/websocket/voteunsubscribe)
...
[Previous«
voteSubscribe](/de/docs/rpc/websocket/votesubscribe)[NextgetConfirmedBlock
»](/de/docs/rpc/deprecated/getconfirmedblock)
