...
# [getHighestSnapshotSlot RPC
Method](/de/docs/rpc/http/gethighestsnapshotslot)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getHighestSnapshotSlot.mdx)
...
[getSnapshotSlot](/de/docs/rpc/http/getsnapshotslot) for `solana-core` v1.8
and below.
...
[Previous« getHealth](/de/docs/rpc/http/gethealth)[NextgetIdentity
»](/de/docs/rpc/http/getidentity)
