...
# [getEpochInfo RPC Method](/de/docs/rpc/http/getepochinfo)
...
[Previous«
getClusterNodes](/de/docs/rpc/http/getclusternodes)[NextgetEpochSchedule
»](/de/docs/rpc/http/getepochschedule)
