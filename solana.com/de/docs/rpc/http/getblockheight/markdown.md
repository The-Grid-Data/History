...
# [getBlockHeight RPC Method](/de/docs/rpc/http/getblockheight)
...
[Previous«
getBlockCommitment](/de/docs/rpc/http/getblockcommitment)[NextgetBlockProduction
»](/de/docs/rpc/http/getblockproduction)
