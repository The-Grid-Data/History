...
# [getInflationGovernor RPC Method](/de/docs/rpc/http/getinflationgovernor)
...
[Previous« getIdentity](/de/docs/rpc/http/getidentity)[NextgetInflationRate
»](/de/docs/rpc/http/getinflationrate)
