...
# [getEpochSchedule RPC Method](/de/docs/rpc/http/getepochschedule)
...
[Previous« getEpochInfo](/de/docs/rpc/http/getepochinfo)[NextgetFeeForMessage
»](/de/docs/rpc/http/getfeeformessage)
