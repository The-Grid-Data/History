...
Method](/de/docs/rpc/http/gettokenaccountbalance)
...
Structure](/de/docs/rpc/json-structures#token-balances) response from
[getBlock](/de/docs/rpc/http/getblock) follows a similar structure.
...
[Previous«
getSupply](/de/docs/rpc/http/getsupply)[NextgetTokenAccountsByDelegate
»](/de/docs/rpc/http/gettokenaccountsbydelegate)
