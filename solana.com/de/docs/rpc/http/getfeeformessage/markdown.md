...
# [getFeeForMessage RPC Method](/de/docs/rpc/http/getfeeformessage)
...
[getFees](/de/docs/rpc/deprecated/getfees) for `solana-core` v1.8 and below.
...
[Previous«
getEpochSchedule](/de/docs/rpc/http/getepochschedule)[NextgetFirstAvailableBlock
»](/de/docs/rpc/http/getfirstavailableblock)
