...
# [getFirstAvailableBlock RPC
Method](/de/docs/rpc/http/getfirstavailableblock)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getFirstAvailableBlock.mdx)
...
[Previous«
getFeeForMessage](/de/docs/rpc/http/getfeeformessage)[NextgetGenesisHash
»](/de/docs/rpc/http/getgenesishash)
