...
# [minimumLedgerSlot RPC Method](/de/docs/rpc/http/minimumledgerslot)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/minimumLedgerSlot.mdx)
...
[Previous«
isBlockhashValid](/de/docs/rpc/http/isblockhashvalid)[NextrequestAirdrop
»](/de/docs/rpc/http/requestairdrop)
