...
# [getBlockProduction RPC Method](/de/docs/rpc/http/getblockproduction)
...
[Previous« getBlockHeight](/de/docs/rpc/http/getblockheight)[NextgetBlockTime
»](/de/docs/rpc/http/getblocktime)
