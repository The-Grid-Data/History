...
# [getVoteAccounts RPC Method](/de/docs/rpc/http/getvoteaccounts)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getVoteAccounts.mdx)
...
[Previous« getVersion](/de/docs/rpc/http/getversion)[NextisBlockhashValid
»](/de/docs/rpc/http/isblockhashvalid)
