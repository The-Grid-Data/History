...
# [getSlotLeaders RPC Method](/de/docs/rpc/http/getslotleaders)
...
[Previous«
getSlotLeader](/de/docs/rpc/http/getslotleader)[NextgetStakeActivation
»](/de/docs/rpc/http/getstakeactivation)
