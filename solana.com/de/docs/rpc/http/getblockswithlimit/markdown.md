...
# [getBlocksWithLimit RPC Method](/de/docs/rpc/http/getblockswithlimit)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getBlocksWithLimit.mdx)
...
[Previous« getBlocks](/de/docs/rpc/http/getblocks)[NextgetClusterNodes
»](/de/docs/rpc/http/getclusternodes)
