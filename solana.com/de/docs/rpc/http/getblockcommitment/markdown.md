...
# [getBlockCommitment RPC Method](/de/docs/rpc/http/getblockcommitment)
...
[Previous« getBlock](/de/docs/rpc/http/getblock)[NextgetBlockHeight
»](/de/docs/rpc/http/getblockheight)
