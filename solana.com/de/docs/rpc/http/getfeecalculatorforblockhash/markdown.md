...
# [getFeeCalculatorForBlockhash RPC
Method](/de/docs/rpc/deprecated/getfeecalculatorforblockhash)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/deprecated/getFeeCalculatorForBlockhash.mdx)

Returns the fee calculator associated with the query blockhash, or `null` if
the blockhash has expired

Deprecated Method

This method is expected to be removed in `solana-core` v2.0. Please use
[isBlockhashValid](/de/docs/rpc/http/isblockhashvalid) or
[getFeeForMessage](/de/docs/rpc/http/getfeeformessage) instead.
...
[Previous«
getConfirmedTransaction](/de/docs/rpc/deprecated/getconfirmedtransaction)[NextgetFeeRateGovernor
»](/de/docs/rpc/deprecated/getfeerategovernor)
