...
# [getStakeActivation RPC Method](/de/docs/rpc/http/getstakeactivation)
...
[Previous«
getSlotLeaders](/de/docs/rpc/http/getslotleaders)[NextgetStakeMinimumDelegation
»](/de/docs/rpc/http/getstakeminimumdelegation)
