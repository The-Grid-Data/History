...
# [requestAirdrop RPC Method](/de/docs/rpc/http/requestairdrop)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/requestAirdrop.mdx)
...
`<string>` \- Transaction Signature of the airdrop, as a base-58 encoded
string
...
[Previous«
minimumLedgerSlot](/de/docs/rpc/http/minimumledgerslot)[NextsendTransaction
»](/de/docs/rpc/http/sendtransaction)
