...
# [getGenesisHash RPC Method](/de/docs/rpc/http/getgenesishash)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getGenesisHash.mdx)
...
[Previous«
getFirstAvailableBlock](/de/docs/rpc/http/getfirstavailableblock)[NextgetHealth
»](/de/docs/rpc/http/gethealth)
