...
# [getLatestBlockhash RPC Method](/de/docs/rpc/http/getlatestblockhash)
...
[getRecentBlockhash](/de/docs/rpc/http/getrecentblockhash) for `solana-core`
v1.8 and below.
...
JSON object including:
  ...
  * `lastValidBlockHeight: <u64>` \- last [block height](/de/docs/terminology#block-height) at which the blockhash will be valid
...
[Previous«
getLargestAccounts](/de/docs/rpc/http/getlargestaccounts)[NextgetLeaderSchedule
»](/de/docs/rpc/http/getleaderschedule)
