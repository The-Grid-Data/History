...
# [getIdentity RPC Method](/de/docs/rpc/http/getidentity)
...
[Previous«
getHighestSnapshotSlot](/de/docs/rpc/http/gethighestsnapshotslot)[NextgetInflationGovernor
»](/de/docs/rpc/http/getinflationgovernor)
