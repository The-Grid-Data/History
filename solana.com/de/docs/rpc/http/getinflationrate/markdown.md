...
# [getInflationRate RPC Method](/de/docs/rpc/http/getinflationrate)
...
[Previous«
getInflationGovernor](/de/docs/rpc/http/getinflationgovernor)[NextgetInflationReward
»](/de/docs/rpc/http/getinflationreward)
