...
# [getMaxShredInsertSlot RPC Method](/de/docs/rpc/http/getmaxshredinsertslot)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getMaxShredInsertSlot.mdx)
...
[Previous«
getMaxRetransmitSlot](/de/docs/rpc/http/getmaxretransmitslot)[NextgetMinimumBalanceForRentExemption
»](/de/docs/rpc/http/getminimumbalanceforrentexemption)
