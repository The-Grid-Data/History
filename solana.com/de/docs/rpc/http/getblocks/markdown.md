...
# [getBlocks RPC Method](/de/docs/rpc/http/getblocks)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getBlocks.mdx)
...
[Previous«
getBlockTime](/de/docs/rpc/http/getblocktime)[NextgetBlocksWithLimit
»](/de/docs/rpc/http/getblockswithlimit)
