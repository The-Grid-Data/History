...
# [getHealth RPC Method](/de/docs/rpc/http/gethealth)
...
[Previous«
getGenesisHash](/de/docs/rpc/http/getgenesishash)[NextgetHighestSnapshotSlot
»](/de/docs/rpc/http/gethighestsnapshotslot)
