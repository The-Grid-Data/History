...
# [getSnapshotSlot RPC Method](/de/docs/rpc/deprecated/getsnapshotslot)
...
[getHighestSnapshotSlot](/de/docs/rpc/http/gethighestsnapshotslot) instead.
...
[Previous« getRecentBlockhash](/de/docs/rpc/deprecated/getrecentblockhash)
