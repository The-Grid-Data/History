...
# [getFees RPC Method](/de/docs/rpc/deprecated/getfees)
...
[Previous«
getFeeRateGovernor](/de/docs/rpc/deprecated/getfeerategovernor)[NextgetRecentBlockhash
»](/de/docs/rpc/deprecated/getrecentblockhash)
