...
# [getFeeRateGovernor RPC Method](/de/docs/rpc/deprecated/getfeerategovernor)
...
[Previous«
getFeeCalculatorForBlockhash](/de/docs/rpc/deprecated/getfeecalculatorforblockhash)[NextgetFees
»](/de/docs/rpc/deprecated/getfees)
