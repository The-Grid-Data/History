...
##### Table of Contents
  ...
  * [Node Setup](/de/docs/more/exchange#node-setup)
  * [Automatic Restarts and Monitoring](/de/docs/more/exchange#automatic-restarts-and-monitoring)
  * [Ledger Continuity](/de/docs/more/exchange#ledger-continuity)
  * [Minimizing Validator Port Exposure](/de/docs/more/exchange#minimizing-validator-port-exposure)
  * [Setting up Deposit Accounts](/de/docs/more/exchange#setting-up-deposit-accounts)
  * [Offline Accounts](/de/docs/more/exchange#offline-accounts)
  * [Listening for Deposits](/de/docs/more/exchange#listening-for-deposits)
  * [Versioned Transaction Migration](/de/docs/more/exchange#versioned-transaction-migration)
  * [Poll for Blocks](/de/docs/more/exchange#poll-for-blocks)
  * [Block Fetching Tips](/de/docs/more/exchange#block-fetching-tips)
  * [Address History](/de/docs/more/exchange#address-history)
  * [Sending Withdrawals](/de/docs/more/exchange#sending-withdrawals)
  * [Synchronous](/de/docs/more/exchange#synchronous)
  * [Asynchronous](/de/docs/more/exchange#asynchronous)
  * [Validating User-supplied Account Addresses for Withdrawals](/de/docs/more/exchange#validating-user-supplied-account-addresses-for-withdrawals)
  * [Minimum Deposit & Withdrawal Amounts](/de/docs/more/exchange#minimum-deposit-withdrawal-amounts)
  * [Prioritization Fees and Compute Units](/de/docs/more/exchange#prioritization-fees-and-compute-units)
  * [What is a Prioritization Fee](/de/docs/more/exchange#what-is-a-prioritization-fee)
  * [How much should the Prioritization Fee be](/de/docs/more/exchange#how-much-should-the-prioritization-fee-be)
  * [How to Implement Prioritization Fees](/de/docs/more/exchange#how-to-implement-prioritization-fees)
  * [Prioritization Fees And Durable Nonces](/de/docs/more/exchange#prioritization-fees-and-durable-nonces)
  * [Supporting the SPL Token Standard](/de/docs/more/exchange#supporting-the-spl-token-standard)
  * [Token Mints](/de/docs/more/exchange#token-mints)
  * [Installing the `spl-token` CLI Tool](/de/docs/more/exchange#installing-the-spl-token-cli-tool)
  * [Account Creation](/de/docs/more/exchange#account-creation)
  * [Checking an Account's Balance](/de/docs/more/exchange#checking-an-account-s-balance)
  * [Token Transfers](/de/docs/more/exchange#token-transfers)
  * [Depositing](/de/docs/more/exchange#depositing)
  * [Withdrawing](/de/docs/more/exchange#withdrawing)
  * [Other Considerations](/de/docs/more/exchange#other-considerations)
  * [Basic Support for the SPL Token-2022 (Token-Extensions) Standard](/de/docs/more/exchange#basic-support-for-the-spl-token-2022-token-extensions-standard)
  * [Extension-Specific Considerations](/de/docs/more/exchange#extension-specific-considerations)
  * [Testing the Integration](/de/docs/more/exchange#testing-the-integration)

[Scroll to Top](/de/docs/more/exchange#)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/more/exchange.md)

[Home](/de)>[Solana Dokumentation](/de/docs)>More Information
...
[shreds](/de/docs/terminology#shred) your node retains on disk. If you do not
...
security) are communicated via a [discord](/de/discord) channel called `#mb-
...
[rent](/de/docs/core/fees#rent) in SOL. In order to find the minimum rent-
exempt balance for your deposit accounts, query the
[`getMinimumBalanceForRentExemption`
endpoint](/de/docs/rpc/http/getminimumbalanceforrentexemption):
...
your Solana API node.
  ...
  * To identify which blocks are available, send a [`getBlocks`](/de/docs/rpc/http/getblocks) request, passing the last block you have already processed as the start-slot parameter:
...
integers.
  ...
  * For each block, request its contents with a [`getBlock`](/de/docs/rpc/http/getblock) request:
...
[lamports](/de/docs/terminology#lamport), indexed to the `accountKeys` list.
...
period of time.
  ...
  * Send a [`getSignaturesForAddress`](/de/docs/rpc/http/getsignaturesforaddress) request to the api node:
...
##### Result
  ...
  * For each signature returned, get the transaction details by sending a [`getTransaction`](/de/docs/rpc/http/gettransaction) request:
...
blockhash](/de/docs/core/transactions#recent-blockhash) to indicate its
...
[blockhash expiration](/de/docs/more/exchange#blockhash-expiration) below.

First, get a recent blockhash using the
[`getFees`](/de/docs/rpc/deprecated/getfees) endpoint or the CLI command:
...
[`sendTransaction`](/de/docs/rpc/http/sendtransaction) endpoint.

#### Transaction Confirmations & Finality #

Get the status of a batch of transactions using the
[`getSignatureStatuses`](/de/docs/rpc/http/getsignaturestatuses) JSON-RPC
endpoint. The `confirmations` field reports how many [confirmed
blocks](/de/docs/terminology#confirmed-block) have elapsed since the
transaction was processed. If `confirmations: null`, it is
[finalized](/de/docs/terminology#finality).
...
[Prioritization Fees](/de/docs/terminology#prioritization-fee) are additional
fees that can be added on top of the [base Transaction
Fee](/de/docs/core/fees#transaction-fees) to ensure transaction inclusion
...
priority fees](/de/developers/guides/advanced/how-to-use-priority-fees) which
...
together](/de/developers/guides/advanced/how-to-use-priority-fees#special-
...
The SPL Token workflow is similar to that of native SOL tokens, but there are
...
accounts do not:
  ...
  2. SPL Token accounts must remain [rent-exempt](/de/docs/core/fees#rent-exempt) for the duration of their existence and therefore require a small amount of native SOL tokens be deposited at account creation. For SPL Token accounts, this amount is 0.00203928 SOL (2,039,280 lamports).
...
polling](/de/docs/more/exchange#poll-for-blocks) method described above. Each
...
Before executing a withdrawal [transfer](/de/docs/more/exchange#token-
transfers), the exchange should check the address as [described
above](/de/docs/more/exchange#validating-user-supplied-account-addresses-for-
...
[clusters](/de/docs/core/clusters) before moving to production on mainnet-
...
[Previous« Limitations](/de/docs/programs/limitations)
