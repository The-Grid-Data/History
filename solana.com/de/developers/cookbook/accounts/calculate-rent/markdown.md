...
Cost](/de/developers/cookbook/accounts/calculate-rent)
...
[Previous« How to Create an Account](/de/developers/cookbook/accounts/create-
account)[NextHow to Create a PDA's Account
»](/de/developers/cookbook/accounts/create-pda-account)
