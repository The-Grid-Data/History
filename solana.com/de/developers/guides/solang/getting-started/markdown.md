...
# [Getting started with Solang](/de/developers/guides/solang/getting-started)

updated 17\. Juli 2023

[intro](/de/developers/guides?difficulty=intro)[quickstart](/de/developers/guides?tags=quickstart)[solang](/de/developers/guides?tags=solang)[solidity](/de/developers/guides?tags=solidity)

[![Getting started with
Solang](https://solana.com/_next/image?url=%2Fopengraph%2Fdevelopers%2Fguides%2Fsolang%2Fgetting-
started&w=3840&q=75)](/de/developers/guides/solang/getting-started)
...
Solang. Just follow the steps outlined below:
  ...
  1. **Check Your Prerequisites** : Before diving in, ensure that you have [Rust](https://www.rust-lang.org/tools/install) and [Node.js](https://nodejs.org/en) installed on your system. Windows users will also need to have [Windows Subsystem for Linux](/de/developers/guides/setup-local-development#windows-users-only) set up.
...
AWS](/de/developers/guides/rpc/configure-solana-rpc-on-aws)[NextHow to use the
Default Account State extension »](/de/developers/guides/token-
extensions/default-account-state)

##### Table of Contents

  * [Getting Started with Solang](/de/developers/guides/solang/getting-started#getting-started-with-solang)
  * [Installation](/de/developers/guides/solang/getting-started#installation)
  * [Creating a new project](/de/developers/guides/solang/getting-started#creating-a-new-project)
  * [On-chain program Overview](/de/developers/guides/solang/getting-started#on-chain-program-overview)
  * [Important Differences](/de/developers/guides/solang/getting-started#important-differences)
  * [Storing of state data](/de/developers/guides/solang/getting-started#storing-of-state-data)
  * [Test File Overview](/de/developers/guides/solang/getting-started#test-file-overview)
  * [Next Steps](/de/developers/guides/solang/getting-started#next-steps)

[Scroll to Top](/de/developers/guides/solang/getting-started#)
