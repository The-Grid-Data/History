...
# [accountSubscribe RPC Method](/ru/docs/rpc/websocket/accountsubscribe)
...
[getAccountInfo](/ru/docs/rpc/http/getaccountinfo) RPC HTTP method.
...
[Previous« Websocket Methods](/ru/docs/rpc/websocket)[NextaccountUnsubscribe
»](/ru/docs/rpc/websocket/accountunsubscribe)
