...
# [getGenesisHash RPC Method](/ru/docs/rpc/http/getgenesishash)
...
[Previous«
getFirstAvailableBlock](/ru/docs/rpc/http/getfirstavailableblock)[NextgetHealth
»](/ru/docs/rpc/http/gethealth)
