...
# [getBlockHeight RPC Method](/ru/docs/rpc/http/getblockheight)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getBlockHeight.mdx)
...
[Previous«
getBlockCommitment](/ru/docs/rpc/http/getblockcommitment)[NextgetBlockProduction
»](/ru/docs/rpc/http/getblockproduction)
