...
# [getVersion RPC Method](/ru/docs/rpc/http/getversion)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getVersion.mdx)
...
[Previous«
getTransactionCount](/ru/docs/rpc/http/gettransactioncount)[NextgetVoteAccounts
»](/ru/docs/rpc/http/getvoteaccounts)
