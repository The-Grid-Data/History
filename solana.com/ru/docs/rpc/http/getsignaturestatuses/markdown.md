...
# [getSignatureStatuses RPC Method](/ru/docs/rpc/http/getsignaturestatuses)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getSignatureStatuses.mdx)

Returns the statuses of a list of signatures. Each signature must be a
[txid](/ru/docs/terminology#transaction-id), the first signature of a
transaction.
...
An array of `RpcResponse<object>` consisting of either:
  ...
  * `<object>`
    ...
    * `confirmationStatus: <string|null>` \- The transaction's cluster confirmation status; Either `processed`, `confirmed`, or `finalized`. See [Commitment](/ru/docs/rpc#configuring-state-commitment) for more on optimistic confirmation.
...
[Previous«
getRecentPrioritizationFees](/ru/docs/rpc/http/getrecentprioritizationfees)[NextgetSignaturesForAddress
»](/ru/docs/rpc/http/getsignaturesforaddress)
