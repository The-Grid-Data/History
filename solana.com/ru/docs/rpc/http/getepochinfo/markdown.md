...
# [getEpochInfo RPC Method](/ru/docs/rpc/http/getepochinfo)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getEpochInfo.mdx)
...
[Previous«
getClusterNodes](/ru/docs/rpc/http/getclusternodes)[NextgetEpochSchedule
»](/ru/docs/rpc/http/getepochschedule)
