...
# [getBalance RPC Method](/ru/docs/rpc/http/getbalance)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getBalance.mdx)
...
[Previous« getAccountInfo](/ru/docs/rpc/http/getaccountinfo)[NextgetBlock
»](/ru/docs/rpc/http/getblock)
