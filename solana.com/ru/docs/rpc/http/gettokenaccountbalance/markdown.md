...
# [getTokenAccountBalance RPC
Method](/ru/docs/rpc/http/gettokenaccountbalance)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getTokenAccountBalance.mdx)
...
Structure](/ru/docs/rpc/json-structures#token-balances) response from
[getBlock](/ru/docs/rpc/http/getblock) follows a similar structure.
...
[Previous«
getSupply](/ru/docs/rpc/http/getsupply)[NextgetTokenAccountsByDelegate
»](/ru/docs/rpc/http/gettokenaccountsbydelegate)
