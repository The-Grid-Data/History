...
# [getHealth RPC Method](/ru/docs/rpc/http/gethealth)
...
[Previous«
getGenesisHash](/ru/docs/rpc/http/getgenesishash)[NextgetHighestSnapshotSlot
»](/ru/docs/rpc/http/gethighestsnapshotslot)
