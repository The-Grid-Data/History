...
# [getMultipleAccounts RPC Method](/ru/docs/rpc/http/getmultipleaccounts)
...
[Previous«
getMinimumBalanceForRentExemption](/ru/docs/rpc/http/getminimumbalanceforrentexemption)[NextgetProgramAccounts
»](/ru/docs/rpc/http/getprogramaccounts)
