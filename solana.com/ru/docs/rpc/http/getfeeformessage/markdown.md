...
# [getFeeForMessage RPC Method](/ru/docs/rpc/http/getfeeformessage)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getFeeForMessage.mdx)
...
[getFees](/ru/docs/rpc/deprecated/getfees) for `solana-core` v1.8 and below.
...
[Previous«
getEpochSchedule](/ru/docs/rpc/http/getepochschedule)[NextgetFirstAvailableBlock
»](/ru/docs/rpc/http/getfirstavailableblock)
