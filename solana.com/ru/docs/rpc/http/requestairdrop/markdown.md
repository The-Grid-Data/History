...
# [requestAirdrop RPC Method](/ru/docs/rpc/http/requestairdrop)
...
[Previous«
minimumLedgerSlot](/ru/docs/rpc/http/minimumledgerslot)[NextsendTransaction
»](/ru/docs/rpc/http/sendtransaction)
