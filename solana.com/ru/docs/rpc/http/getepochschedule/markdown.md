...
# [getEpochSchedule RPC Method](/ru/docs/rpc/http/getepochschedule)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getEpochSchedule.mdx)
...
[Previous« getEpochInfo](/ru/docs/rpc/http/getepochinfo)[NextgetFeeForMessage
»](/ru/docs/rpc/http/getfeeformessage)
