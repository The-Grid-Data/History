...
# [getStakeActivation RPC Method](/ru/docs/rpc/http/getstakeactivation)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getStakeActivation.mdx)
...
defaults to current epoch. **DEPRECATED** , inputs other than the current
epoch return an error.
...
[Previous«
getSlotLeaders](/ru/docs/rpc/http/getslotleaders)[NextgetStakeMinimumDelegation
»](/ru/docs/rpc/http/getstakeminimumdelegation)
