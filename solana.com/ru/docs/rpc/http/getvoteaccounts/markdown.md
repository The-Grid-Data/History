...
# [getVoteAccounts RPC Method](/ru/docs/rpc/http/getvoteaccounts)
...
[Previous« getVersion](/ru/docs/rpc/http/getversion)[NextisBlockhashValid
»](/ru/docs/rpc/http/isblockhashvalid)
