...
# [getClusterNodes RPC Method](/ru/docs/rpc/http/getclusternodes)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getClusterNodes.mdx)
...
[Previous«
getBlocksWithLimit](/ru/docs/rpc/http/getblockswithlimit)[NextgetEpochInfo
»](/ru/docs/rpc/http/getepochinfo)
