...
# [minimumLedgerSlot RPC Method](/ru/docs/rpc/http/minimumledgerslot)
...
[Previous«
isBlockhashValid](/ru/docs/rpc/http/isblockhashvalid)[NextrequestAirdrop
»](/ru/docs/rpc/http/requestairdrop)
