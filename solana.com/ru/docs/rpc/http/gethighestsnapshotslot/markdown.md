...
Method](/ru/docs/rpc/http/gethighestsnapshotslot)
...
[getSnapshotSlot](/ru/docs/rpc/http/getsnapshotslot) for `solana-core` v1.8
and below.
...
[Previous« getHealth](/ru/docs/rpc/http/gethealth)[NextgetIdentity
»](/ru/docs/rpc/http/getidentity)
