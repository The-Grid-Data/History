...
Method](/ru/docs/rpc/http/getminimumbalanceforrentexemption)
...
[Previous«
getMaxShredInsertSlot](/ru/docs/rpc/http/getmaxshredinsertslot)[NextgetMultipleAccounts
»](/ru/docs/rpc/http/getmultipleaccounts)
