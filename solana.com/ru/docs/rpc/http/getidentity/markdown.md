...
# [getIdentity RPC Method](/ru/docs/rpc/http/getidentity)
...
[Previous«
getHighestSnapshotSlot](/ru/docs/rpc/http/gethighestsnapshotslot)[NextgetInflationGovernor
»](/ru/docs/rpc/http/getinflationgovernor)
