...
# [getLatestBlockhash RPC Method](/ru/docs/rpc/http/getlatestblockhash)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getLatestBlockhash.mdx)
...
[getRecentBlockhash](/ru/docs/rpc/http/getrecentblockhash) for `solana-core`
v1.8 and below.
...
JSON object including:
  ...
  * `lastValidBlockHeight: <u64>` \- last [block height](/ru/docs/terminology#block-height) at which the blockhash will be valid
...
[Previous«
getLargestAccounts](/ru/docs/rpc/http/getlargestaccounts)[NextgetLeaderSchedule
»](/ru/docs/rpc/http/getleaderschedule)
