...
# [getBlockProduction RPC Method](/ru/docs/rpc/http/getblockproduction)
...
[Previous« getBlockHeight](/ru/docs/rpc/http/getblockheight)[NextgetBlockTime
»](/ru/docs/rpc/http/getblocktime)
