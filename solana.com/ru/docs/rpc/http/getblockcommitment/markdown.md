...
# [getBlockCommitment RPC Method](/ru/docs/rpc/http/getblockcommitment)

[Edit Page](https://github.com/solana-foundation/developer-
content/tree/main/docs/rpc/http/getBlockCommitment.mdx)
...
[Previous« getBlock](/ru/docs/rpc/http/getblock)[NextgetBlockHeight
»](/ru/docs/rpc/http/getblockheight)
