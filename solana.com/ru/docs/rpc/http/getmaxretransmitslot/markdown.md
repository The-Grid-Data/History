...
# [getMaxRetransmitSlot RPC Method](/ru/docs/rpc/http/getmaxretransmitslot)
...
[Previous«
getLeaderSchedule](/ru/docs/rpc/http/getleaderschedule)[NextgetMaxShredInsertSlot
»](/ru/docs/rpc/http/getmaxshredinsertslot)
