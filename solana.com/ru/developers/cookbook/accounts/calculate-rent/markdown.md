...
Cost](/ru/developers/cookbook/accounts/calculate-rent)
...
[Previous« How to Create an Account](/ru/developers/cookbook/accounts/create-
account)[NextHow to Create a PDA's Account
»](/ru/developers/cookbook/accounts/create-pda-account)
