...
# [How to create a CRUD dApp on Solana](/ru/developers/guides/dapps/journal)

updated 18 марта 2024 г.

[intro](/ru/developers/guides?difficulty=intro)[quickstart](/ru/developers/guides?tags=quickstart)[dApp](/ru/developers/guides?tags=dApp)[crud](/ru/developers/guides?tags=crud)[anchor](/ru/developers/guides?tags=anchor)[rust](/ru/developers/guides?tags=rust)[react](/ru/developers/guides?tags=react)[program](/ru/developers/guides?tags=program)

[![How to create a CRUD dApp on
Solana](https://solana.com/_next/image?url=%2Fopengraph%2Fdevelopers%2Fguides%2Fdapps%2Fjournal&w=3840&q=75)](/ru/developers/guides/dapps/journal)
...
with a few tools:
  ...
  * [Solana CLI & Anchor](/ru/developers/guides/getstarted/setup-local-development)
...
[program](/ru/docs/terminology#program), written in rust using the Anchor
...
Now, let's add an [instruction handler](/ru/docs/terminology#instruction-
...
[rent](/ru/docs/terminology#rent) to hold this account's data on-chain and how
...
In the above code, we use the `close` constraint to close out the account on-
...
Solana](/ru/developers/guides/advanced/stake-weighted-qos)[NextBuild an Energy
System for Casual Games on Solana »](/ru/developers/guides/games/energy-
system)

##### Table of Contents

  * [What you will learn](/ru/developers/guides/dapps/journal#what-you-will-learn)
  * [Prerequisites](/ru/developers/guides/dapps/journal#prerequisites)
  * [Setting up the project](/ru/developers/guides/dapps/journal#setting-up-the-project)
  * [Writing a Solana program with Anchor](/ru/developers/guides/dapps/journal#writing-a-solana-program-with-anchor)
  * [Define your Anchor program](/ru/developers/guides/dapps/journal#define-your-anchor-program)
  * [Define your program state](/ru/developers/guides/dapps/journal#define-your-program-state)
  * [Create a journal entry](/ru/developers/guides/dapps/journal#create-a-journal-entry)
  * [Updating a journal entry](/ru/developers/guides/dapps/journal#updating-a-journal-entry)
  * [Delete a journal entry](/ru/developers/guides/dapps/journal#delete-a-journal-entry)
  * [Build and deploy your Anchor program](/ru/developers/guides/dapps/journal#build-and-deploy-your-anchor-program)
  * [Connecting a Solana program to a UI](/ru/developers/guides/dapps/journal#connecting-a-solana-program-to-a-ui)
  * [Resources](/ru/developers/guides/dapps/journal#resources)

[Scroll to Top](/ru/developers/guides/dapps/journal#)
