...
Now that we know what Durable Nonces are, it's time to use them to send
...
##### Table of Contents
  ...
  * [Displace Nonce Account](/ru/developers/guides/advanced/introduction-to-durable-nonces#displace-nonce-account)
