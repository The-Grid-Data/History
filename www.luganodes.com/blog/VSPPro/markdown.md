...
# ​​Luganodes Secures VSP Pro Status at Program Debut
...
Copy
Link[](https://twitter.com/intent/tweet?text=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22%E2%80%8B%E2%80%8BLuganodes%20Secures%20VSP%20Pro%20Status%20at%20Program%20Debut%22&url=)[](https://www.linkedin.com/sharing/share-
offsite/?url=&title=%E2%80%8B%E2%80%8BLuganodes%20Secures%20VSP%20Pro%20Status%20at%20Program%20Debut&summary=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22%E2%80%8B%E2%80%8BLuganodes%20Secures%20VSP%20Pro%20Status%20at%20Program%20Debut%22)

> Luganodes is one of the only two pre-verified and audited providers
> worldwide, receiving the [VSP Pro
> Badge](https://www.stakingrewards.com/journal/news/introducing-the-vsp-pro)
> at launch.

## Introduction

The Verified Staking Provider (VSP) badge by Staking Rewards is a coveted
accreditation sought after by every staking provider. Over time, it has
cemented its position as an industry standard helping users identify the
providers which follow best practices and offer a high degree of reliability.
With an increasing focus on security, it was time to take things a step
further and offer an advanced seal of trust by conducting a thorough audit.
Quantstamp joined forces with Staking Rewards to conduct these audits and
offer the VSP Pro tag.

## Quantstamp Audit

As one of the biggest names in Web3 security,
[Quantstamp](https://quantstamp.com/) has 750+ audits under its belt with $200
billion secured in digital assets. Their team of scholars and security experts
ensures that staking providers follow advanced security measures and rectify
any vulnerabilities. Their expertise in auditing now enables Staking Rewards
to offer not just a certification, but also a badge of excellence to providers
in the staking field.

## The Process

The VSP Pro certification is awarded to staking providers who meet the high
standards set by the original VSP certification and also successfully pass the
rigorous and comprehensive audit conducted by Quantstamp. The process involves
an in-depth analysis of the staking provider's security practices, including
smart contract audits, infrastructure reviews, and penetration testing. By
scrutinizing elements like the anti-slashing database, key management, and
internet accessibility of validators, Quantstamp ensures that the staking
providers adhere to the [highest standards of security and
reliability](https://www.luganodes.com/blog/complianceupdate/).

Once a staking provider passes this audit, they are granted the VSP Pro badge,
signifying their excellence in staking services and commitment to top-tier
security measures. This badge also provides the provider exclusive access to
sign up for another layer of fund security—[Chainproof
Insurance.](https://www.luganodes.com/blog/Update_Chainproof/)

External Insurance, such as the one offered by Chainproof, is fairly new to
the staking space and it is a major step forward since it brings to Web3 a
benefit available largely in traditional finance. This establishes a new
industry standard, as the presence of the safety net of insurance provides
essential reassurance, irrespective of the robustness of the security systems
in place.

## Luganodes: VSP Pro

At Luganodes, we have worked relentlessly to provide [world-class
institutional staking services](https://www.luganodes.com/) and have always
been a preferred provider on Staking Rewards. In recent news, we have gone
through an [extensive audit by
Quantstamp](https://www.luganodes.com/blog/Update_Quantstamp/) and have opted
for Chainproof Insurance. This venture positions us as one of the first
staking providers who offer external insurance. Moreover, our insurance is
included in our standard offering for institutional customers and is not
merely an opt-in service.

Our impeccable track record and pre-verified and audited status led us to
become one of the two staking providers in the world, which received the VSP
Pro tag at its launch.

## Conclusion

In essence, the VSP Pro badge represents a new echelon of trust and safety in
the staking industry, setting a benchmark for security and sustainability. For
staking providers, earning this badge is not just an accolade but a testament
to their dedication to providing secure, reliable, and forward-thinking
staking services. As one of the first VSP Pro providers, Luganodes is
dedicated to maintaining this global standard.
