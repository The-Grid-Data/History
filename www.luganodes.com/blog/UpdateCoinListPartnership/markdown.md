...
# Luganodes Becomes a Staking Provider for CoinList

Empowering CoinList Users with Seamless Staking Opportunities
...
![](data:image/webp;base64,UklGRkwAAABXRUJQVlA4IEAAAABQAwCdASoUAAsAPtFWo0uoJKMhsAgBABoJZwDG9DBhqCajgAD+8Q5VCB5Jmrjbbr/o6PMH32GtJIxJOnGUR8AA)![Cover
Image](/static/2951fe582096fcd9c04917dfb939cd93/edb28/luga_CL_d94a3c12c0.webp)![Cover
Image](/static/2951fe582096fcd9c04917dfb939cd93/edb28/luga_CL_d94a3c12c0.webp)
...
Copy
Link[](https://twitter.com/intent/tweet?text=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22Luganodes%20Becomes%20a%20Staking%20Provider%20for%20CoinList%22&url=)[](https://www.linkedin.com/sharing/share-
offsite/?url=&title=Luganodes%20Becomes%20a%20Staking%20Provider%20for%20CoinList&summary=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22Luganodes%20Becomes%20a%20Staking%20Provider%20for%20CoinList%22)

[Luganodes](https://www.luganodes.com/) has joined
[CoinList](https://coinlist.co/)’s line of trusted staking infrastructure
providers for selected Proof of Stake tokens listed on the exchange, enabling
CoinList customers to earn staking rewards on their assets via Luganodes’
staking platform. Dedicated to providing institutional-grade staking
infrastructure, Luganodes helps enterprises and their customers stay ahead in
a rapidly changing industry to secure and scale Proof of Stake networks.

> “We are excited to collaborate with CoinList to bring their customers a
> seamless way to earn protocol staking rewards. Both CoinList and Luganodes
> have security and compliance at the heart of the technology, and we are
> pleased to work together to enable staking on behalf of CoinList’s users.
> With our world-class staking infrastructure and expansive list of PoS
> networks, this is merely the beginning of a promising and mutually
> beneficial collaboration.” -Anuj Shankar, CEO of Luganodes.

Founded in 2017, CoinList is a premier digital asset platform that empowers
builders at any stage in their journey, and connects them with high quality
early adopters. Beyond its trading platform, which provides access to over 40
high-quality digital currencies, CoinList supports certain assets that can
earn users monthly rewards by staking their tokens in accordance with the
applicable Proof-of-Stake network. CoinList is regarded as a compliance-first
organization that has taken extensive precautions to safeguard the funds of
its users, with no confirmed attacks or data leaks to date. Luganodes is
honoured to be a staking provider for CoinList.

> “Luganodes has been one of the fastest growing validators, supporting many
> of the top protocols and validating for reputable industry players. We’re
> excited to leverage their infrastructure to provide a smooth and stable
> staking experience for our users” -Spenser Huang, Director of Business
> Development at CoinList.

Luganodes is a Swiss-operated institutional-grade staking service provider
born out of the Lugano Plan B program, an initiative driven by Tether and the
City of Lugano. With ~$700 million worth of staked assets and live validator
nodes on 22+ PoS networks, Luganodes is the world’s fastest-growing staking
provider. We treasure the trust and support of CoinList and anticipate to
secure and scale the Web3 realm together.
