...
# Concordium — How to Stake $CCD Tokens with Luganodes
...
Copy
Link[](https://twitter.com/intent/tweet?text=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22Concordium%20%E2%80%94%20How%20to%20Stake%20%24CCD%20Tokens%20with%20Luganodes%22&url=)[](https://www.linkedin.com/sharing/share-
offsite/?url=&title=Concordium%20%E2%80%94%20How%20to%20Stake%20%24CCD%20Tokens%20with%20Luganodes&summary=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22Concordium%20%E2%80%94%20How%20to%20Stake%20%24CCD%20Tokens%20with%20Luganodes%22)

# Introduction:

Concordium is a Layer-1 Proof of Stake decentralized, permissionless, science-
backed, and sustainable blockchain with an ID layer to ease regulatory
compliance.

The fast and effective finality of transactions and low transaction fees,
combined with the stability of CCD’s value in terms of EURO, makes Concordium
an attractive option for various use cases.

In this guide, we’ll show you how to delegate your CCD tokens with Luganodes
and start earning ~14% in a few simple steps.
...
[https://ccdscan.io/nodes?dcount=1&dentity=node&did=Tm9kZVN0YXR1cwpkNDBmNDZkMzg2OTkyNjgyZg%253D%253D](https://ccdscan.io/nodes?dcount=1&dentity=node&did=Tm9kZVN0YXR1cwpkNDBmNDZkMzg2OTkyNjgyZg%253D%253D)

# Unbonding Period:

  * Unbonding period is a timeframe in which the funds are locked when you unstake
  * The **unbonding period** on **Concordium** is 14 days
...
**Step 1 — Set up your Concordium Wallet on your IOS app**
  ...
  * Download the **Concordium Wallet App** from the app store
  * You can either create a new account or import the existing one

![CCD_1.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_1_68e425da7b.webp)

**Step 2 — Stake with luganodes**

  * Once you’ve successfully verified your account and added CCD tokens to it, start the delegation process.

![CCD_2.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_2_cd4611fec6.webp)

  * Select **Delegation**

![CCD_3.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_3_4bf04d9b6e.webp)

  * Enter the **Baker Pool ID** (For Luganodes — **87236**)

![CCD_4.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_4_89e47951ac.webp)

  * Once you’ve entered the Baker ID, **continue** (Please enter the baker ID carefully, you can cross-verify this ID from — [https://ccdscan.io/nodes?dcount=1&dentity=node&did=Tm9kZVN0YXR1cwpkNDBmNDZkMzg2OTkyNjgyZg%253D%253D](https://ccdscan.io/nodes?dcount=1&dentity=node&did=Tm9kZVN0YXR1cwpkNDBmNDZkMzg2OTkyNjgyZg%253D%253D))

![CCD_5.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_5_c01ff3d2a9.webp)

  * Enter the amount of CCD tokens you want to delegate (Stake) and **continue**

![CCD_6.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_6_d36ef74fa2.webp)

**Step 3 — Confirm the transaction and check your staked amount**

  * After entering the amount of CCD to be staked, **Submit the delegation transaction**

![CCD_7.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_7_81c5900b4d.webp)

  * Tap on **Finish**

![CCD_8.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_8_e364bad0e2.webp)

  * Please note that once your transaction has been successfully finalized, the delegation will take effect from the next pay day.

![CCD_9.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_9_e17edde9a8.webp)

  * You can check your staked and available CCD tokens from from the accounts section.

![CCD_10.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_10_e8a2ed6129.webp)

# Step-by-Step Unstaking Guide:

**Step 1 — Head over to Concordium wallet and log in with the same credentials
you used in the staking process above**

  * Go to your account and tap on the top-right hamburger icon to see more options

![CCD_11.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_11_bd819d880b.webp)

  * Select **Delegation**

![CCD_12.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_12_407f323f77.webp)

**Step 2 — Initiate the Unstaking process**

  * Under the Delegation status, tap on Stop Delegation to initiate the process to unstake your CCD

![CCD_13.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_13_4d5c82dd1b.webp)

  * Read the Instructions properly about the cool-down period (Unbonding period, that is 14 days for CCD)

![CCD_14.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_14_0be12600d6.webp)

![CCD_15.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_15_3a3a93038a.webp)

**Step 3 — Submit the transaction and withdraw after the unbonding period (14
days)**

![CCD_16.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/CCD_16_12ba81984f.webp)
