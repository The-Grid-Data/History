...
# Aptos — How to Stake $APT Tokens with Luganodes

How to Stake $APT Tokens with Luganodes
...
![](data:image/png;base64,)![Cover
Image](/static/ca3a61912a5670dc933267f568f44ed3/bb8ee/Staking_Guide_aptos_7f0a29eb11.png)![Cover
Image](/static/ca3a61912a5670dc933267f568f44ed3/bb8ee/Staking_Guide_aptos_7f0a29eb11.png)
...
Copy
Link[](https://twitter.com/intent/tweet?text=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22Aptos%20%E2%80%94%20How%20to%20Stake%20%24APT%20Tokens%20with%20Luganodes%22&url=)[](https://www.linkedin.com/sharing/share-
offsite/?url=&title=Aptos%20%E2%80%94%20How%20to%20Stake%20%24APT%20Tokens%20with%20Luganodes&summary=Check%20out%20this%20blog%20by%20Luganodes%20-%20%22Aptos%20%E2%80%94%20How%20to%20Stake%20%24APT%20Tokens%20with%20Luganodes%22)

# Introduction:

Aptos is a layer 1 blockchain built with the Move programming language. It
promises users increased scalability, reliability, security, and usability,
with low transaction costs.

In this guide, we’ll show you how to delegate your $APT tokens with Luganodes
...
**Validator Address:**
0xff3e9c10dd3781a1e0750a75ae9e5b04133cd7e8ca18b9936ffcf3b2a2538a49

Blockchain Explorer Link for the Validator:
<https://explorer.aptoslabs.com/validator/0xff3e9c10dd3781a1e0750a75ae9e5b04133cd7e8ca18b9936ffcf3b2a2538a49?network=mainnet>

# Unbonding Period:

  * Unbonding period is a timeframe in which the funds are locked when you unstake
  * The validator unlock period is 30 days, but the timing follows from when the delegation pool is initiated.
  * Depending on when in the cycle you choose to unstake your APT, it could be as little as a few hours, or up to 30 days

# Step-by-Step Staking Guide:

## Step 1 — Set up your Aptos Wallet

  * You can use either of the APTOS compatible wallet, but for this guide we’ll be using one of the most popular wallet, Petra Aptos Wallet.
  * Head over to this [link](https://chrome.google.com/webstore/detail/petra-aptos-wallet/ejjladinnckdgjemekebdpeokbikhfci/related) to install the chrome extension

![Aptos_1.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_1_daedf56b75.webp)

  * After adding the extension, creat a new wallet or import the existing one and make sure it has at least 11.1 $APT in it (11 $APT is the minimum delegation amount required, plus about 0.1 to compensate for transaction fees)

![Aptos_2.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_2_f323429f94.webp)

## Step 2— Connect your wallet to Aptos Explorer

  * Head over to the [Aptos Mainnet Explorer](https://explorer.aptoslabs.com/?network=mainnet) and connect to your Petra wallet

![Aptos_3.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_3_974803bef2.webp)

![Aptos_4.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_4_61505214b9.webp)

## Step 3 — Stake with Luganodes

  * Under the Validators section, head over to Delegation Nodes and choose the operator with name Luganodes or operator address [0xb2f23993fc7b32567cb614c7d31907242a63d5a82aea5c0f22ff4aaed0a557c3](https://explorer.aptoslabs.com/account/0xb2f23993fc7b32567cb614c7d31907242a63d5a82aea5c0f22ff4aaed0a557c3?network=mainnet)

![Aptos_5.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_5_88287a4adf.webp)

  * Select stake

![Aptos_6.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_6_e4ab86e3e0.webp)

  * Enter the amount of $APT you want to stake (Should be more than 11) and confirm the delegation

![Aptos_7.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_7_5c72e9e753.webp)

  * Approve the transaction

![Aptos_8.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_8_62cc50f686.webp)
![Aptos_9.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_9_24468b4d52.webp)

To check your staked amount, select account under the wallet on the top right
corner

![Aptos_10.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_10_0154f8c241.webp)

# Step-by-Step Unstaking Guide:

## Step 1 — Head over to Aptos Explorer and log in with the same wallet and
credentials you used in the staking process above

  * Under the validator section, in the Delegation Nodes you will be able to see “My Deposit” besides your validator, select the validator

![Aptos_11.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_11_30d313b221.webp)

## Step 2 — Initiate Unstaking process

  * Under My deposits, you can check your deposit/ staking status and choose to unstake your assets

![Aptos_12.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_12_582eec5caf.webp)
![Aptos_13.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_13_f7ebc20e6d.webp)

  * Now select the amount of $APT you want to unstake and click on Unstake

![Aptos_14.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_14_83d75905f7.webp)

  * Confirm the transaction

![Aptos_15.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_15_ec3d7ea41e.webp)
![Aptos_16.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_16_9800172fcd.webp)

## Step 3 — Withdraw after the unbonding period

  * Head back to the validator you staked your $APT with after the unbonding period is over to withdraw your stakes
  * Validators>Delegation Nodes>Luganodes>My Deposits

![Aptos_17.webp](https://better-
triumph-f08c8a30a5.media.strapiapp.com/Aptos_17_3afcf68fdc.webp)

**For more details head over to[Aptos
docs](https://aptos.dev/concepts/staking/) or reach out to us on
...
[How to Stake $APT | Aptos Staking Guide](https://www.youtube.com/watch?v=9UbyXvuBFgk)
...
[Watch
on](https://www.youtube.com/watch?v=9UbyXvuBFgk&embeds_referring_euri=https%3A%2F%2Fwww.luganodes.com%2F&feature=emb_imp_woyt)
...
[](https://www.youtube.com/watch?v=9UbyXvuBFgk "Watch on YouTube")

# An error occurred.

[Try watching this video on
www.youtube.com](https://www.youtube.com/watch?v=9UbyXvuBFgk), or enable
