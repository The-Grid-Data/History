...
Smart contracts on Ethereum are self-executing programs that run in the
...
The newly deployed contract will have an empty storage, allowing you to
...
[More on proxy patterns(opens in a new
