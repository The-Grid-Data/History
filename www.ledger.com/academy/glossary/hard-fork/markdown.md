...
"Instagram")[](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.ledger.com%2Facademy%2Fglossary%2Fhard-
fork
"Facebook")[](http://twitter.com/intent/tweet?via=ledger&text=Hard%20Fork&url=https%3A%2F%2Fwww.ledger.com%2Facademy%2Fglossary%2Fhard-
fork "Twitter")[](https://www.linkedin.com/sharing/share-
offsite/?url=https%3A%2F%2Fwww.ledger.com%2Facademy%2Fglossary%2Fhard-fork
"Linkedin")[](http://reddit.com/submit?url=https%3A%2F%2Fwww.ledger.com%2Facademy%2Fglossary%2Fhard-
fork&title=Hard%20Fork "Reddit")

**A hard fork is a significant change that permanently splits a blockchain
into two different networks when the nodes fail to reach a consensus.**

## What is a Hard Fork in Crypto?

A hard fork (often used as one word, “hardfork”) is a protocol software
upgrade that permanently splits a blockchain network into two separate chains.
It occurs when [nodes](https://www.ledger.com/academy/glossary/node) on the
newest version of the protocol fail to accept the older version of the
blockchain.

Technically, modifying the blockchain forces all the nodes to comply and
upgrade to the newest version of the protocol. However, some continue along
the old path. This lack of consensus results in the upgraded protocol being
permanently split from the previous version. It also leads to the invalidation
of previously valid transactions and blocks, and vice versa.

Two things can happen when a blockchain undergoes a hard fork:

  1. The hard fork creates another crypto asset when the cryptocurrency’s community fails to reach a consensus. For example, in August 2017 Bitcoin Cash (BCH) was formed in response to [Segregated Witness (SegWit)](https://www.ledger.com/academy/glossary/segregated-witness-segwit) when the Bitcoin community failed to reach a consensus to increase Bitcoin’s block size.
  2. One of the crypto assets formed from the hard fork may virtually disappear in the case an upgrade is unanimously supported by the community. Hence, the crypto asset that lost community support disappears. For example, the Ethereum community unanimously supported the Byzantium hard fork, leading to only a single crypto as a result.
...
For example, the Ethereum community proposed a hard fork to reverse a hack on
[the DAO](https://www.ledger.com/academy/blockchain/what-is-a-dao)
(Decentralized Autonomous Organization) project, which claimed crypto worth
tens of millions of dollars of DAO token holders’ funds. A newer version of
the network was created with newly formed [smart
contracts](https://www.ledger.com/academy/glossary/smart-contract) that
enabled the original owners of the stolen crypto to recover their funds. The
older version of the network was renamed **Ethereum Classic** , while the
newer version retained the original name, **Ethereum**.

## What is the Difference Between a Hard Fork and Soft Fork?

Hard forks and soft forks are similar processes with different results. A
[soft fork](https://www.ledger.com/academy/glossary/soft-fork) is performed
when forward and backward compatibility is possible. This means that the new
version can still communicate with the old version of the software.

In hard forks, nodes stop processing blocks following the introduction of new
rules, that is, upgraded nodes stop communicating with non-upgraded nodes.
With hard forks, networks do not maintain backward compatibility.
...
[Full definition](https://www.ledger.com/academy/glossary/bear-market "Full
definition")
...
[Full definition](https://www.ledger.com/academy/glossary/gas "Full
definition")
