...
[Blog](https://www.ledger.com/blog/device-apps-tutorials) __[Blog
...
As an embedded application developer, you must know all about a handy tool
that many of you might find incredibly useful: the Ledger VS extension. To
make your journey smoother, we’ve released a trio of video tutorials that
break down everything you need to know about using this extension effectively.

[Blog](https://www.ledger.com/blog/device-apps-tutorials) __[Blog
posts](https://www.ledger.com/category/blog-posts "Blog posts")

As an embedded application developer, you must know all about a handy tool
that many of you might find incredibly useful: the Ledger VS Code extension.
It’s designed to significantly ease the process of building, testing and
loading applications on Ledger devices, leveraging a tailored Docker image by
Ledger for a quick environment setup.

For those who haven’t explored this extension yet, it supports app development
in both C and Rust for all Ledger devices. Plus, it ensures you stay on top of
your game with the latest SDK updates and allows for efficient multitasking
with support for multiple app folders in a single workspace.

But here’s the kicker: to make your journey smoother, we’ve released a trio of
video tutorials that break down everything you need to know about using this
extension effectively.

##### 1\. Development environment

Kicking things off, this tutorial takes you through the steps to set up your
environment, build your application, and run it with the Speculos emulator.
It’s perfect for getting a solid start with the extension.

##### 2\. Testing the App

Next up, this tutorial focuses on how to thoroughly test your applications,
ensuring they are bulletproof when deployed on actual devices.

##### 3\. Device Operations

And finally, this tutorial covers all the device operations that can be
performed. It details how to use the extension to the fullest, from the quick
initial setup, to loading and deleting applications on a Ledger device.

Whether you’re a seasoned developer or just starting out in the world of
Ledger device applications, these tutorials are crafted to enhance your
development prowess, making the process as clear and straightforward as
possible.

Have fun coding and testing, and make sure to check out these tutorials and
the [Developer Portal](https://developers.ledger.com/docs/device-
app/develop/quickstart) to fully harness the potential of the Ledger VS Code
extension. Happy developing!
