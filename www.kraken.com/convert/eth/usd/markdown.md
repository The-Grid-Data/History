...
[Home](/) / [Convert](/convert) / **ETH to USD**

# ETH to USD

## Convert Ethereum to United States Dollar
...
1 ETH equals 3,903.92 USD. The current value of 1 Ethereum is  -0.36% against
the exchange rate to USD in the last 24 hours.​ The current Ethereum market
cap is $467.06B. ​Create a free Kraken account to instantly convert ETH to USD
today.
...
eth_colored.svg)ETH EUR
](/convert/eth/eur)[![xrp](https://assets.kraken.com/marketing/web/icons/sym-
...
## How to convert  
Ethereum to United States Dollar

### Create your free  
Kraken account

You can trade ETH on Kraken with as little as $10.
...
[Get started](https://pro.kraken.com/app/trade/ETH-USD)
...
#### [Sell Ethereum](/learn/sell-ethereum-eth)

Cash out of Ethereum with flexible funding options.

#### [Ethereum rewards](/features/staking-coins/ethereum)

See if you can earn rewards on your Ethereum.

### ETH to USD converter FAQ:

  1. ### What does conversion rate mean?

The Ethereum to United States Dollar conversion rate is the amount of United
States Dollar you can receive for each unit of Ethereum.

  2. ### What affects the Ethereum to United States Dollar conversion rate?

The conversion rate between Ethereum and United States Dollar may fluctuate
based on supply and demand, relative scarcity, investor sentiment, media
attention and other factors.

  3. ### How do I use this ETH to USD converter tool?

Enter the amount of Ethereum you wish to convert to United States Dollar into
the Ethereum field. To convert United States Dollar to Ethereum, input the
amount of United States Dollar in the United States Dollar field.

  4. ### How can I convert Ethereum to United States Dollar ?

    1. Ensure Ethereum and United States Dollar are selected in the converter tool
    2. Enter the amount of Ethereum you want to convert into United States Dollar
    3. Click "Trade now" to sign up or sign into your Kraken account
    4. Convert Ethereum to United States Dollar with just a few clicks

  5. ### Can I buy ETH with USD?
