...
[Home](/) / [Convert](/convert) / **XRP to USD**

# XRP to USD

## Convert XRP to United States Dollar
...
### Current XRP to USD exchange rate

1 XRP equals 0.53 USD. The current value of 1 XRP is  -0.90% against the
exchange rate to USD in the last 24 hours.​ The current XRP market cap is
$29.31B. ​Create a free Kraken account to instantly convert XRP to USD today.

[Trade now](https://kraken.app.link/C7jtQTPhHFb)

[Trade now](/sign-up)

### XRP to USD conversion rates
...
xrp_colored.svg)XRP EUR
](/convert/xrp/eur)[![ada](https://assets.kraken.com/marketing/web/icons/sym-
...
ltc_colored.svg)LTC USD
](/convert/ltc/usd)[![xmr](https://assets.kraken.com/marketing/web/icons/sym-
...
## How to convert  
XRP to United States Dollar

### Create your free  
Kraken account

You can trade XRP on Kraken with as little as $10.
...
[Get started](https://pro.kraken.com/app/trade/XRP-USD)
...
#### [Buy XRP](/learn/buy-xrp-xrp)

Learn how to buy XRP easily and safely through Kraken.

#### [Sell XRP](/learn/sell-xrp-xrp)

Cash out of XRP with flexible funding options.

#### [XRP rewards](/features/staking-coins/xrp)

See if you can earn rewards on your XRP.

### XRP to USD converter FAQ:

  1. ### What does conversion rate mean?

The XRP to United States Dollar conversion rate is the amount of United States
Dollar you can receive for each unit of XRP.

  2. ### What affects the XRP to United States Dollar conversion rate?

The conversion rate between XRP and United States Dollar may fluctuate based
on supply and demand, relative scarcity, investor sentiment, media attention
and other factors.

  3. ### How do I use this XRP to USD converter tool?

Enter the amount of XRP you wish to convert to United States Dollar into the
XRP field. To convert United States Dollar to XRP, input the amount of United
States Dollar in the United States Dollar field.

  4. ### How can I convert XRP to United States Dollar ?

    1. Ensure XRP and United States Dollar are selected in the converter tool
    2. Enter the amount of XRP you want to convert into United States Dollar
    3. Click "Trade now" to sign up or sign into your Kraken account
    4. Convert XRP to United States Dollar with just a few clicks

  5. ### Can I buy XRP with USD?
