...
[Home](/) / [Convert](/convert) / **SOL to USD**

# SOL to USD

## Convert Solana to United States Dollar
...
1 SOL equals 172.73 USD. The current value of 1 Solana is  +3.03% against the
exchange rate to USD in the last 24 hours.​ The current Solana market cap is
$77.38B. ​Create a free Kraken account to instantly convert SOL to USD today.

[Trade now](https://kraken.app.link/C7jtQTPhHFb)

[Trade now](/sign-up)

### SOL to USD conversion rates
...
EUR
](/convert/sol/eur)[![ltc](https://assets.kraken.com/marketing/web/icons/sym-
...
## How to convert  
Solana to United States Dollar

### Create your free  
Kraken account

You can trade SOL on Kraken with as little as $10.
...
[Get started](https://pro.kraken.com/app/trade/SOL-USD)
...
#### [Solana rewards](/features/staking-coins/solana)

See if you can earn rewards on your Solana.

### SOL to USD converter FAQ:

  1. ### What does conversion rate mean?

The Solana to United States Dollar conversion rate is the amount of United
States Dollar you can receive for each unit of Solana.

  2. ### What affects the Solana to United States Dollar conversion rate?

The conversion rate between Solana and United States Dollar may fluctuate
based on supply and demand, relative scarcity, investor sentiment, media
attention and other factors.

  3. ### How do I use this SOL to USD converter tool?

Enter the amount of Solana you wish to convert to United States Dollar into
the Solana field. To convert United States Dollar to Solana, input the amount
of United States Dollar in the United States Dollar field.

  4. ### How can I convert Solana to United States Dollar ?

    1. Ensure Solana and United States Dollar are selected in the converter tool
    2. Enter the amount of Solana you want to convert into United States Dollar
    3. Click "Trade now" to sign up or sign into your Kraken account
    4. Convert Solana to United States Dollar with just a few clicks

  5. ### Can I buy SOL with USD?
