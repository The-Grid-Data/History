...
[Home](/) / [Convert](/convert) / **BTC to USD**
...
![usd](https://assets.kraken.com/marketing/web/icons/sym-o.svg)
...
1 BTC equals 68,194.00 USD. The current value of 1 Bitcoin is  -1.01% against
the exchange rate to USD in the last 24 hours.​ The current Bitcoin market cap
is $1.34T. ​Create a free Kraken account to instantly convert BTC to USD
today.
...
[![btc](https://assets.kraken.com/marketing/web/icons/sym-o.svg)BTC EUR
](/convert/btc/eur)[![eth](https://assets.kraken.com/marketing/web/icons/sym-
...
You can trade BTC on Kraken with as little as $10.
...
[Get started](https://pro.kraken.com/app/trade/BTC-USD)
...
### BTC to USD converter FAQ:

  1. ### What does conversion rate mean?

The Bitcoin to United States Dollar conversion rate is the amount of United
States Dollar you can receive for each unit of Bitcoin.

  2. ### What affects the Bitcoin to United States Dollar conversion rate?

The conversion rate between Bitcoin and United States Dollar may fluctuate
based on supply and demand, relative scarcity, investor sentiment, media
attention and other factors.

  3. ### How do I use this BTC to USD converter tool?

Enter the amount of Bitcoin you wish to convert to United States Dollar into
the Bitcoin field. To convert United States Dollar to Bitcoin, input the
amount of United States Dollar in the United States Dollar field.

  4. ### How can I convert Bitcoin to United States Dollar ?

    1. Ensure Bitcoin and United States Dollar are selected in the converter tool
    2. Enter the amount of Bitcoin you want to convert into United States Dollar
    3. Click "Trade now" to sign up or sign into your Kraken account
    4. Convert Bitcoin to United States Dollar with just a few clicks

  5. ### Can I buy BTC with USD?
