...
One application to reach millions of Kraken clients

[Get listed](/listings/apply)

This page is your central resource for getting listed on Kraken

Our listing process

We run a rigorous due diligence process to ensure every asset meets our
standards. Here’s a brief summary of the process:

### Apply

Issuers complete and submit an application with all relevant information about
their asset.

### Evaluate

Our Listing Committee evaluates each application from a legal, compliance,
engineering and business perspective.

### List

Once integrated with our platform, the asset is listed on our exchange. This
does not mean Kraken endorses the asset.

### Monitor

We monitor all assets on our exchange to ensure they meet our standards.

Now you can buy, sell and deposit these newly listed assets*

[![w](https://assets.kraken.com/marketing/web/icons/sym-w_colored.svg)Wormhole
W ](/learn/buy-wormhole-w)

[![strk](https://assets.kraken.com/marketing/web/icons/sym-
strk_colored.svg)Starknet Token STRK ](/learn/buy-starknet-token-strk)

[![dym](https://assets.kraken.com/marketing/web/icons/sym-
dym_colored.svg)Dymension DYM ](/learn/buy-dymension-dym)

[![wif](https://assets.kraken.com/marketing/web/icons/sym-
wif_colored.svg)Dogwifhat WIF ](/learn/buy-dogwifhat-wif)

[![hnt](https://assets.kraken.com/marketing/web/icons/sym-
hnt_colored.svg)Helium HNT ](/learn/buy-helium-hnt)

[![jup](https://assets.kraken.com/marketing/web/icons/sym-
jup_colored.svg)Jupiter JUP ](/learn/buy-jupiter-jup)
...
We’ll update this roadmap once the Listing Committee decides to list an asset.
An asset’s inclusion on this roadmap is not a guarantee of listing.  
  
Funding and trading are not supported for these assets until a listing is
officially announced on our [Kraken Pro X account](https://x.com/krakenpro).
Do not attempt to deposit these assets before that time or your funds may be
lost.

# ERC20 on Ethereum

[![pda](https://assets.kraken.com/marketing/web/icons/sym-
pda_colored.svg)PlayDapp PDA ](https://www.coingecko.com/en/coins/playdapp)

[![zeta](https://assets.kraken.com/marketing/web/icons/sym-
zeta_colored.svg)ZetaChain ZETA
](https://www.coingecko.com/en/coins/zetachain)

[![arkm](https://assets.kraken.com/marketing/web/icons/sym-
arkm_colored.svg)Arkham ARKM ](https://www.coingecko.com/en/coins/arkham)

[![ethfi](https://assets.kraken.com/marketing/web/icons/sym-
ethfi_colored.svg)Ether-fi ETHFI ](https://www.coingecko.com/en/coins/ether-
fi)

[![ena](https://assets.kraken.com/marketing/web/icons/sym-
ena_colored.svg)Ethena ENA ](https://www.coingecko.com/en/coins/ethena)

[![alt](https://assets.kraken.com/marketing/web/icons/sym-
alt_colored.svg)AltLayer ALT ](https://www.coingecko.com/en/coins/altlayer)

[![pendle](https://assets.kraken.com/marketing/web/icons/sym-
pendle_colored.svg)Pendle PENDLE ](https://www.coingecko.com/en/coins/pendle)

[![portal](https://assets.kraken.com/marketing/web/icons/sym-
portal_colored.svg)Portal PORTAL ](https://www.coingecko.com/en/coins/portal)

[![safe](https://assets.kraken.com/marketing/web/icons/sym-
safe_colored.svg)Safe SAFE ](https://www.coingecko.com/en/coins/safe)

[![mpl](https://assets.kraken.com/marketing/web/icons/sym-
mpl_colored.svg)Maple MPL ](https://www.coingecko.com/en/coins/maple)

[![aevo](https://assets.kraken.com/marketing/web/icons/sym-
aevo_colored.svg)Aevo AEVO ](https://www.coingecko.com/en/coins/aevo)

# Solana

[![popcat](https://assets.kraken.com/marketing/web/icons/sym-
popcat_colored.svg)Popcat POPCAT ](https://www.coingecko.com/en/coins/popcat)

[![wen](https://assets.kraken.com/marketing/web/icons/sym-wen_colored.svg)Wen
Solana WEN ](https://www.coingecko.com/en/coins/wen-solana)

[![boden](https://assets.kraken.com/marketing/web/icons/sym-
boden_colored.svg)Jeo Boden BODEN ](https://www.coingecko.com/en/coins/jeo-
boden)

[![tremp](https://assets.kraken.com/marketing/web/icons/sym-
tremp_colored.svg)Doland Tremp TREMP
](https://www.coingecko.com/en/coins/doland-tremp)

[![tnsr](https://assets.kraken.com/marketing/web/icons/sym-
tnsr_colored.svg)Tensor TNSR ](https://www.coingecko.com/en/coins/tensor)

[![zeus](https://assets.kraken.com/marketing/web/icons/sym-
zeus_colored.svg)Zeus Network ZEUS ](https://www.coingecko.com/en/coins/zeus-
network)

[![nos](https://assets.kraken.com/marketing/web/icons/sym-
nos_colored.svg)Nosana NOS ](https://www.coingecko.com/en/coins/nosana)
...
Please submit **one application per asset**. For example, if you would like to
list your chain’s native token — and would also like to list a stablecoin from
that chain on Kraken — two applications are required.

Additionally, **do not** ask your community to submit multiple applications on
your behalf – this will only lower your chances of a successful outcome.

* * *

  2. ### What does Kraken look for in a listing application?

Please make specific and detailed reference to the utility of your token,
tokenomics and relevant on-chain metrics. Where possible, also include links
to publicly available sources and documentation.

* * *

  3. ### When can I expect to hear back on my application?

All applications are subject to a rigorous evaluation process. We aim to be
proactive in providing updates throughout the process and will reach out if we
need additional information. In the meantime, please do not follow up on your
application or reach out to individuals at Kraken in an effort to influence
...
We have strict legal, compliance, engineering and business standards for every
listing. Once our Listing Committee evaluates all information submitted via an
application (as well as other publicly available sources), and a decision to
list an asset is made, the asset will be added to our roadmap.  
  
Kraken’s listing roadmap is subject to change and does not guarantee a
listing.
...
Our listing process is strictly merit based and independent of any listing
fees.
...
Email
[listing@kraken.com](mailto:listing@kraken.com?subject=Kraken%20asset%20listing)

Please note, requests for new listings will only be considered through
submission of the standard application form.

* * *

# Ready to get listed?

Launch your asset to our global audience
...
[Get the App](https://kraken.app.link/rXVDOtb5iGb)
