...
[Home](/) / [Staking](/features/staking-coins) / Sei

# Crypto staking

![sei](https://assets.kraken.com/marketing/web/icons/sym-o.svg)
...
# Earn 1-4% by staking Sei (SEI)

Staking Sei lets you earn rewards on your SEI holdings while helping to secure
the Sei network. Create a Kraken account to stake your SEI and earn 1-4% APY.
...
In just a few steps, you can start staking your SEI in the Kraken mobile app
or on the web.
...
Stake your SEI to earn up to 1-4% APY

[Sign up](https://krakenpro.app.link/2MPaEYajHFb)

[Sign up](/sign-up?rfr=pro-web)

## Why stake SEI with Kraken

##### Fast. Easy. No minimums.

Stake any amount of SEI in minutes

##### Exchange integration

One login for staking, buying, selling and trading SEI
...
With Kraken, it only takes a few minutes to stake Sei
...
#### [How to buy Sei](/learn/buy-sei-sei)

Learn how to buy Sei easily and safely through Kraken.

#### [How to sell Sei](/learn/sell-sei-sei)

Cash out of Sei with flexible funding options.

#### [Sei price](/prices/sei)

Discover SEI price trends, charts, and history with Kraken.

### Swap Sei for other assets

After you buy Sei, you can trade it for fiat currencies and other
...
[SEI to USD](/convert/sei/usd )

![sei](https://assets.kraken.com/marketing/web/icons/sym-o.svg)

![eur](https://assets.kraken.com/marketing/web/icons/sym-eur_colored.svg)

[SEI to EUR](/convert/sei/eur )

![sei](https://assets.kraken.com/marketing/web/icons/sym-o.svg)

![eth](https://assets.kraken.com/marketing/web/icons/sym-eth_colored.svg)

[SEI to ETH](/convert/sei/eth )

![sei](https://assets.kraken.com/marketing/web/icons/sym-o.svg)

![usdt](https://assets.kraken.com/marketing/web/icons/sym-usdt_colored.svg)

[SEI to USDT](/convert/sei/usdt )

![sei](https://assets.kraken.com/marketing/web/icons/sym-o.svg)

![gbp](https://assets.kraken.com/marketing/web/icons/sym-gbp_colored.svg)

[SEI to GBP](/convert/sei/gbp )

![sei](https://assets.kraken.com/marketing/web/icons/sym-o.svg)

![cad](https://assets.kraken.com/marketing/web/icons/sym-cad_colored.svg)

[SEI to CAD](/convert/sei/cad )

## FAQ

## Sei staking FAQ:

  1. ### Can I convert SEI to USD?

You can easily convert SEI to USD by taking the price of Sei multiplied by the
number of SEI tokens you hold. See our [Sei converter](/convert/sei/usd) for
details.
...
like Sei, SEI tokens are staked in order to make network validators eligible
to verify transactions and incentivize their honest behavior. The amount of
SEI a validator stakes is directly proportional to the likelihood that they
will be chosen to validate the transaction, with some degree of randomness.
Those chosen to verify a transaction on a Proof-of-Stake blockchain like Sei
are rewarded with SEI.

  3. ### Can I stake SEI using my hardware wallet?

It is not possible to stake Sei on Kraken using your hardware wallet. If you
already have SEI in a hardware wallet, you can easily transfer it to Kraken’s
secure staking platform.

  4. ### How do I run a Sei validator node?

Running a Sei validator node is a technically complex and costly process which
requires a significant amount of resources. Because many feel the investment
in running a Sei node is too great, they often choose to stake their SEI using
an easy and secure service like Kraken.
...
chain” in Proof-of-Stake protocols such as Sei. Off-chain staking utilizes
