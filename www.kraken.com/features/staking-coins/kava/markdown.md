...
[Home](/) / [Staking](/features/staking-coins) / Kava
...
# Earn 3-6% by staking Kava (KAVA)

Staking Kava lets you earn rewards on your KAVA holdings while helping to
secure the Kava network. Create a Kraken account to stake your KAVA and earn
3-6% APY.
...
In just a few steps, you can start staking your KAVA in the Kraken mobile app
or on the web.
...
Stake your KAVA to earn up to 3-6% APY
...
Stake any amount of KAVA in minutes

##### Exchange integration

One login for staking, buying, selling and trading KAVA
...
With Kraken, it only takes a few minutes to stake Kava
...
#### [How to buy Kava](/learn/buy-kava-kava)

Learn how to buy Kava easily and safely through Kraken.

#### [How to sell Kava](/learn/sell-kava-kava)

Cash out of Kava with flexible funding options.

#### [Kava price](/prices/kava)

Discover KAVA price trends, charts, and history with Kraken.

### Swap Kava for other assets

After you buy Kava, you can trade it for fiat currencies and other
...
[KAVA to USD](/convert/kava/usd )

![kava](https://assets.kraken.com/marketing/web/icons/sym-kava_colored.svg)

![eur](https://assets.kraken.com/marketing/web/icons/sym-eur_colored.svg)

[KAVA to EUR](/convert/kava/eur )

![kava](https://assets.kraken.com/marketing/web/icons/sym-kava_colored.svg)

![eth](https://assets.kraken.com/marketing/web/icons/sym-eth_colored.svg)

[KAVA to ETH](/convert/kava/eth )

![kava](https://assets.kraken.com/marketing/web/icons/sym-kava_colored.svg)

![usdt](https://assets.kraken.com/marketing/web/icons/sym-usdt_colored.svg)

[KAVA to USDT](/convert/kava/usdt )

![kava](https://assets.kraken.com/marketing/web/icons/sym-kava_colored.svg)

![gbp](https://assets.kraken.com/marketing/web/icons/sym-gbp_colored.svg)

[KAVA to GBP](/convert/kava/gbp )

![kava](https://assets.kraken.com/marketing/web/icons/sym-kava_colored.svg)

![cad](https://assets.kraken.com/marketing/web/icons/sym-cad_colored.svg)

[KAVA to CAD](/convert/kava/cad )

## FAQ

## Kava staking FAQ:

  1. ### Can I convert KAVA to USD?

You can easily convert KAVA to USD by taking the price of Kava multiplied by
the number of KAVA tokens you hold. See our [Kava
converter](/convert/kava/usd) for details.
...
like Kava, KAVA tokens are staked in order to make network validators eligible
to verify transactions and incentivize their honest behavior. The amount of
KAVA a validator stakes is directly proportional to the likelihood that they
will be chosen to validate the transaction, with some degree of randomness.
Those chosen to verify a transaction on a Proof-of-Stake blockchain like Kava
are rewarded with KAVA.

  3. ### Can I stake KAVA using my hardware wallet?

It is not possible to stake Kava on Kraken using your hardware wallet. If you
already have KAVA in a hardware wallet, you can easily transfer it to Kraken’s
secure staking platform.

  4. ### How do I run a Kava validator node?

Running a Kava validator node is a technically complex and costly process
which requires a significant amount of resources. Because many feel the
investment in running a Kava node is too great, they often choose to stake
their KAVA using an easy and secure service like Kraken.
...
chain” in Proof-of-Stake protocols such as Kava. Off-chain staking utilizes
