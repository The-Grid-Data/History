...
[Home](/) / [Staking](/features/staking-coins) / USDC
...
# Earn 5.75% on USDC (USDC) with opt-in rewards

Opt-in rewards let you earn rewards on your USDC holdings. Create a Kraken
account to earn 5.75% APY on your USDC holdings.
...
## How to earn rewards on USDC

In just a few steps, you can earn rewards on your USDC in the Kraken mobile
app or on the web.
...
Opt-in to earn up to 5.75% APY on your USDC

[Sign up](https://krakenpro.app.link/2MPaEYajHFb)

[Sign up](/sign-up?rfr=pro-web)

## Why earn rewards on USDC with Kraken

##### Fast. Easy. No minimums.

Earn rewards on any amount of USDC in minutes

##### Exchange integration

One login for buying, selling, trading and earning rewards on USDC
...
With Kraken, it only takes a few minutes to earn rewards on USDC
...
#### [How to buy USDC](/learn/buy-usdc-usdc)

Learn how to buy USDC easily and safely through Kraken.

#### [How to sell USDC](/learn/sell-usdc-usdc)

Cash out of USDC with flexible funding options.

#### [USDC price](/prices/usdc)

Discover USDC price trends, charts, and history with Kraken.

### Swap USDC for other assets

After you buy USDC, you can trade it for fiat currencies and other
...
[USDC to USD](/convert/usdc/usd )

![usdc](https://assets.kraken.com/marketing/web/icons/sym-usdc_colored.svg)

![eur](https://assets.kraken.com/marketing/web/icons/sym-eur_colored.svg)

[USDC to EUR](/convert/usdc/eur )

![usdc](https://assets.kraken.com/marketing/web/icons/sym-usdc_colored.svg)

![eth](https://assets.kraken.com/marketing/web/icons/sym-eth_colored.svg)

[USDC to ETH](/convert/usdc/eth )

![usdc](https://assets.kraken.com/marketing/web/icons/sym-usdc_colored.svg)

![usdt](https://assets.kraken.com/marketing/web/icons/sym-usdt_colored.svg)

[USDC to USDT](/convert/usdc/usdt )

![usdc](https://assets.kraken.com/marketing/web/icons/sym-usdc_colored.svg)

![gbp](https://assets.kraken.com/marketing/web/icons/sym-gbp_colored.svg)

[USDC to GBP](/convert/usdc/gbp )

![usdc](https://assets.kraken.com/marketing/web/icons/sym-usdc_colored.svg)

![cad](https://assets.kraken.com/marketing/web/icons/sym-cad_colored.svg)

[USDC to CAD](/convert/usdc/cad )

## FAQ

## USDC opt-in rewards FAQ:

  1. ### Do I need to lock up my USDC for a period of time when earning rewards on Kraken?

There is no lockup period for earning rewards on USDC on Kraken — you are free
to stop earning rewards any time if you want to convert into another
cryptocurrency or cash out your rewards.

  2. ### Can I opt-in to earning rewards on USDC using my hardware wallet?

It is not possible to earn rewards on USDC on Kraken using your hardware
wallet. If you already have USDC in a hardware wallet, you can easily transfer
it to Kraken’s secure rewards platform.

  1. ### Can I convert USDC to USD?

You can easily convert USDC to USD by taking the price of USDC multiplied by
the number of USDC tokens you hold. See our [USDC price page](/prices/usdc)
