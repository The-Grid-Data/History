...
[Home](/) / [Staking](/features/staking-coins) / Polkadot
...
# Earn 7-11% by staking Polkadot (DOT)

Staking Polkadot lets you earn rewards on your DOT holdings while helping to
secure the Polkadot network. Create a Kraken account to stake your DOT and
earn 7-11% APY.
...
In just a few steps, you can start staking your DOT in the Kraken mobile app
or on the web.
...
Stake your DOT to earn up to 7-11% APY

[Sign up](https://krakenpro.app.link/2MPaEYajHFb)

[Sign up](/sign-up?rfr=pro-web)

## Why stake DOT with Kraken

##### Fast. Easy. No minimums.

Stake any amount of DOT in minutes

##### Exchange integration

One login for staking, buying, selling and trading DOT
...
With Kraken, it only takes a few minutes to stake Polkadot
...
#### [How to buy Polkadot](/learn/buy-polkadot-dot)

Learn how to buy Polkadot easily and safely through Kraken.

#### [How to sell Polkadot](/learn/sell-polkadot-dot)

Cash out of Polkadot with flexible funding options.

#### [Polkadot price](/prices/polkadot)

Discover DOT price trends, charts, and history with Kraken.

### Swap Polkadot for other assets

After you buy Polkadot, you can trade it for fiat currencies and other
cryptocurrencies. Kraken offers instant trades and reliable uptime on over 200
Polkadot trading pairs.
...
## Polkadot staking FAQ:

  1. ### Can I convert DOT to USD?

You can easily convert DOT to USD by taking the price of Polkadot multiplied
by the number of DOT tokens you hold. See our [Polkadot
converter](/convert/dot/usd) for details.
...
like Polkadot, DOT tokens are staked in order to make network validators
eligible to verify transactions and incentivize their honest behavior. The
amount of DOT a validator stakes is directly proportional to the likelihood
...
blockchain like Polkadot are rewarded with DOT.

  3. ### Can I stake DOT using my hardware wallet?

It is not possible to stake Polkadot on Kraken using your hardware wallet. If
you already have DOT in a hardware wallet, you can easily transfer it to
Kraken’s secure staking platform.

  4. ### How do I run a Polkadot validator node?

Running a Polkadot validator node is a technically complex and costly process
which requires a significant amount of resources. Because many feel the
investment in running a Polkadot node is too great, they often choose to stake
their DOT using an easy and secure service like Kraken.
...
chain” in Proof-of-Stake protocols such as Polkadot. Off-chain staking
