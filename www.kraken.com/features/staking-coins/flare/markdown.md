...
[Home](/) / [Staking](/features/staking-coins) / Flare
...
# Earn 0.1-2% by staking Flare (FLR)

Staking Flare lets you earn rewards on your FLR holdings while helping to
secure the Flare network. Create a Kraken account to stake your FLR and earn
0.1-2% APY.
...
In just a few steps, you can start staking your FLR in the Kraken mobile app
or on the web.
...
Stake your FLR to earn up to 0.1-2% APY

[Sign up](https://krakenpro.app.link/2MPaEYajHFb)

[Sign up](/sign-up?rfr=pro-web)

## Why stake FLR with Kraken

##### Fast. Easy. No minimums.

Stake any amount of FLR in minutes

##### Exchange integration

One login for staking, buying, selling and trading FLR
...
With Kraken, it only takes a few minutes to stake Flare
...
#### [How to buy Flare](/learn/buy-flare-flr)

Learn how to buy Flare easily and safely through Kraken.

#### [How to sell Flare](/learn/sell-flare-flr)

Cash out of Flare with flexible funding options.

#### [Flare price](/prices/flare)

Discover FLR price trends, charts, and history with Kraken.

### Swap Flare for other assets

After you buy Flare, you can trade it for fiat currencies and other
...
[FLR to USD](/convert/flr/usd )

![flr](https://assets.kraken.com/marketing/web/icons/sym-flr_colored.svg)

![eur](https://assets.kraken.com/marketing/web/icons/sym-eur_colored.svg)

[FLR to EUR](/convert/flr/eur )

![flr](https://assets.kraken.com/marketing/web/icons/sym-flr_colored.svg)

![eth](https://assets.kraken.com/marketing/web/icons/sym-eth_colored.svg)

[FLR to ETH](/convert/flr/eth )

![flr](https://assets.kraken.com/marketing/web/icons/sym-flr_colored.svg)

![usdt](https://assets.kraken.com/marketing/web/icons/sym-usdt_colored.svg)

[FLR to USDT](/convert/flr/usdt )

![flr](https://assets.kraken.com/marketing/web/icons/sym-flr_colored.svg)

![gbp](https://assets.kraken.com/marketing/web/icons/sym-gbp_colored.svg)

[FLR to GBP](/convert/flr/gbp )

![flr](https://assets.kraken.com/marketing/web/icons/sym-flr_colored.svg)

![cad](https://assets.kraken.com/marketing/web/icons/sym-cad_colored.svg)

[FLR to CAD](/convert/flr/cad )

## FAQ

## Flare staking FAQ:

  1. ### Can I convert FLR to USD?

You can easily convert FLR to USD by taking the price of Flare multiplied by
the number of FLR tokens you hold. See our [Flare converter](/convert/flr/usd)
for details.
...
like Flare, FLR tokens are staked in order to make network validators eligible
to verify transactions and incentivize their honest behavior. The amount of
FLR a validator stakes is directly proportional to the likelihood that they
will be chosen to validate the transaction, with some degree of randomness.
Those chosen to verify a transaction on a Proof-of-Stake blockchain like Flare
are rewarded with FLR.

  3. ### Can I stake FLR using my hardware wallet?

It is not possible to stake Flare on Kraken using your hardware wallet. If you
already have FLR in a hardware wallet, you can easily transfer it to Kraken’s
secure staking platform.

  4. ### How do I run a Flare validator node?

Running a Flare validator node is a technically complex and costly process
which requires a significant amount of resources. Because many feel the
investment in running a Flare node is too great, they often choose to stake
their FLR using an easy and secure service like Kraken.
...
chain” in Proof-of-Stake protocols such as Flare. Off-chain staking utilizes
