...
[Home](/) / [Staking](/features/staking-coins) / Polygon
...
# Earn 1-3% by staking Polygon (MATIC)

Staking Polygon lets you earn rewards on your MATIC holdings while helping to
secure the Polygon network. Create a Kraken account to stake your MATIC and
earn 1-3% APY.
...
In just a few steps, you can start staking your MATIC in the Kraken mobile app
or on the web.

Create your free Kraken account

Buy or deposit MATIC

Stake your MATIC to earn up to 1-3% APY

[Sign up](https://krakenpro.app.link/2MPaEYajHFb)

[Sign up](/sign-up?rfr=pro-web)

## Why stake MATIC with Kraken

##### Fast. Easy. No minimums.

Stake any amount of MATIC in minutes

##### Exchange integration

One login for staking, buying, selling and trading MATIC
...
With Kraken, it only takes a few minutes to stake Polygon
...
#### [How to buy Polygon](/learn/buy-polygon-matic)

Learn how to buy Polygon easily and safely through Kraken.

#### [How to sell Polygon](/learn/sell-polygon-matic)

Cash out of Polygon with flexible funding options.

#### [Polygon price](/prices/polygon)

Discover MATIC price trends, charts, and history with Kraken.

### Swap Polygon for other assets

After you buy Polygon, you can trade it for fiat currencies and other
...
[MATIC to USD](/convert/matic/usd )

![matic](https://assets.kraken.com/marketing/web/icons/sym-matic_colored.svg)

![eur](https://assets.kraken.com/marketing/web/icons/sym-eur_colored.svg)

[MATIC to EUR](/convert/matic/eur )

![matic](https://assets.kraken.com/marketing/web/icons/sym-matic_colored.svg)

![eth](https://assets.kraken.com/marketing/web/icons/sym-eth_colored.svg)

[MATIC to ETH](/convert/matic/eth )

![matic](https://assets.kraken.com/marketing/web/icons/sym-matic_colored.svg)

![usdt](https://assets.kraken.com/marketing/web/icons/sym-usdt_colored.svg)

[MATIC to USDT](/convert/matic/usdt )

![matic](https://assets.kraken.com/marketing/web/icons/sym-matic_colored.svg)

![gbp](https://assets.kraken.com/marketing/web/icons/sym-gbp_colored.svg)

[MATIC to GBP](/convert/matic/gbp )

![matic](https://assets.kraken.com/marketing/web/icons/sym-matic_colored.svg)

![cad](https://assets.kraken.com/marketing/web/icons/sym-cad_colored.svg)

[MATIC to CAD](/convert/matic/cad )

## FAQ

## Polygon staking FAQ:

  1. ### Can I convert MATIC to USD?

You can easily convert MATIC to USD by taking the price of Polygon multiplied
by the number of MATIC tokens you hold. See our [Polygon
converter](/convert/matic/usd) for details.
...
like Polygon, MATIC tokens are staked in order to make network validators
eligible to verify transactions and incentivize their honest behavior. The
amount of MATIC a validator stakes is directly proportional to the likelihood
...
blockchain like Polygon are rewarded with MATIC.

  3. ### Can I stake MATIC using my hardware wallet?

It is not possible to stake Polygon on Kraken using your hardware wallet. If
you already have MATIC in a hardware wallet, you can easily transfer it to
Kraken’s secure staking platform.

  4. ### How do I run a Polygon validator node?

Running a Polygon validator node is a technically complex and costly process
which requires a significant amount of resources. Because many feel the
investment in running a Polygon node is too great, they often choose to stake
their MATIC using an easy and secure service like Kraken.
...
chain” in Proof-of-Stake protocols such as Polygon. Off-chain staking utilizes
