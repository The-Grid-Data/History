...
[Home](/) / [Staking](/features/staking-coins) / Secret
...
# Earn 6-10% by staking Secret (SCRT)

Staking Secret lets you earn rewards on your SCRT holdings while helping to
secure the Secret network. Create a Kraken account to stake your SCRT and earn
6-10% APY.
...
In just a few steps, you can start staking your SCRT in the Kraken mobile app
or on the web.
...
Stake your SCRT to earn up to 6-10% APY
...
Stake any amount of SCRT in minutes

##### Exchange integration

One login for staking, buying, selling and trading SCRT
...
With Kraken, it only takes a few minutes to stake Secret
...
#### [How to buy Secret](/learn/buy-secret-scrt)

Learn how to buy Secret easily and safely through Kraken.

#### [How to sell Secret](/learn/sell-secret-scrt)

Cash out of Secret with flexible funding options.

#### [Secret price](/prices/secret)

Discover SCRT price trends, charts, and history with Kraken.

### Swap Secret for other assets

After you buy Secret, you can trade it for fiat currencies and other
cryptocurrencies. Kraken offers instant trades and reliable uptime on over 200
Secret trading pairs.
...
[SCRT to USD](/convert/scrt/usd )

![scrt](https://assets.kraken.com/marketing/web/icons/sym-scrt_colored.svg)

![eur](https://assets.kraken.com/marketing/web/icons/sym-eur_colored.svg)

[SCRT to EUR](/convert/scrt/eur )

![scrt](https://assets.kraken.com/marketing/web/icons/sym-scrt_colored.svg)

![eth](https://assets.kraken.com/marketing/web/icons/sym-eth_colored.svg)

[SCRT to ETH](/convert/scrt/eth )

![scrt](https://assets.kraken.com/marketing/web/icons/sym-scrt_colored.svg)

![usdt](https://assets.kraken.com/marketing/web/icons/sym-usdt_colored.svg)

[SCRT to USDT](/convert/scrt/usdt )

![scrt](https://assets.kraken.com/marketing/web/icons/sym-scrt_colored.svg)

![gbp](https://assets.kraken.com/marketing/web/icons/sym-gbp_colored.svg)

[SCRT to GBP](/convert/scrt/gbp )

![scrt](https://assets.kraken.com/marketing/web/icons/sym-scrt_colored.svg)

![cad](https://assets.kraken.com/marketing/web/icons/sym-cad_colored.svg)

[SCRT to CAD](/convert/scrt/cad )

## FAQ

## Secret staking FAQ:

  1. ### Can I convert SCRT to USD?

You can easily convert SCRT to USD by taking the price of Secret multiplied by
the number of SCRT tokens you hold. See our [Secret
converter](/convert/scrt/usd) for details.
...
like Secret, SCRT tokens are staked in order to make network validators
eligible to verify transactions and incentivize their honest behavior. The
amount of SCRT a validator stakes is directly proportional to the likelihood
...
blockchain like Secret are rewarded with SCRT.

  3. ### Can I stake SCRT using my hardware wallet?

It is not possible to stake Secret on Kraken using your hardware wallet. If
you already have SCRT in a hardware wallet, you can easily transfer it to
Kraken’s secure staking platform.

  4. ### How do I run a Secret validator node?

Running a Secret validator node is a technically complex and costly process
which requires a significant amount of resources. Because many feel the
investment in running a Secret node is too great, they often choose to stake
their SCRT using an easy and secure service like Kraken.
...
chain” in Proof-of-Stake protocols such as Secret. Off-chain staking utilizes
assets “Off-chain” (as further described in our Terms of Service). You can
view your eligibility for Off-chain staking
