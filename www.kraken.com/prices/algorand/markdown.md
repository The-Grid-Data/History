...
[Home](/) / [Crypto Prices](/prices) / Algorand
...
Kraken Price Chart$0.20$0.20$0.20$0.19$0.19$0.19
...
[Buy Algorand](/sign-up)

[Buy Algorand](https://kraken.app.link/LFAFiCIbHFb)

## Algorand (ALGO) Price Today

The current Algorand price is $0.19.

In the last 24 hours Algorand price moved -2.21%. The current [ALGO to
USD](/convert/algo/usd) conversion rate is $0.19 per ALGO. The circulating
supply of Algorand is** ** 8,201,464,884 ALGO and the current Algorand market
cap is $1,555,366,808.

3,874,570 ALGO was purchased today on Kraken worth $734,793. Have you placed
your ALGO order yet? Kraken makes it easy to get started. Sign up today to buy
and sell 246 cryptocurrencies. [View all crypto prices](/prices).

## Algorand (ALGO) Price History

Algorand price is +24.91% over the last year. The highest price of ALGO in the
last year was $0.32 and the lowest price of Algorand in the last year was
$0.088.
...
Analyze trends, spot opportunities and trade Algorand like a pro

[Try advanced view](https://krakenpro.app.link/8AJgTavutGb)

[Try advanced view](https://pro.kraken.com/app/trade/algo-usd)

### Get started with Algorand

#### [Buy Algorand](/learn/buy-algorand-algo)

Learn how to buy Algorand easily and safely through Kraken.

#### [Sell Algorand](/learn/sell-algorand-algo)

Cash out of Algorand with flexible funding options.

#### [Algorand staking](/features/staking-coins/algorand)

See if you can earn rewards on your Algorand.

## Algorand FAQ

* * *

## Can I trade Algorand at a lower price?

Yes, you can choose what price you pay for Algorand using Custom Orders on
Kraken. If the price of Algorand reaches to your desired price, the order will
execute automatically.

## Is now a good time to buy Algorand?

Timing the market can be tough, but dollar cost averaging can help. By setting
up recurring buys, you can constantly accumulate Algorand over time and not
worry about whether or not now is the best time to buy.

## What is the daily trading volume of Algorand?

3,874,570 ALGO worth $734,793 was traded on Kraken in the last 24 hours.

## What affects the Algorand price?

A variety of factors affect the price of Algorand including market sentiment,
...
### Algorand Dollar Cost Averaging Calculator
...
[![Algorand](/_assets/images/generic-article-0.png)What is Algorand?
(ALGO)Want to learn more about Algorand? Read how Algorand works and the
unique features of the ALGO cryptocurrency.Read more »](/learn/what-is-
algorand-algo)
...
Buy Algorand in minutes with Kraken. **Get started with $10 today**.
...
Explore popular Algorand trading pairs on Kraken. You can swap ALGO for cash,
