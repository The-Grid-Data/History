...
[Home](/) / [Crypto Prices](/prices) / USDC
...
Kraken Price Chart$1.00$1.00$1.00$1.00$1.00
...
[Buy USDC](https://kraken.app.link/LFAFiCIbHFb)

## USDC (USDC) Price Today

The current USDC price is $1.00.

In the last 24 hours USDC price moved -0.16%. The current [USDC to
USD](/convert/usdc/usd) conversion rate is $1.00 per USDC. The circulating
supply of USDC is** ** 32,481,568,861 USDC and the current USDC market cap is
$32,426,837,417.

52,609,415 USDC was purchased today on Kraken worth $52,520,769. Have you
placed your USDC order yet? Kraken makes it easy to get started. Sign up today
to buy and sell 246 cryptocurrencies. [View all crypto prices](/prices).

## USDC (USDC) Price History

USDC price is -0.22% over the last year. The highest price of USDC in the last
year was $1.00 and the lowest price of USDC in the last year was $1.00.
...
### Top cryptocurrencies by market cap
  ...
  * [![usdc](https://assets.kraken.com/marketing/web/icons/sym-usdc_colored.svg)USDCUSDC-0.16%$1.00](/prices/usdc)
...
Analyze trends, spot opportunities and trade USDC like a pro

[Try advanced view](https://krakenpro.app.link/8AJgTavutGb)

[Try advanced view](https://pro.kraken.com/app/trade/usdc-usd)

### Get started with USDC

#### [Buy USDC](/learn/buy-usdc-usdc)

Learn how to buy USDC easily and safely through Kraken.

#### [Sell USDC](/learn/sell-usdc-usdc)

Cash out of USDC with flexible funding options.

#### [USDC rewards](/features/staking-coins/usdc)

See if you can earn rewards on your USDC.

## USDC FAQ

* * *

## Can I trade USDC at a lower price?

Yes, you can choose what price you pay for USDC using Custom Orders on Kraken.
If the price of USDC reaches to your desired price, the order will execute
automatically.

## Is now a good time to buy USDC?

Timing the market can be tough, but dollar cost averaging can help. By setting
up recurring buys, you can constantly accumulate USDC over time and not worry
about whether or not now is the best time to buy.

## What is the daily trading volume of USDC?

52,609,415 USDC worth $52,520,769 was traded on Kraken in the last 24 hours.

## What affects the USDC price?

A variety of factors affect the price of USDC including market sentiment,
...
[![USDC](/_assets/images/generic-article-0.png)What is USD Coin? (USDC)Want to
learn more about USDC? Read how USDC works and the unique features of the USDC
cryptocurrency.Read more »](/learn/what-is-usd-coin-usdc)

###### $

###### 10

Buy USDC in minutes with Kraken. **Get started with $10 today**.
...
Explore popular USDC trading pairs on Kraken. You can swap USDC for cash,
