...
Bitter Ã© uma carteira simples e segura em muitas plataformas. Com modo frio /
quente especialmente projetado, o usuÃ¡rio pode obter seguranÃ§a e
simplicidade. O XRANDOM do Bither usa diferentes fontes de entropia para gerar
nÃºmeros aleatÃ³rios para os usuÃ¡rios. Ainda com HDM, os usuÃ¡rios podem ter
as vantagens do HD e a seguranÃ§a de Multi-assinatura.
...
Esta carteira usa SPV e a rede Bitcoin. Isso significa muito pouca confianÃ§a
em terceiros Ã© necessÃ¡ria quando a verificaÃ§Ã£o de pagamentos. No entanto,
nÃ£o Ã© tÃ£o seguro quanto um full node como [Bitcoin Core](/pt_BR/download).
...
Esta carteira Ã© carregada em celulares aonde os apps estÃ£o geralmente
...
Divulga uma quantidade de informaÃ§Ã£o limitada aos usuÃ¡rios

UsuÃ¡rios na rede podem registrar o seu endereÃ§o IP e associar junto os seus
pagamentos ao receber ou enviar pagamento.
...
SugestÃ£o para taxa estÃ¡tica

Esta carteira nÃ£o fornece sugestÃµes de tarifas baseadas em condiÃ§Ãµes de
rede atuais. Isso significa que suas transaÃ§Ãµes podem estar sujeitas a
atrasos se a taxa escolhida for muito baixa, ou que vocÃª possa pagar uma taxa
que Ã© muito alta.
...
[Instalar](https://itunes.apple.com/us/app/bither/id899478936) [ CÃ³digo
fonte](https://github.com/bither/bither-ios)

![screenshot](/img/screenshots/bithermobile.png)

[Instalar](https://play.google.com/store/apps/details?id=net.bither) [ CÃ³digo
fonte](https://github.com/bither/bither-android)

![screenshot](/img/screenshots/bithermobile.png)

[Acessar o site](https://bither.net) [ CÃ³digo
fonte](https://github.com/bither/bither-desktop-java)
