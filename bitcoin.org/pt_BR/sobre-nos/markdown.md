...
Bitcoing.org Ã© dedicada a ajudar a Bitcoin a se desenvolver de forma
sustentÃ¡vel.

## Quem Ã© dono do bitcoin.org?
...
Bitcoin.org foi originalmente registrado e mantido pelos dois primeiros
desenvolvedores do Bitcoin, [Satoshi
Nakamoto](https://en.bitcoin.it/wiki/Satoshi_Nakamoto) e [Martti
Malmi](https://en.bitcoin.it/wiki/Sirius). Quando Nakamoto deixou o projeto,
ele deu propriedade do domÃ­nio a outras pessoas, alheias aos desenvolvedores
do Bitcoin, para dividir a responsabilidade e impedir que qualquer pessoa ou
grupo facilmente obtenha controle sobre o projeto Bitcoin.
...
De 2011 a 2013, o site foi usado principalmente para lanÃ§ar novas versÃµes do
software que agora Ã© chamado de Bitcoin Core. Em 2013, o site foi
reformulado, adicionando vÃ¡rias pÃ¡ginas, listando mais softwares Bitcoin e
criando o sistema de traduÃ§Ã£o.
...
### A documentaÃ§Ã£o para desenvolvedores foi adicionada em 2014

AtualizaÃ§Ãµes, correÃ§Ãµes, sugestÃµes e melhorias por membros da comunidade
sÃ£o bem-vindos.
...
### O site Ã© um projeto independente de cÃ³digo aberto

Atualmente, o site Ã© um projeto de cÃ³digo aberto ou open source
independente, com a participaÃ§Ã£o de pessoas do mundo inteiro. A autoridade
final de publicaÃ§Ã£o pertence aos coproprietÃ¡rios do domÃ­nio, porÃ©m todas
atividades de rotina sÃ£o organizadas atravÃ©s do processo de ["pull-
requests"](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/working-with-github.md) e gerenciadas pelos
co-mantenedores do site.

O Bitcoin.org nÃ£o Ã© o site oficial do Bitcoin. Assim como ninguÃ©m Ã© dono
da tecnologia de e-mail, ninguÃ©m Ã© dono da rede Bitcoin. Como tal, ninguÃ©m
pode falar com autoridade em nome do Bitcoin.

## EntÃ£o... quem controla o Bitcoin?

Bitcoin Ã© controlado por todos seus usuÃ¡rios ao redor do mundo.
Desenvolvedores estÃ£o sempre melhorando o software mas eles nÃ£o podem impor
novas regras, porque os usuÃ¡rios sÃ£o livres para escolher outros softwares,
caso nÃ£o concordem com as mudanÃ§as. Para que haja compatibilidade entre os
programas, eles precisam estar em conformidade com as mesmas regras. Bitcoin
sÃ³ funciona de forma adequada se existir total consenso entre os usuÃ¡rios.
Portanto, todos os usuÃ¡rios e desenvolvedores tÃªm fortes incentivos para
adotar e proteger este consenso.

## MissÃ£o

  * Informar usuÃ¡rios para protegÃª-los de erros comuns.
  * Descrever as reais propriedades, usos e limitaÃ§Ãµes do Bitcoin.
  * Divulgar alertas transparentes e eventos relativos Ã rede Bitcoin.
  * Convide pessoas talentosas para ajudar no desenvolvimento do Bitcoin em diferentes nÃ­veis.
  * Dar visibilidade ao ecossistema Bitcoin de grande escala.
  * Melhorar a acessibilidade do Bitcoin no mundo todo atravÃ©s da internacionalizaÃ§Ã£o.
  * Continua a ser um recurso informativo neutro sobre Bitcoin.

## Ajude-nos

VocÃª pode reportar qualquer problema ou ajudar a melhorar o site bitcoin.org
no [GitHub](https://github.com/bitcoin-dot-org/bitcoin.org#how-to-participate)
abrindo uma nova requisiÃ§Ã£o ou um "pull request" em inglÃªs. Quando for
submeter um pull request, por favor tome o tempo necessÃ¡rio para discutir
suas mudanÃ§as e adaptar seu trabalho. VocÃª pode ajudar com as traduÃ§Ãµes,
para isso basta se juntar a um time no
[Transifex.](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/assisting-with-translations.md) Por favor,
nÃ£o peÃ§a para promover o seu negÃ³cio ou o seu site pessoal, exceto em casos
especiais, como conferÃªncias. Muito obrigado a todos os contribuidores que
dedicam seu tempo melhorando o bitcoin.org!
...
ALL TOPICS
  ...
  * Contribuidores de ServiÃ§o
  * Contribuidores inativos
  * Donos do domÃ­nio
  * Contribuidores em GitHub
