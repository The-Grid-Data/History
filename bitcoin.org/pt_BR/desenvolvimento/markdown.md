...
Encontre mais informaÃ§Ãµes sobre a especificaÃ§Ã£o atual, software e
desenvolvedores.
...
ALL TOPICS
  ...
  * Outros projetos de cÃ³digo aberto

O desenvolvimento do Bitcoin Ã© cÃ³digo-livre sendo que qualquer desenvolvedor
pode contribuir para o projeto. Tudo que vocÃª precista estÃ¡ no [repositÃ³rio
GitHub](https://github.com/bitcoin/bitcoin). Por favor, certifique-se de ler e
seguir o processo de desenvolvimento descrito no README, bem como fornecer
cÃ³digo de boa qualidade e respeitar todas as orientaÃ§Ãµes.

DiscussÃµes de desenvolvimento acontecem no GitHub e a [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev)lista de
emails. DiscussÃµes menos formais acontecem em irc.freenode.net #bitcoin-core-
dev ([interface web](https://webchat.freenode.net/?channels=bitcoin-core-dev),
[logs](http://gnusha.org/bitcoin-core-dev/)).

## DocumentaÃ§Ã£o

Se vocÃª estiver interessado em aprender mais a respeito dos detalhes
tÃ©cnicos do Bitcoin e em como usar as ferramentas e APIs existentes,
recomendamos comeÃ§ar com [a documentaÃ§Ã£o para
programadores](https://developer.bitcoin.org/).

## Comunidades de desenvolvedores

As seguintes salas de bate-papo e web sites apresentam discussÃµes sobre o
desenvolvimento da Bitcoin. Por favor assegure-se de ler as regras de conduta
antes de enviar um comentÃ¡rio.

  * [Canal IRC #bitcoin-core-dev](https://webchat.freenode.net/?channels=bitcoin-core-dev) em freenode.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [FÃ³rum Bitcointalk sobre Desenvolvimento e DiscussÃµes TecnolÃ³gicas.](https://bitcointalk.org/index.php?board=6.0)
