...
Encuentre mÃ¡s informaciÃ³n sobre las especificaciones actuales, software y
desarrolladores.
...
El desarrollo de Bitcoin es de cÃ³digo abierto y cualquier desarrollador puede
contribuir con el proyecto. Todo lo que necesita estÃ¡ en el [repositorio
GitHub](https://github.com/bitcoin/bitcoin). Por favor asegÃºrese de leer y
seguir el proceso de desarrollo descrito en el README, asÃ­ como de proveer
cÃ³digo de alta calidad y respetar las directrices.

Las discusiones de desarrollo se llevan a cabo en GitHub y en la lista de
correo [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev) en
sourceforge. Las discusiones menos formales sobre el desarrollo se realizan en
el canal #bitcoin-dev de irc.freenode.net (interfaz web,
[registro](http://bitcoinstats.com)).

## DocumentaciÃ³n

Si estÃ¡ interesado en conocer mÃ¡s acerca de los detalles tÃ©cnicos de
Bitcoin y como utilizar las herramientas existentes y APIs, le recomendamos
comenzar explorando la [documentaciÃ³n de
desarrollador](https://developer.bitcoin.org/).

## Comunidades de desarrolladores

Las siguientes salas de chat y sitios web hospedan discusiones acerca del
desarrollo de Bitcoin. Por favor asegurese de leer el cÃ³digo de conducta
antes de publicar algo.

  * [Canal de IRC #bitcoin-dev](https://webchat.freenode.net/?channels=bitcoin-dev) en freenode.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [BitcoinTalk Development & Technical Discussion Forum](https://bitcointalk.org/index.php?board=6.0)

## Colaboradores de Bitcoin Core

(Ordenados por nÃºmero de confirmaciones)
