...
Bitcoin.org estÃ¡ dedicado a ayudar a Bitcoin a desarrollarse de forma
sostenible.

## Â¿QuiÃ©n es el dueÃ±o de bitcoin.org?
...
Bitcoin.org es el dominio original utilizado para la primera pÃ¡gina web de
Bitcoin. Fue registrado y sigue siendo gestionado por [los desarrolladores del
nÃºcleo de Bitcoin](/es/desarrollo) y por otros miembros de la comunidad, con
las aportaciones de las [comunidades de Bitcoin](/es/comunidad). Bitcoin.org
no es una pÃ¡gina web oficial. AsÃ­ como nadie es propietario de la
tecnologÃ­a del correo electrÃ³nico, nadie es propietario de la red Bitcoin.
Por tanto, nadie puede pretender hablar en nombre de Bitcoin.
...
## Entonces... quiÃ©n controla Bitcoin?

Bitcoin es controlado por todos los usuarios de Bitcoin alrededor del mundo.
Los desarrolladores estÃ¡n mejorando el software, pero no pueden forzar un
cambio en las reglas del protocolo de Bitcoin porque todos los usuarios son
libres de escoger el software que utilizan. Para permanecer compatibles unos
con otros, los usuarios deben usar software que cumpla con las mismas reglas.
Bitcoin solo puede funcionar bien con un consenso completo entre todos los
usuarios. Por lo tanto, todos los usuarios y desarrolladores tienen un fuerte
incentivo para adoptar y proteger este consenso.

## MisiÃ³n

  * Informar a los usuarios para protegerlos de errores comunes.
  * Dar una descripciÃ³n precisa de las propiedades de Bitcoin, sus potenciales usos y limitaciones.
  * Mostrar alertas pÃºblicas y eventos relacionados con la red Bitcoin.
  ...
  * Mejorar el acceso mundial a Bitcoin haciÃ©ndolo internacional.
  * Permanecer como un recurso informativo neutral sobre Bitcoin.

## AyÃºdanos

Usted puede reportar cualquier problema o ayudar a mejorar bitcoin.org
accediendo a [GitHub](https://github.com/bitcoin-dot-org/bitcoin.org#how-to-
participate) para abrir un problema o enviar un pull request en Ingles. Cuando
envÃ­e un pull request, por favor tome en cuenta el tiempo requerido para
discutir sus cambios y la adaptaciÃ³n de su trabajo. Puede ayudar con las
traducciones uniÃ©ndose a un equipo de traducciÃ³n en
[Transifex](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/assisting-with-translations.md). Por favor no
pida una promociÃ³n para su negocio personal o pÃ¡gina web, a excepciÃ³n de
casos especiales como conferencias. Â¡Muchas gracias a todos los
contribuidores que han pasado tiempo mejorando bitcoin.org!
