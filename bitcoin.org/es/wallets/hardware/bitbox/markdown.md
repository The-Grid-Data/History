...
La BitBox02 es una hardware wallet, desarrollada y manufacturada en Suiza.
EstÃ¡ equipada con una pantalla OLED, sensores tÃ¡ctiles invisibles, USB-C,
soporte para USB-A y copias de seguridad offline tanto en tarjeta microSD como
con semilla mnemotÃ©cnica BIP39. Configurar una cartera BitBox02 y gestionar
tus monedas se hace muy sencillo gracias a la BitBoxApp.
...
[Ir al sitio](https://shiftcrypto.ch/bitbox02/) [ CÃ³digo
fuente](https://github.com/BitBoxSwiss/bitbox02-firmware)
