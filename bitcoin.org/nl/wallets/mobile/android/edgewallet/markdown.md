...
Edge is een met Segwit compatibele, mobiele Bitcoin-portemonnee, met een hoog
niveau van privacy, veiligheid en decentralisatie, waardoor deze zeer
vertrouwd en bruikbaar is voor de massa. Edge-portemonnees worden altijd
automatisch gecodeerd en er wordt een back-up van gemaakt.
...
Gehoste controle over uw geld

Deze portemonnee geeft u controle over uw bitcoins. Deze dienst houdt echter
wel een geÃ«ncrypteerde kopie van uw portemonnee bij. Dit betekent dat uw
bitcoins gestolen kunnen worden als u geen sterk wachtwoord gebruikt en de
dienst is gecompromitteerd.

Gedecentraliseerde validatie

Deze portemonnee verbindt met een willekeurige server uit een lijst. Dit
betekent dat weinig vertrouwen in derde partijen vereist is tijdens het
verifiÃ«ren van betalingen. Het is echter niet even veilig als een "full node"
zoals [Bitcoin Core](/nl/download).
...
Deze dienst kan uw betalingen met elkaar associÃ«ren, uw IP-adres loggen en uw
echte identiteit herkennen als u persoonlijke informatie zoals uw e-mail, naam
of bankrekening verschaft.

Tor niet ondersteund

Met deze portemonnee kunt u geen Tor gebruiken om aanvallers of
internetproviders ervan te weerhouden uw betalingen met uw IP-adres in verband
te brengen.

Dynamische vergoeding met mogelijkheid tot overschrijving

Deze portefeuille biedt suggesties voor tarieven die op de huidige voorwaarden
van het netwerk zijn gebaseerd en die u kunt overschrijven. Dit betekent dat
deze portefeuille u helpt bij het kiezen van de juiste vergoeding, zodat uw
transacties tijdig worden bevestigd zonder meer te betalen dan strikt
noodzakelijk, maar uiteindelijk geeft u de controle als u de suggestie wilt
overrulen.
...
[Installeer](https://play.google.com/store/apps/details?id=co.edgesecure.app)
[ Broncode](https://github.com/EdgeApp/edge-react-gui)

![screenshot](/img/screenshots/edgewalletandroid.png)

[Installeer](https://itunes.apple.com/us/app/edge-bitcoin-wallet/id1344400091)
[ Broncode](https://github.com/EdgeApp/edge-react-gui)
