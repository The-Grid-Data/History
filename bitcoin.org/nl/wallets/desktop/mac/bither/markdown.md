...
Bither is een eenvoudige en veilige portemonnee op vele platformen. Met de
speciaal ontworpen koude/warme modes, kan de gebruiker gemakkelijk veiligheid
en eenvoud krijgen. Bither's XRANDOM gebruikt verschillende entropie bronnen
om echte willekeurige getallen voor gebruikers te genereren. Ook met HDM
kunnen gebruikers de voordelen van HD en de veiligheid van multisigs hebben.
...
Suggesties voor vaste vergoedingen

Deze portefeuille bevat geen suggesties voor tarieven die op de huidige
voorwaarden van het netwerk zijn gebaseerd. Dit betekent dat uw transacties
onderhevig kunnen zijn aan vertragingen als de gekozen vergoeding te laag is,
of dat u een vergoeding betaalt die te hoog is.
...
[Installeer](https://itunes.apple.com/us/app/bither/id899478936) [
Broncode](https://github.com/bither/bither-ios)

![screenshot](/img/screenshots/bithermobile.png)

[Installeer](https://play.google.com/store/apps/details?id=net.bither) [
Broncode](https://github.com/bither/bither-android)

![screenshot](/img/screenshots/bithermobile.png)

[Naar de website](https://bither.net) [
Broncode](https://github.com/bither/bither-desktop-java)
