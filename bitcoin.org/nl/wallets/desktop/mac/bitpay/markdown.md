...
BitPay Wallet is de HD-multisignature wallet die oorspronkelijk gebouwd werd
om de fondsen van BitPay zelf te beheren. BitPay Wallet ondersteunt meerdere
persoonlijke en gedeelde wallets, testnet en het Payment Protocol. Een
persoonlijke [BWS](https://github.com/bitpay/bitcore-wallet-service) node kan
gebruikt worden voor meer veiligheid en privacy.
...
[Naar de website](https://bitpay.com/wallet) [
Broncode](https://github.com/bitpay/copay)
