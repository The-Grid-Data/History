...
Electrum is gericht op snelheid en eenvoud en is zeer licht voor uw computer.
Het laat de ingewikkeldere taken van het Bitcoin-systeem uitvoeren door
servers elders en het biedt de mogelijkheid om uw portemonnee terug te vinden
met behulp van een geheime zin.
...
Deze portemonnee gebruikt SPV en willekeurige servers uit een lijst. Dit
betekent dat er zeer weinig vertrouwen in derde partijen nodig is bij het
verifiÃ«ren van betalingen. Het is echter niet zo veilig als een "full node"
...
Deze portemonnee kan gebruikt worden in onveilige omgevingen. Deze service
vereist echter wel dubbele authenticatie. Dit betekent dat toegang tot
meerdere toestellen of accounts vereist is voordat uw bitcoins gestolen kunnen
worden.
...
[Naar de website](https://electrum.org) [
Broncode](https://github.com/spesmilo/electrum)
...
[Installeer](https://play.google.com/store/apps/details?id=org.electrum.electrum)
[ Broncode](https://github.com/spesmilo/electrum)
