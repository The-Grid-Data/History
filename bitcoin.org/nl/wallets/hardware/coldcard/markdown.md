...
Coldcard is een eenvoudig te gebruiken, veilige en betaalbare hardware
portemonnee, waar u gemakkelijk een backup van kunt maken middels een
versleutelde microSD kaart. Uw priv̩ sleutel is opgeslagen op een speciaal
daarvoor bestemde, beveiligings chip. De in MicroPython ontwikkelde software
is open source en eventueel door u zelf aan te passen.
...
[Naar de website](https://coldcardwallet.com/) [
Broncode](https://github.com/Coldcard/firmware)
