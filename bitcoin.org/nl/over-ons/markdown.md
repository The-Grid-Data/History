...
Bitcoin.org is toegewijd om Bitcoin op een duurzame manier te helpen
ontwikkelen.

## Wie is eigenaar van bitcoin.org?
...
### Satoshi Nakamoto en Martti Malmi

Bitcoin.org werd oorspronkelijk geregistreerd en was eigendom van de eerste
twee ontwikkelaars van Bitcoin, [Satoshi
Nakamoto](https://en.bitcoin.it/wiki/Satoshi_Nakamoto) en [Martti
Malmi](https://en.bitcoin.it/wiki/Sirius). Toen Nakamoto het project verliet,
gaf hij het eigendom van het domein aan meer mensen, los van de Bitcoin-
ontwikkelaars, om de verantwoordelijkheid te spreiden en te voorkomen dat
Ã©Ã©n persoon of groep gemakkelijk de controle over het Bitcoin-project zou
krijgen.
...
Van 2011 tot 2013 werd de site voornamelijk gebruikt voor het uitbrengen van
nieuwe versies van de software die nu Bitcoin Core heet. In 2013 werd de site
herontworpen. Er werden tal van pagina's toegevoegd met onder andere extra
Bitcoin-software, en werd het vertaalsysteem toegevoegd.
...
### De documentatie voor ontwikkelaars is in 2014 toegevoegd.

Updates, oplossingen, suggesties en verbeteringen vanuit de leden van de
gemeenschap zijn welkom.
...
### De website is een onafhankelijk open-source project.

Tegenwoordig is de site een onafhankelijk open source project met
contribuanten uit de hele wereld. De uiteindelijke bevoegdheid tot publicatie
ligt bij de mede-eigenaars, maar alle reguliere werkzaamheden worden
georganiseerd via het openbare [pull-
aanvraagproces](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/working-with-github.md) en beheerd door de
mede-beheerders van de site.

Bitcoin.org is niet de officiÃ«le website van Bitcoin. Net als dat er niet
Ã©Ã©n eigenaar is van e-mailtechnologie, is er niet Ã©Ã©n eigenaar van het
Bitcoin-netwerk. Daarom kan niemand terecht (met authoriteit) claimen te
spreken in naam van Bitcoin.

## Maar wie heeft bij Bitcoin dan de touwtjes in handen?

Bitcoin wordt beheerd door alle Bitcoin-gebruikers ter wereld. Ontwikkelaars
zijn continu bezig de software te verbeteren, maar kunnen geen wijzigingen in
de regels van het Bitcoin-protocol doorvoeren omdat alle gebruikers vrij zijn
om te kiezen welke software ze gebruiken. Om met elkaar compatibel te blijven,
dienen alle gebruikers software te gebruiken die aan dezelfde regels voldoet.
Bitcoin werkt alleen naar behoren met een complete overeenstemming tussen alle
gebruikers. Daarom hebben alle gebruikers en ontwikkelaars een sterke
drijfveer om deze overeenstemming over te nemen en te beschermen.

## Missie

  * Informeer gebruikers om ze tegen veelvoorkomende fouten te behoeden.
  * Geef een nauwkeurige omschrijving van Bitcoin-eigenschappen, potentieel gebruik en beperkingen.
  * Geef duidelijke waarschuwingen en evenementen weer over het Bitcoin-netwerk.
  * Nodig getalenteerde mensen uit om op vele niveaus te helpen bij de ontwikkeling van Bitcoin.
  * Bied inzicht in het uitgebreide Bitcoin-ecosysteem.
  * Verbeter de wereldwijde toegankelijkheid van Bitcoin via internationalisatie.
  * Blijf een neutrale informatiebron over Bitcoin.

## Help ons

U kunt elk probleem of hulp bij het verbeteren van bitcoin.org op
[GitHub](https://github.com/bitcoin-dot-org/bitcoin.org#how-to-participate)
melden door een probleem of een pull-verzoek in het Engels te openen. Als u
een pull-verzoek indient, neem dan de nodige tijd om uw wijzigingen te
bespreken en uw werk aan te passen. U kunt helpen met vertalen door u aan te
sluiten bij een team op [Transifex](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/assisting-with-translations.md). Vraag
alstublieft niet om promotionele activiteiten voor uw eigen bedrijf of
website, behalve voor speciale gevallen zoals conferenties. Veel dank aan alle
medewerkers, die tijd besteden aan het verbeteren van bitcoin.org!
...
ALL TOPICS
  ...
  * Service Contribuanten
  * Inactieve Bijdragers
  * Domein eigenaren
  * Bijdragers op GitHub
