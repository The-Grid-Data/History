...
# Ã propos de bitcoin.org

Bitcoin.org Åuvre au dÃ©veloppement durable de Bitcoin.

## Qui possÃ¨de bitcoin.org ?
...
Bitcoin.org est le nom de domaine du premier site Web portant sur Bitcoin. Il
a Ã©tÃ© enregistrÃ© et est encore gÃ©rÃ© par les [dÃ©veloppeurs
principaux](/fr/developpement) et d'autres membres de la communautÃ©, avec
l'aide des [communautÃ©s Bitcoin](/fr/communaute). Bitcoin.org n'est pas un
site web officiel. De la mÃªme faÃ§on que personne ne possÃ¨de la technologie
derriÃ¨re les courriels, personne ne possÃ¨de le rÃ©seau Bitcoin. En
consÃ©quence, personne ne peut parler avec autoritÃ© au nom de Bitcoin.
...
## Alors... qui contrÃ´le Bitcoin ?

Bitcoin est contrÃ´lÃ© par tous ses utilisateurs Ã travers le monde. Les
dÃ©veloppeurs amÃ©liorent les logiciels mais il ne peuvent pas imposer un
changement dans les rÃ¨gles du protocole Bitcoin car chaque utilisateur est
libre de choisir quel logiciel il utilise. Afin de rester compatibles entre
eux, les utilisateurs ont besoin d'utiliser des logiciels qui se conforment
aux mÃªmes rÃ¨gles. Bitcoin ne peut bien fonctionner qu'avec un consensus
complet entre tous ses utilisateurs. Par consÃ©quent, tous les utilisateurs et
dÃ©veloppeurs ont un intÃ©rÃªt prÃ©dominant Ã adopter et Ã protÃ©ger ce
consensus.

## Mission

  * Informer les utilisateurs afin de les protÃ©ger des erreurs communes.
  * Donner une description exacte des propriÃ©tÃ©s de Bitcoin, de ses utilisations potentielles et de ses limites.
  * Afficher des alertes et des Ã©vÃ©nements touchant le rÃ©seau Bitcoin de faÃ§on transparente.
  * Inviter des humains talentueux Ã contribuer au dÃ©veloppement de Bitcoin Ã diffÃ©rents niveaux.
  * Offrir de la visibilitÃ© Ã l'Ã©cosystÃ¨me de Bitcoin Ã grande Ã©chelle.
  * AmÃ©liorer l'accessibilitÃ© mondiale Ã Bitcoin par l'internationalisation.
  * Demeurer une ressource d'information neutre Ã propos de Bitcoin.

## Aidez-nous

Vous pouvez rapporter tout problÃ¨me ou aider Ã amÃ©liorer bitcoin.org sur
[GitHub](https://github.com/bitcoin-dot-org/bitcoin.org#how-to-participate) en
ouvrant (en anglais) un problÃ¨me (Â« issue Â») ou une demande d'extraction
(Â« pull request Â»). Lorsque vous soumettez une demande d'extraction,
veuillez prendre le temps nÃ©cessaire pour discuter de vos changements et
adapter votre travail. Vous pouvez aider Ã la traduction en rejoignant une
Ã©quipe sur [Transifex](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/assisting-with-translations.md). Veuillez ne
pas demander de publicitÃ© pour votre entreprise ou pour votre site Web, sauf
pour des cas spÃ©ciaux comme les confÃ©rences. Merci Ã tous les contributeurs
qui prennent le temps d'amÃ©liorer bitcoin.org !
