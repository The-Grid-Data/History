...
ContrÃ´le hÃ©bergÃ© sur votre argent.

Ce portefeuile vous donne le contrÃ´le de vos bitcoins. Toutefois, ce service
maintient une copie chiffrÃ©e de votre portefeuille. Cela signifie que vos
bitcoins peuvent Ãªtre volÃ©s si vous n'utilisez pas un mot de passe solide et
que le service est compromis.

Validation dÃ©centralisÃ©e

Ce portefeuille se connecte Ã un serveur alÃ©atoire dans une liste. Cela
signifie que peu de confiance en des tiers est requise afin de vÃ©rifier les
...
[Installer](https://play.google.com/store/apps/details?id=co.edgesecure.app) [
Code source](https://github.com/EdgeApp/edge-react-gui)

![screenshot](/img/screenshots/edgewalletandroid.png)

[Installer](https://itunes.apple.com/us/app/edge-bitcoin-wallet/id1344400091)
[ Code source](https://github.com/EdgeApp/edge-react-gui)
