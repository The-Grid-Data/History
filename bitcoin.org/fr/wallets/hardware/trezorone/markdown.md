...
TREZOR est un portefeuille matÃ©riel qui fournit un haut niveau de sÃ©curitÃ©
sans sacrifier la commoditÃ©. Contrairement au stockage Ã froid, TREZOR peut
signer des transactions tout en Ã©tant connectÃ© sur un appareil en ligne.
Cela signifie que dÃ©penser des bitcoins est sans risque mÃªme lorsque vous
utilisez un ordinateur compromis.
...
Les fonctionnalitÃ©s reliÃ©es Ã la validation des paiements sont offertes par
le portefeuille logiciel que vous utilisez avec cet appareil. Veuillez
consulter le score de Validation du portefeuile logiciel que vous envisagez
utiliser.
...
Environnement trÃ¨s sÃ»r

Ce portefeuille est chargÃ© depuis un environnement spÃ©cialisÃ© et sÃ»r
Ã©tabli par l'appareil. Cela permet d'offrir une protection trÃ¨s solide
contre les vulnÃ©rabilitÃ©s informatiques et les logiciels malveillants
puisqu'aucun logiciel ne peut Ãªtre installÃ© dans cet environnement.

ConfidentialitÃ© variable

Les fonctionnalitÃ©s reliÃ©es Ã la vie privÃ©e sont offertes par le
portefeuille logiciel que vous utilisez avec cet appareil. Veuillez consulter
le score de ConfidentialitÃ© du portefeuile logiciel que vous envisagez
utiliser.
...
[Visiter le site Web](https://trezor.io/) [ Code
