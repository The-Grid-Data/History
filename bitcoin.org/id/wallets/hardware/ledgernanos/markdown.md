...
Ledger Nano S adalah piranti keras wallet Bitcoin yang aman. Dapat
menghubungkan ke berbagai komputer melalui USB dan menampilkan layar OLED
bawaan untuk cek ulang serta mengonfirmasi setiap transaksi dengan sekali
tekan tombol saja.
...
Fitur validasi pembayaran disediakan oleh piranti lunak wallet yang anda
gunakan pada perangkat ini.

Transparansi dasar

Spesifikasi wallet ini adalah umum. Ini berarti setiap pengembang di dunia
dapat melakukan uji kotak hitam. Meski demikian, anda masih perlu untuk
mempercayai para pengembang dari dompet ini karena perangkat tidak bisa
diverifikasi untuk menghasilkan seed acak yang aman dan sumber kode tidak bisa
diaudit. Memperbarui firmware perangkat anda, menghasilkan seed acak yang aman
milik anda sendiri atau menggunakan multi-signature bisa membuat bitcoin anda
makin sulit untuk dicuri.

Lingkungan yang sangat aman

Wallet ini dimuat melalui lingkungan khusus yang aman yang disediakan oleh
perangkatnya. Hal ini memberikan perlindungan yang sangat kuat melawan
kerentanan komputer dan malware karena tidak ada perangkat lunak yang bisa
diinstal pada lingkungan ini.

Privasi variabel

Fitur privasi disediakan oleh piranti lunak wallet yang anda gunakan pada
perangkat ini.

Kontrol biaya yang bisa diubah

Fitur kontrol disediakan oleh piranti lunak yang anda gunakan pada perangkat
ini.
...
[Kunjungi situs web](https://www.ledgerwallet.com/) [ Sumber
Kode](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
