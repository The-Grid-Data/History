...
Edge sudah kompatibel untuk segwit, wallet Bitcoin untuk mobile ini mempunyai
level privasi tinggi, keamanan dan desentralisasi yang lebih populer untuk
digunakan untuk banyak orang. Wallet Edge akan selalu ter-enkripsi, ter-back-
up, meskipun server Edge sedang turun.
...
Mengadakan kendali atas uang Anda

Wallet ini memberi Anda kontrol atas bitcoin anda. Namun, layanan ini
menyimpan salinan terenkripsi dari dompet anda. Hal ini berarti bitcoin anda
dapat dicuri jika anda tidak menggunakan kata kunci yang kuat dan layanan ini
dibobol.
...
Layanan ini dapat menghubungkan pembayaran-pembayaran Anda, merekam alamat IP
Anda dan mengetahui identitas asli Anda jika Anda menyediakan informasi
pribadi seperti email, nama atau rekening bank.
...
[Memasang](https://play.google.com/store/apps/details?id=co.edgesecure.app) [
Sumber Kode](https://github.com/EdgeApp/edge-react-gui)

![screenshot](/img/screenshots/edgewalletandroid.png)

[Memasang](https://itunes.apple.com/us/app/edge-bitcoin-wallet/id1344400091) [
Sumber Kode](https://github.com/EdgeApp/edge-react-gui)
