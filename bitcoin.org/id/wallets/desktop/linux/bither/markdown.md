...
Bither adalah wallet yang simpel dan aman di berbagai platform. Didesain
secara khusus dengan mode Cold/Hot, pengguna bisa mendapat keamanan dan
kemudahan sekaligus. Fitur XRANDOM menggunakan berbagai sumber entropi yang
berbeda untuk menghasilkan angka yang benar-benar acak bagi pengguna. Juga
dengan HDM, pengguna bisa mendapatkan keunggulan HD dan keamanan Multisig.
...
Wallet ini menggunakan SPV dan jaringan Bitcoin. Hal ini berarti dibutuhkan
sangat sedikit kepercayaan pada pihak ketiga saat verifikasi pembayaran. Meski
...
Memberitahukan informasi terbatas kepada orang lain

Orang lain di jaringan dapat merekam alamat IP Anda dan menghubungkan
pembayaran-pembayaran Anda, saat menerima atau mengirimkan pembayaran.

Tor tidak didukung

Wallet ini tidak memungkinkan anda untuk menggunakan Tor untuk mencegah
penyerang atau penyedia layanan internet dari menghubungkan pembayaran dengan
alamat IP anda.

Rekomendasi biaya statis

Wallet ini tidak menyediakan rekomendasi biaya apapun yang berdasar kondisi
jaringan saat ini. Ini berarti transaksi anda dapat tertunda apabila biaya
yang dipilih terlalu rendah, atau anda mungkin bisa membayar biaya yang
terlalu tinggi.
...
[Memasang](https://itunes.apple.com/us/app/bither/id899478936) [ Sumber
Kode](https://github.com/bither/bither-ios)

![screenshot](/img/screenshots/bithermobile.png)

[Memasang](https://play.google.com/store/apps/details?id=net.bither) [ Sumber
Kode](https://github.com/bither/bither-android)

![screenshot](/img/screenshots/bithermobile.png)

[Kunjungi situs web](https://bither.net) [ Sumber
Kode](https://github.com/bither/bither-desktop-java)
