...
Temukan informasi lebih lanjut mengenai spesifikasi, perangkat lunak, dan para
pengembang.
...
Bitcoin adalah perangkat lunak gratis dan setiap pengembang dapat
berkontribusi dalam proyek ini. Semua yang Anda butuhkan ada di [repositori
GitHub](https://github.com/bitcoin/bitcoin). Mohon pastikan untuk membaca dan
mengikuti proses pengembangan dalam README, serta menyediakan kode yang
berkualitas baik dan hormati semua panduan.

Diskusi pengembangan dilakukan melalui GitHub dan [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev) mailing
list. Diskusi non formal dilakukan melalui irc.freenode.net #bitcoin-core-dev
([antarmuka web](https://webchat.freenode.net/?channels=bitcoin-core-dev),
[logs](http://gnusha.org/bitcoin-core-dev/)).

## Dokumentasi

Jika Anda tertarik untuk mempelajari lebih lanjut mengenai rincian teknis dari
Bitcoin dan bagaimana menggunakan peralatan dan API yang ada, Anda disarankan
untuk memulai dengan menjelajahi [dokumentasi
developer](https://developer.bitcoin.org/).

## Komunitas Pengembang

Beberapa chatroom dan situs berikut menyediakan diskusi tentang perkembangan
Bitcoin. Pastikan untuk membaca aturan-aturan mereka sebelum menulis posting.

  * [Channel IRC #bitcoin-core-dev](https://webchat.freenode.net/?channels=bitcoin-core-dev) pada freenode.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [Forum Diskusi Pengembangan & Teknis BitcoinTalk](https://bitcointalk.org/index.php?board=6.0)
