...
Trova maggiori informazioni riguardo la specifica, il software e gli
sviluppatori attuali.

ALL TOPICS

  * Documentazione
  * ComunitÃ di sviluppatori
  * Collaboratori di Bitcoin Core
  * Altri progetti open-source

Lo sviluppo di Bitcoin Ã¨ open-source e qualsiasi sviluppatore puÃ²
contribuire al progetto. Tutto quello di cui hai bisogno Ã¨ nel [deposito
GitHub](https://github.com/bitcoin/bitcoin). Per favore assicurati di leggere
e di seguire il processo di sviluppo descritto nel file README, al fine di
produrre un codice di buona qualitÃ e rispettare tutte le linee guida.

Le discussioni relative allo sviluppo hanno luogo su GitHub e sulla [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev) mailing
list. Discussioni meno formali sullo sviluppo si trovano su irc.freenode.net #
bitcoin-core-dev([web
interface](https://webchat.freenode.net/?channels=bitcoin-core-
dev),[logs](http://gnusha.org/bitcoin-core-dev/)).

## Documentazione

Se sei interessato a saperne di piÃ¹ sui dettagli tecnici di Bitcoin e
all'utilizzo degli strumenti esistenti e gli API, ti suggeriamo di cominciare
ad esplorare la [documentazione dello
sviluppatore](https://developer.bitcoin.org/).

## ComunitÃ di sviluppatori

I seguenti siti e chatroom ospitano discussioni riguardo lo sviluppo di
Bitcoin. Si prega di leggere le regole di comportamento prima di inserire
messaggi.

  * [Canale IRC #bitcoin-core-dev](https://webchat.freenode.net/?channels=bitcoin-core-dev) su freenode.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [Forum di BitcoinTalk - Development & Technical Discussion](https://bitcointalk.org/index.php?board=6.0)
