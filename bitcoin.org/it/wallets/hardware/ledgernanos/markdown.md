...
Ledger Nano S Ã¨ un portafoglio hardware sicuro di Bitcoin. Connette ogni
computer tramite USB e incorpora un display OLED integrato per ricontrollare e
confermare ogni transazione con un semplice tocco.
...
Le specifiche di questo portafoglio sono pubbliche. CiÃ² significa che ogni
sviluppatore nel mondo puÃ² effettuare dei test blackbox. Comunque, Ã¨
necessario che ti fidi degli sviluppatori di questo portafoglio perchÃ¨ non Ã¨
possibile verificare che il dispositivo generi dei seed casuali sicuri e il
codice non puÃ² essere controllato. Aggiornare il firmware del tuo
dispositivo, generare da solo dei seed casuali sicuri o utilizzare la multi-
firma puÃ² rendere piÃ¹ difficile rubare i tuoi bitcoin.
...
[Visita il sito web](https://www.ledgerwallet.com/) [ Codice
sorgente](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
