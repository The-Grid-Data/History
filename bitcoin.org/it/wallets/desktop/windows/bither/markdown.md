...
Bither Ã¨ un portafoglio semplice e sicuro che funziona su diverse
piattaforme. Con specifiche modalitÃ online/offline, l'utente puÃ² avere
insieme sicurezza e semplicitÃ . La funzione XRANDOM di Bither utilizza
l'ambiente in cui vive l'utente per generare chiavi in maniera realmente
casuale. Inoltre con la funzione HDM, gli utenti possono avere i vantaggi
...
Suggerimento delle commissioni fisse

Questo portafoglio non fornisce suggerimenti delle commissioni basati sulle
condizioni della rete. Questo significa che le tue transazioni potrebbero
essere soggette a ritardi se la commissione scelta Ã¨ troppo bassa o che
potresti pagarne una troppo alta.
...
[Installa](https://itunes.apple.com/us/app/bither/id899478936) [ Codice
sorgente](https://github.com/bither/bither-ios)

![screenshot](/img/screenshots/bithermobile.png)

[Installa](https://play.google.com/store/apps/details?id=net.bither) [ Codice
sorgente](https://github.com/bither/bither-android)

![screenshot](/img/screenshots/bithermobile.png)

[Visita il sito web](https://bither.net) [ Codice
sorgente](https://github.com/bither/bither-desktop-java)
