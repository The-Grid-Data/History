...
Bitcoin.org si dedica ad aiutare lo sviluppo di Bitcoin in modo sostenibile.

## Chi possiede bitcoin.org?
...
### Satoshi Nakamoto e Martti Malmi

Bitcoin.org fu originariamente registrato dai due primi programmatori del
nucleo Bitcoin, [Satoshi
Nakamoto](https://en.bitcoin.it/wiki/Satoshi_Nakamoto) e [Martti
Malmi](https://en.bitcoin.it/wiki/Sirius). Quando Nakamoto ha lasciato il
progetto, ha allargato l'appartenenza del dominio ad altre persone non facenti
parte degli sviluppatori del nucleo Bitcoin. Questo avevo lo scopo di
distribuire la responsabilitÃ ed impedire ad una singola persona o ad un
singlolo gruppo di poter facilmente prendere il controllo del progetto
Bitcoin.
...
Dal 2011 al 2013, il sito Ã¨ stato utilizzato principalmente per il rilascio
di nuove versioni del software ora denominato Bitcoin Core. Nel 2013, il sito
Ã¨ stato ridisegnato, aggiungendo numerose pagine, elencando il software
Bitcoin aggiuntivo e creando il sistema di traduzione.
...
### La documentazione per gli sviluppatori Ã¨ stata aggiunta nel 2014

Aggiornamenti, correzioni, suggerimenti e miglioramenti da parte dei membri
della comunitÃ sono i benvenuti.
...
### Il sito Ã¨ un progetto open source indipendente

Oggi il sito Ã¨ un progetto open source indipendente con collaboratori da
tutto il mondo. L'autoritÃ di pubblicazione finale Ã¨ detenuta dai
comproprietari, ma tutte le attivitÃ regolari sono organizzate attraverso il
processo di [richiesta di attrazione pubblica](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/working-with-github.md) e gestite dai co-
manutentori del sito.

Bitcoin.org non Ã¨ il sito ufficiale di Bitcoin. Proprio come nessuno possiede
la tecnologia email, nessuno possiede la rete Bitcoin. Come tale, nessuno puÃ²
parlare con autoritÃ nel nome di Bitcoin.

## Quindi... chi controlla Bitcoin?

Bitcoin Ã¨ controllato da tutti gli utenti Bitcoin di tutto il mondo. Gli
sviluppatori stanno migliorando il software ma non possono forzare un
cambiamento nelle regole del protocollo Bitcoin, perchÃ© tutti gli utenti sono
liberi di scegliere il software utilizzare. Per rimanere compatibili con tutti
gli altri, ogni utente ha bisogno di usare software conforme alle stesse
regole. Bitcoin puÃ² lavorare in modo decente solo con un consenso completo
tra tutti gli utenti. Quindi, tutti gli utenti e gli sviluppatori sono molto
incentivati ad adottare e proteggere questo consenso.

## La missione

  * Informare gli utenti per proteggerli da errori comuni.
  * Dare un'accurata descrizione delle proprietÃ di Bitcoin, usi potenziali e limitazioni
  * Mostrare avvisi trasparenti ed eventi riguardanti la rete Bitcoin.
  * Invitare persone con talento ad aiutare lo sviluppo di Bitcoin a molti livelli.
  * Offrire visibilitÃ all'ecosistema Bitcoin su larga scala
  * Migliorare l'accessibilitÃ a Bitcoin in tutto il mondo con l'internazionalizzazione.
  * Conservare una risorsa informativa neutrale riguardante Bitcoin.

## Aiutaci

Ã possibile segnalare qualsiasi problema o contribuire a migliorare
bitcoin.org su [GitHub](https://github.com/bitcoin-dot-org/bitcoin.org#how-to-
participate)aprendo una segnalazione o inviando un suggerimento di modifica in
Inglese . Quando si invia un suggerimento di modifica, si prega di attendere
il tempo necessario per discutere le vostre modifiche e adattare il vostro
lavoro. Potete aiutare con le traduzioni unendovi a una squadra su
[Transifex](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/assisting-with-translations.md). Per favore
non chiedete di avere pubblicitÃ per i vostri affari personali o il vostro
sito Web, ad eccezione di casi particolari come le conferenze. Molte grazie a
tutti i collaboratori che stanno spendendo tempo su bitcoin.org migliorando!
