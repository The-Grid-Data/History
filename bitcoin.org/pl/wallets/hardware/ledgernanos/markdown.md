...
Funkcje walidacji pÅatnoÅci sÄ dostarczane przez oprogramowanie portfela,
ktÃ³rego uÅ¼ywasz z tym sprzÄtem. Prosimy sprawdziÄ ocenÄ Potwierdzenia
oprogramowania portfelu, ktÃ³rego planujesz uÅ¼yÄ.

Podstawowa przejrzystoÅÄ

Specyfikacja tego portfela jest publiczna. Oznacza to, Å¼e kaÅ¼dy programista
na Åwiecie moÅ¼e przeprowadziÄ testy balckbox. WciÄ Å¼ jednak musisz zaufaÄ
twÃ³rcom tego portfela, poniewaÅ¼ urzÄ dzenie nie moÅ¼e zostaÄ zweryfikowane
pod kÄ tem generowania bezpiecznych, losowych seedÃ³w, zaÅ kod ÅºrÃ³dÅowy
nie moÅ¼e zostaÄ sprawdzony. Aktualizacja oprogramowania sprzÄtowego
(firmware), generowanie wÅasnych, bezpiecznych i losowych seedÃ³w bÄ dÅº
uÅ¼ywanie multipodpisu moÅ¼e utrudniÄ kradzieÅ¼ Twoich bitcoinÃ³w.

Dobrze zabezpieczone Årodowisko

Ten portfel jest Åadowany z bezpiecznego, wyspecjalizowanego Årodowiska
dostarczanego przez urzÄ dzenie. Zapewnia to bardzo silnÄ ochronÄ przed
zagroÅ¼eniami i zÅoÅliwym oprogramowaniem, poniewaÅ¼ Å¼adne oprogramowanie
nie moÅ¼e zostaÄ w tym Årodowisku zainstalowane.

Zmienna prywatnoÅÄ

Funkcje bezpieczeÅstwa sÄ zapewniane przez oprogramowanie portfela, ktÃ³rego
uÅ¼ywasz z tym sprzÄtem. Prosimy sprawdziÄ ocenÄ PrywatnoÅci
oprogramowania portfela, ktÃ³rego planujesz uÅ¼yÄ.
...
[OdwiedÅº witrynÄ](https://www.ledgerwallet.com/) [ Kod
ÅºrÃ³dÅowy](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
