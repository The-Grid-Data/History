...
Electrum koncentruje siÄ na szybkoÅci oraz prostocie przy niewielkim uÅ¼yciu
zasobÃ³w. Wykorzystuje on zdalne serwery, ktÃ³re wykonujÄ najbardziej
skomplikowane zadania systemu Bitcoin, oraz pozwala Ci na odtworzenie twojego
portfela przy uÅ¼yciu hasÅa.
...
Ten portfel uÅ¼ywa SPV i losowych serwerÃ³w z listy. Oznacza to, Å¼e podczas
weryfikacji pÅatnoÅci musisz zaufaÄ podmiotom trzecim jedynie w niewielkim
stopniu. Nie jest to jednak tak bezpieczne, jak peÅny wÄzeÅ, jak na
przykÅad [Bitcoin Core](/pl/pobieranie).
...
Tego portfela moÅ¼na uÅ¼ywaÄ z niezabezpieczonych Årodowisk. UsÅuga ta
wymaga jednak dwustopniowego uwierzytelnienia. Oznacza to, Å¼e aby wykraÅÄ
Twoje bitcoiny, niezbÄdny jest dostÄp do wielu urzÄ dzeÅ.
...
[OdwiedÅº witrynÄ](https://electrum.org) [ Kod
ÅºrÃ³dÅowy](https://github.com/spesmilo/electrum)
...
[Instaluj](https://play.google.com/store/apps/details?id=org.electrum.electrum)
[ Kod ÅºrÃ³dÅowy](https://github.com/spesmilo/electrum)
