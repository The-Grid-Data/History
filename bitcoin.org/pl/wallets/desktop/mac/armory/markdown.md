...
Armory jest zaawansowanym klientem Bitcoin, ktÃ³ry daje szersze moÅ¼liwoÅci
zaawansowanym uÅ¼ytkownikom. Oferuje wiele funkcji kopii zapasowych i
szyfrowania oraz umoÅ¼liwia bezpieczne przechowywanie "cold-storage", na
komputerach niepodÅÄ czonych do sieci.
...
Ten portfel wymaga, zainstalowania oprogramowania peÅnego wÄzÅa, ktÃ³re
waliduje i przekazuje transakcje w sieci Bitcoin. Oznacza to, Å¼e przy
weryfikacji pÅatnoÅci nie jest wymagane zaufanie w stosunku do podmiotÃ³w
trzecich. PeÅne wÄzÅy zapewniajÄ najwyÅ¼szy poziom bezpieczeÅstwa i sÄ
kluczowe dla ochrony sieci. WymagajÄ jednakÅ¼e wiÄcej miejsca (ponad 65 GB),
przepustowoÅci i dÅuÅ¼szego czasu poczÄ tkowej synchronizacji.
...
[OdwiedÅº witrynÄ](https://btcarmory.com/) [ Kod
ÅºrÃ³dÅowy](https://github.com/goatpig/BitcoinArmory)
