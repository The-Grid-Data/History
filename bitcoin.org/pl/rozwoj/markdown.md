...
ZnajdÅº wiÄcej informacji o aktualnej specyfikacji, oprogramowaniu i
programistach.

ALL TOPICS

  * Dokumentacja
  * SpoÅecznoÅci deweloperÃ³w
  * WspÃ³Åautorzy Bitcoin Core
  * WiÄcej projektÃ³w otwartego oprogramowania

Bitcoin jest wolnym oprogramowaniem i kaÅ¼dy moÅ¼e przyczyniÄ siÄ do jego
rozwoju. Wszystko, czego potrzebujesz, zawarte jest w [repozytorium
GitHub](https://github.com/bitcoin/bitcoin). Jest bardzo istotne, abyÅ
przeczytaÅ plik README oraz postÄpowaÅ zgodnie z procesem w nim opisanym, a
takÅ¼e byÅ tworzyÅ kod dobrej jakoÅci, respektujÄ c wszystkie wytyczne.

Dyskusja o rozwoju ma miejsce na GitHub oraz na liÅcie mailingowej [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev)
zamieszczonej na sourceforge. Mniej formalna dyskusja ma miejsce na
irc.freenode.net na kanale #bitcoin-dev (interfejs sieciowy;
[logi](http://bitcoinstats.com)).

## Dokumentacja

JeÅli chciaÅbyÅ dowiedzieÄ siÄ wiÄcej o technicznych szczegÃ³Åach
Bitcoin i o tym, jak uÅ¼ywaÄ istniejÄ cych narzÄdzi oraz API, zalecamy, byÅ
zaczÄ Å od zapoznania siÄ z [dokumentacjÄ deweloperskÄ
](https://developer.bitcoin.org/).

## SpoÅecznoÅci deweloperÃ³w

Na poniÅ¼szych witrynach i chatroomach odbywajÄ siÄ dyskusje na temat rozwoju
Bitcoin. Przed wziÄciem udziaÅu w dyskusji prosimy o zapoznanie siÄ z ich
zasadami.

  * [KanaÅ IRC #bitcoin-dev](https://webchat.freenode.net/?channels=bitcoin-dev) na freenode.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [Forum dyskusyjne o rozwoju i kwestiach technicznych BitcoinTalk](https://bitcointalk.org/index.php?board=6.0)

## WspÃ³Åautorzy Bitcoin Core

(W kolejnoÅci liczby poprawek)
