...
Electrum ist auf Geschwindigkeit und Einfachheit fokussiert und benÃ¶tigt
wenig Ressourcen. Es nutzt entfernte Server, die den komplizierten Teil des
Bitcoin-Systems Ã¼bernehmen und ermÃ¶glicht es, mit einer geheimen Phrase
wieder Zugriff auf eine Wallet zu bekommen.
...
Diese Wallet verwendet SPV und zufÃ¤llige Server aus einer Liste. Das
bedeutet, dass wenig Vertrauen in Dritte beim Verifizieren von Zahlungen
nÃ¶tig ist. Dennoch ist sie nicht so sicher wie ein "Full Node" wie [Bitcoin
Core](/de/download).
...
Diese Wallet kann in unsicheren Umgebungen verwendet werden. Allerdings wird
eine Zwei-Faktor-Authentifizierung vorausgesetzt. Das bedeutet, dass Zugang zu
mehreren GerÃ¤ten oder Accounts nÃ¶tig ist, um Bitcoins zu stehlen.
...
Volle Kontrolle Ã¼ber GebÃ¼hren

Diese Wallet gibt Ihnen die volle Kontrolle Ã¼ber GebÃ¼hren. Das bedeutet,
dass diese Wallet es ermÃ¶glicht, GebÃ¼hren mittels RBF oder CPFP nach dem
Verschicken von Bitcoins anzupassen. DarÃ¼ber hinaus schlÃ¤gt diese Wallet
GebÃ¼hren basierend auf den gegenwÃ¤rtigen Netzwerkbedingungen vor, sodass
Ihre Transaktionen zeitnah bestÃ¤tigt werden, ohne dass Sie dafÃ¼r mehr als
notwendig zahlen mÃ¼ssen.
...
[Website besuchen](https://electrum.org) [
Quellcode](https://github.com/spesmilo/electrum)
...
[Installieren](https://play.google.com/store/apps/details?id=org.electrum.electrum)
[ Quellcode](https://github.com/spesmilo/electrum)
