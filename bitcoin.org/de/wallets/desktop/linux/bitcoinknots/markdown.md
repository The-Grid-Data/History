...
Bitcoin Knots ist ein kompletter Bitcoin-Client und bildet das RÃ¼ckgrat des
Netzwerks. Er bietet ein hohes MaÃ an Sicherheit, PrivatsphÃ¤re und
StabilitÃ¤t. Er beinhaltet mehr fortgeschrittene Funktionen als Bitcoin Core,
welche aber nicht so umfassend geprÃ¼ft wurden. Er benÃ¶tigt viel Festplatten-
und Arbeitsspeicher.
...
Diese Wallet ist ein "Full Node", die Transaktionen im Bitcoin-Netzwerk
validiert und weiterleitet. Das bedeutet, dass keinem Dritten vertraut werden
muss, wenn Zahlungen verifiziert werden. "Full Nodes" bieten das hÃ¶chste MaÃ
an Sicherheit und sind zum Schutz des Netzwerks unentbehrlich. Allerdings wird
viel Speicher (Ã¼ber 350GB), Bandbreite und eine lÃ¤ngere anfÃ¤ngliche
Synchronisierung benÃ¶tigt.
...
[Website besuchen](https://bitcoinknots.org/) [
Quellcode](https://github.com/bitcoinknots/bitcoin/)
