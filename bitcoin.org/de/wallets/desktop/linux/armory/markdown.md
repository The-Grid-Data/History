...
Armory ist ein erweiterter Bitcoin-Client, der FunktionalitÃ¤ten fÃ¼r Bitcoin-
Power-User ergÃ¤nzt. Er bietet viele Backup- und VerschlÃ¼sselungsfunktionen
und ermÃ¶glicht sicheres Speichern auf Offline-Rechnern.
...
Diese Wallet benÃ¶tigt eine installierte "Full Node"-Software, die
Transaktionen im Bitcoin-Netzwerk validiert und weiterleitet. Das impliziert,
dass keinen Dritten vertraut werden muss, wenn Zahlungen verifiziert werden.
"Full Nodes" bieten das hÃ¶chste MaÃ an Sicherheit und sind fÃ¼r den Schutz
des Netzwerks unentbehrlich. Allerdings benÃ¶tigen diese viel Speicher (Ã¼ber
350GB), Bandbreite und eine lÃ¤ngere anfÃ¤ngliche Synchronisierung.
...
[Website besuchen](https://btcarmory.com/) [
Quellcode](https://github.com/goatpig/BitcoinArmory)
