...
Ledger Nano S ist eine sichere Bitcoin-Hardware-Wallet. Es verbindet sich mit
einem beliebigen Computer via USB und besitzt ein integriertes OLED-Display
zur GegenprÃ¼fung und BestÃ¤tigung einer Transaktion mit einem einfachen
Knopfdruck.
...
Die Features der Zahlungsvalidierung werden von der Software-Wallet
bereitgestellt, die Sie auf dem GerÃ¤t verwenden.

Grundlegende Transparenz

Die Spezifikation dieser Wallet ist Ã¶ffentlich zugÃ¤nglich. Das bedeutet,
dass jeder Entwickler einen Blackbox-Test durchfÃ¼hren kann. Dennoch ist es
nÃ¶tig den Entwicklern dieser Wallet zu vertrauen, da nicht Ã¼berprÃ¼ft werden
kann, ob das GerÃ¤t sichere zufÃ¤llige Seeds generiert. Ebenso kann der
Quellcode nicht geprÃ¼ft werden. Die GerÃ¤te-Firmware zu aktualisieren, einen
eigenen zufÃ¤lligen Seed zu generieren oder Multisignaturen zu verwenden, kann
es schwieriger machen, Ihre Bitcoins zu stehlen.

Sehr sichere Umgebung

Die Wallet wird aus einer gesicherten spezialisierten Umgebung geladen, die
von dem GerÃ¤t zur VerfÃ¼gung gestellt wird. Diese bietet sehr starken Schutz
vor SicherheitslÃ¼cken und Malware, da keine andere Software in dieser
Umgebung installiert werden kann.

Variable PrivatsphÃ¤re

PrivatsphÃ¤re-Features werden von der Software-Wallet bereitgestellt, die Sie
auf dem GerÃ¤t verwenden.

Variable Kontrolle Ã¼ber GebÃ¼hren

Features der GebÃ¼hrenkontrolle werden von der Software-Wallet bereitgestellt,
die Sie auf dem GerÃ¤t verwenden.
...
[Website besuchen](https://www.ledgerwallet.com/) [
Quellcode](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
