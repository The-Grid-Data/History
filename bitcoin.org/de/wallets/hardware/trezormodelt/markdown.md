...
Trezor Model T ist eine Hardware-Wallet der nÃ¤chsten Generation. Sie
kombiniert die Vorteile des Original-Trezors mit einer modernen und intuitiven
Schnittstelle, die das Nutzererlebnis verbessert und die Sicherheit erhÃ¶ht.
Sie besitzt einen Touchscreen, einen schnelleren Prozessor und alle Features
des Trezor One.
...
[Website besuchen](https://trezor.io/) [
Quellcode](https://github.com/trezor/trezor-firmware)
