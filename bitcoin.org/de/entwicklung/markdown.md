...
Finden Sie weitere Informationen zur gegenwÃ¤rtigen Spezifikation, zur
Software und zu Entwicklern.
...
ALL TOPICS
  ...
  * Weitere freie Software-Projekte

Bitcoin ist freie Software und jeder Entwickler kann zu dem Projekt beitragen.
Alles was Sie benÃ¶tigen finden Sie im [GitHub
Repository](https://github.com/bitcoin/bitcoin). Bitte lesen und befolgen Sie
den in der README beschriebenen Entwicklungsprozess, liefern Sie Codes von
guter QualitÃ¤t und respektieren Sie alle Richtlinien.

Diskussionen Ã¼ber die Entwicklung finden auf GitHub und Ã¼ber die [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev) E-Mail-
Liste statt. Weniger formale Diskussionen Ã¼ber die Entwicklung finden bei
irc.freenode.net #bitcoin-core-dev
([Webinterface](https://webchat.freenode.net/?channels=bitcoin-core-dev),
[Logs](http://gnusha.org/bitcoin-core-dev/)) statt.

## Dokumentation

Falls Sie daran interessiert sind, mehr Ã¼ber die technischen Details von
Bitcoin zu erfahren und wie man vorhandene Tools und APIs verwendet, dann wird
empfohlen bei der [Dokumentation fÃ¼r
Entwickler](https://developer.bitcoin.org/) zu beginnen.

## Entwickler-Community

Die folgenden Chatrooms und Websites bieten Diskussionen Ã¼ber die Bitcoin-
Entwicklung. Lesen Sie bitte die Verhaltensregeln bevor Sie sich beteiligen.

  * [IRC Channel #bitcoin-core-dev](https://webchat.freenode.net/?channels=bitcoin-core-dev) auf freenode.
