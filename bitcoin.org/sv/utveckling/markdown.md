...
Hitta mer information om nuvarande specifikation, mjukvara och utvecklare.
...
ALL TOPICS
  ...
  * Fler projekt med fri mjukvara

Bitcoin Ã¤r fri mjukvara och vilken utvecklare som helst kan delta i
projektet. Allt du behÃ¶ver finns pÃ¥
[GitHub](https://github.com/bitcoin/bitcoin). LÃ¤s igenom och fÃ¶lj
utvecklingsprocessen som beskrivs i filen README och bidra med hÃ¶gkvalitativ
kod och respektera alla riktlinjer.

Diskussion avseende utveckling sker pÃ¥ GitHub och e-postlistan [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev). Mer
informella diskussioner hÃ¥lls pÃ¥ irc.freenode.net #bitcoin-core-dev
([webbgrÃ¤nssnitt](https://webchat.freenode.net/?channels=bitcoin-core-dev),
[loggar](http://gnusha.org/bitcoin-core-dev/)).

## Dokumentation

Om du vill lÃ¤ra dig mer om de tekniska detaljerna i Bitcoin och hur man
anvÃ¤nder befintliga verktyg och API:er sÃ¥ rekommenderas att du utforskar
[utvecklardokumentationen](https://developer.bitcoin.org/).

## Utvecklarcommunityn

FÃ¶ljande chattrum och webbplatser har diskussioner om Bitcoinutveckling. Se
till att lÃ¤sa deras fÃ¶rhÃ¥llningsregler innan du skriver nÃ¥got.

  * IRC-kanalen [#bitcoin-core-dev](https://webchat.freenode.net/?channels=bitcoin-core-dev) pÃ¥ freenode.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [BitcoinTalk Development & Technical Discussion Forum](https://bitcointalk.org/index.php?board=6.0)

## Bidragsgivare till Bitcoin Core

(Sorterad efter antal commit)
