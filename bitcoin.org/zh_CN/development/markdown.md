...
å¯»æ¾æ´å¤æå ³å½åè§èãè½¯ä»¶åå¼åè çä¿¡æ¯
...
æ¯ç¹å¸æ¯å¼æºçï¼ä»»ä½å¼åè
é½å¯ä»¥ä¸ºè¿ä¸ªé¡¹ç®ååºè´¡ç®ã[GitHubä»£ç
ä»åº](https://github.com/bitcoin/bitcoin)ä¸­æä½
éè¦çä¸åãè¯·å¡å¿ é è¯»å¹¶éµç
§READMEä¸­æè¿°çå¼åæµç¨ï¼ä¹è¯·æä¾é«è´¨éçä»£ç
ï¼å¹¶éµå¾ªææçå¼åååã

æå ³å¼åçè®¨è®ºå¨GitHubå[bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-
dev)é®ä»¶åè¡¨è¿è¡ãéæ­£å¼çå¼åè®¨è®ºè¯·è§ irc.freenode.net
#bitcoin-core-dev ï¼[web
interface](https://webchat.freenode.net/?channels=bitcoin-core-dev),
[logs](http://gnusha.org/bitcoin-core-dev/)ï¼ã

## ææ¡£è®°å½

å¦æä½ æå ´è¶£äºè§£æ´å¤å
³äºæ¯ç¹å¸çææ¯ç»èä»¥åå¦ä½ä½¿ç¨ç°æçå·¥å ·å
APIï¼å»ºè®®ä½ å äºè§£ [å¼åè
ææ¡£è®°å½](https://developer.bitcoin.org/).

## å¼åäººåç¤¾åº

ä¸é¢è¿äºèå¤©å®¤åç½ç«å¼å±å
³äºæ¯ç¹å¸åå±çè®¨è®ºãè¯·ç¡®ä¿å¨åå¸ä»»ä½ä¿¡æ¯åé
è¯»å®ä»¬çè¡ä¸ºè§èã

  * å¨èªç±èç¹ä¸ç[IRC é¢é #bitcoin-core-dev](https://webchat.freenode.net/?channels=bitcoin-core-dev) ã
  * [æ¯ç¹å¸é®ç­ç½ç«ï¼StackExchangeï¼](https://bitcoin.stackexchange.com/)
  * [æ¯ç¹å¸å¯¹è¯åå±åææ¯è®¨è®ºè®ºå](https://bitcointalk.org/index.php?board=6.0)

## Bitcoin Coreè´¡ç®è

ï¼æ ¹æ®ä»£ç æäº¤æ¬¡æ°æåºï¼
