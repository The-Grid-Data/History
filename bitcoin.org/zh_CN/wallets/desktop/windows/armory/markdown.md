...
Armory
æ¯ä¸æ¬¾é«çº§æ¯ç¹å¸å®¢æ·ç«¯ï¼ä¸ºæ¯ç¹å¸èµæ·±ç¨æ·åäºæ´å¤æ§è½æ©å±ãå®æä¾äºå¾å¤çå¤ä»½åå
å¯åè½ï¼å è®¸å®å ¨ççº¿ä¸å·å­å¨æ¹å¼ã
...
è¿æ¬¾é±å è¦æ±æ¨å®è£ å®å ¨èç¹è½¯ä»¶ä»¥å¨Bitcoin
ç½ç»ä¸éªè¯åä¼
éäº¤æãè¿æå³çå½éªè¯æ¯ä»çæ¶åä¸éè¦å¯¹ç¬¬ä¸æ¹æä¿¡ä»»ãå®å
¨èç¹å ·ææé«çå®å ¨æ°´å¹³ï¼å®å¯¹äºä¿æ¤è¿ä¸ªç½ç»æ¯è³å
³éè¦çãç¶èï¼å®ä»¬è¦æ±æ´å¤çå­å¨ç©ºé´(è¶
è¿20GB)ãå¸¦å®½åæ´é¿çåå§åæ­¥æ¶é´ã
...
[è®¿é®ç½ç«](https://btcarmory.com/) [ æºä»£ç
