...
Bitcoin.orgè´åäºå¸®å©æ¯ç¹å¸å®ç°å¯æç»­æ§åå±ã

## è°æ¥æbitcoin.orgååï¼
...
### ä¸­æ¬èªåé©¬å°èâ§é©¬å°ç±³

Bitcoin.orgæ¯ç¹å¸ä¸å¼å§æ¯ç±æ¯ç¹å¸æåçä¸¤åå¼åè
ï¼[ä¸­æ¬èª](https://en.bitcoin.it/wiki/Satoshi_Nakamoto)å[é©¬å°èÂ·é©¬å°ç±³](https://en.bitcoin.it/wiki/Sirius)ï¼æ³¨åå¹¶æ¥æçãå½ä¸­æ¬èªç¦»å¼é¡¹ç®æ¶ï¼å®æååçæææç»äºæ¯ç¹å¸å¼åè
å¤çä¸äºäººæ¥åæ
è´£ä»»ä»¥é²æ­¢ä»»ä½ä¸ªäººæå¢éæ§å¶æ¯ç¹å¸é¡¹ç®ã
...
2011å¹´å°2013å¹´è¿æ®µæ¶é´ï¼è¿ä¸ªç½ç«ä¸»è¦æ¯ä¸ºäºåå¸æ¯ç¹å¸æ
¸å¿çæ°çæ¬ã2013å¹´çæ¶åï¼ç½ç«è¢«éæ°è®¾è®¡æå½åçå½¢å¼ï¼å¢å
äºæ´å¤é¡µé¢ï¼å å«äºæ´å¤å
³äºæ¯ç¹å¸è½¯ä»¶ï¼ä»¥ååå»ºäºç¿»è¯ç³»ç»ãèå¼åè
ææ¡£å¨2014å¹´è¢«å å ¥ã
...
### å¼åè ææ¡£å¨2014å¹´è¢«å å ¥

å¦ä»è¯¥ç½ç«æ¯ä¸ä¸ªç¬ç«çå¼æºé¡¹ç®ï¼å ¶ä¸­è´¡ç®è
æ¥èªä¸çåå°ãæç»åå¸ææ¯ç±èåæ¥æè
ä»¬ææï¼ä½ææçå¸¸è§æ´»å¨åéè¿å ¬å¼ç[æåè¯·æ±ï¼pull
requestï¼è¿ç¨](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/working-with-
github.md)è¿è¡ç»ç»ï¼å¹¶ä¸ç±ç½ç«èåè¿ç»´è è¿è¡ç®¡çã
...
### è¯¥ç«ç¹æ¯ä¸ä¸ªç¬ç«çå¼æºé¡¹ç®

æ¯ç¹å¸Bitcoin.orgä¸æ¯æ¯ç¹å¸å®æ¹ç½ç«ãå°±åæ²¡æäººæ¥æçµå­é®ä»¶ææ¯ä¸æ
·ï¼æ²¡æäººæ¥ææ¯ç¹å¸ç½ç»ãå
æ­¤ï¼æ²¡æäººè½ä»£è¡¨æ¯ç¹å¸çæå¨ã
...
## é£ä¹â¦â¦æ¯ç¹å¸ç±è°æ§å¶ï¼

æ¯ç¹å¸ç±ä¸çåå°ææçæ¯ç¹å¸ç¨æ·æ§å¶ãå¼åè
...
## ä½¿å½
  ...
  * åç¥ç¨æ·ï¼ä¿æ¤ä»ä»¬ä»¥é¿å å¸¸è§çéè¯¯ã
  * ç»æ¯ç¹å¸çå±æ§ãæ½å¨çç¨éåå±éæ§åä¸ä¸ªåç¡®çæè¿°ã
  * ä¸ç®äºç¶å°æ¾ç¤ºå ³äºæ¯ç¹å¸ç½ç»çæéåäºä»¶ã
  * éè¯·ææåçäººå¨å¤ä¸ªå±é¢å¸®å©æ¯ç¹å¸åå±ã
  * æä¾å¤§å°ºåº¦ä¸æ¯ç¹å¸çæç³»ç»çå¯è§æ§ã
  * è´åå½é åï¼ä¿è¿æ¯ç¹å¸å ¨çæ éç¢ã
  * ä¿çä¸ä¸ªä¸­ç«çãå å®¹ç¿å®çæ¯ç¹å¸èµæºç«ç¹ã

## å¸®å©æä»¬

æ¨å¯ä»¥å¨[GitHub](https://github.com/bitcoin-dot-org/bitcoin.org#how-to-
participate)ä¸ç¨è±è¯­æ¥æ¥åä»»ä½é®é¢æå¸®å©æåæ¯ç¹å¸ç«ç¹bitcoin.orgï¼åæ³å°±æ¯åèµ·ä¸ä¸ªé®é¢æè
åå¹¶è¯·æ±ï¼pull
requestï¼ãå½æäº¤ä¸é¡¹åå¹¶è¯·æ±æ¶ï¼è¯·è±äºæ¶é´æ¥è®¨è®ºä½
çåæ´ä»¥åè°æ´ä½
çå·¥ä½ãæ¨å¯ä»¥å¨[Transifex](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/assisting-with-translations.md)ç½ç«ä¸å å
¥ä¸ä¸ªå¢éæ¥å¸®å©ç¿»è¯ãè¯·ä¸è¦æ¨éä½
èªå·±çä¼ä¸æç½ç«ï¼é¤ç¹æ®æ
åµï¼å¦ä¼è®®ï¼å¤ãæè°¢ææè±è´¹äºæ¶é´æ¹åbitcoin.orgçè´¡ç®è
ä»¬ï¼
