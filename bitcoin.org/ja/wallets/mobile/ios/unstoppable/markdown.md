...
è¦ä»¥ä¸ã®ææ°æãæ¯æãäºãªãæ¿èªããã¾ãã
...
[ã¤ã³ã¹ãã¼ã«](https://apps.apple.com/app/bank-bitcoin-
wallet/id1447619907?ls=1) [
ã½ã¼ã¹ã³ã¼ã](https://github.com/horizontalsystems/unstoppable-wallet-
ios)

![screenshot](/img/screenshots/unstoppable_ios.png)

[ã¤ã³ã¹ãã¼ã«](https://play.google.com/store/apps/details?id=io.horizontalsystems.bankwallet)
[ ã½ã¼ã¹ã³ã¼ã](https://github.com/horizontalsystems/unstoppable-wallet-
android)
