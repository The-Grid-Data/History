...
Ledger Nano S Ã©s una cartera hardware Bitcoin segura. Es connecta a qualsevol
ordinador mitjanÃ§ant USB i incorpora una pantalla OLED integrada per
comprovar i confirmar cada transacciÃ³ amb un sol toc als botons.
...
Les funcions de validaciÃ³ de pagaments les proporciona la cartera software
que utilitzeu amb aquest dispositiu.

TransparÃ¨ncia bÃ sica

L'especificaciÃ³ d'aquesta cartera Ã©s pÃºblica. AixÃ² significa que qualsevol
desenvolupador del mÃ³n pot fer proves de blackbox. Tot i aixÃ², encara heu de
confiar en els desenvolupadors d'aquesta cartera perquÃ¨ no es pot verificar
que el dispositiu generi llavors aleatÃ²ries segures i el codi font no es pot
auditar. Actualitzar el firmware del dispositiu, generar la vostra prÃ²pia
llavor aleatÃ²ria segura o fer servir signatures mÃºltiples pot dificultar el
robatori dels vostres bitcoins.

Entorn molt segur

Aquest moneder Ã©s carregat des d'un entorn segur i especialitzat ofert pel
dispositiu. AixÃ² aporta una protecciÃ³ molt forta sobre vulnerabilitats i
programari maliciÃ³s, ja que en aquest entorn segur no es pot instalÂ·lar cap
programa.

Privacitat variable

Les funcions de privadesa les proporciona la cartera software que utilitzeu
amb aquest dispositiu.

Control variable de la comissiÃ³

Les funcions de control de tarifes les proporciona la cartera software que
utilitzeu amb aquest dispositiu.
...
[Visita el web](https://www.ledgerwallet.com/) [ Codi
font](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
