...
Armory Ã©s un client Bitcoin que amplia les caracterÃ­stiques per usuaris
Bitcoin avanÃ§ats. Ofereix molts tipus de cÃ²pies de seguretat i
encriptacions. Permet emmagatzemament en "fred" a mÃ quines fora de lÃ­nia.
...
Aquesta cartera requereix que instalÂ·leu programari de node complet que
validi i transmeti transaccions a la xarxa Bitcoin. AixÃ² significa que no es
requereix confiar en un tercer a lâhora de verificar els pagaments. Els
nodes complets proporcionen el mÃ xim nivell de seguretat i sÃ³n essencials
per protegir la xarxa. No obstant aixÃ², requereixen mÃ©s espai (mÃ©s de 350
GB), amplada de banda i un temps de sincronitzaciÃ³ inicial mÃ©s llarg.
...
[Visita el web](https://btcarmory.com/) [ Codi
font](https://github.com/goatpig/BitcoinArmory)
