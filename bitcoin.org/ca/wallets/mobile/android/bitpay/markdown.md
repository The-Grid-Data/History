...
BitPay Wallet Ã©s la cartera multisignatura HD construÃ¯da originalment per
assegurar els fons de BitPay. BitPay admet mÃºltiples carteres personals i
compartides, testnet i el protocol de pagament complet. Es pot utilitzar un
node [BWS](https://github.com/bitpay/bitcore-wallet-service) privat per
millorar la seguretat i la privadesa.
...
[Visita el web](https://bitpay.com/wallet) [ Codi
font](https://github.com/bitpay/copay)
