...
Bither Ã©s una cartera senzilla i segura en moltes plataformes. Amb els modes
fred/calent especials dissenyats, l'usuari pot obtenir seguretat i simplicitat
fÃ cilment. Bither's XRANDOM utilitza diferents fonts d'entropia per generar
un nombre aleatori real per als usuaris. TambÃ© amb HDM, els usuaris poden
tenir els avantatges de HD i la seguretat multisig.
...
Aquesta cartera utilitza SPV i la xarxa Bitcoin. AixÃ² significa que no cal
confiar en terceres parts a l'hora de verificar els pagaments. No obstant
aixÃ², no Ã©s tan segur com un node complet com [ Bitcoin Core
](/ca/descarrega).
...
Aquest moneder es carrega a dispositius mÃ²bils a on les aplicacions queden
...
Revela informaciÃ³ limitada a iguals

Els iguals o "peers" de la xarxa poden registrar la teva adreÃ§a IP i
associar-hi els teus pagaments quan els envies o reps.
...
Suggeriments estÃ tics de comissions

Aquesta cartera no proporciona cap suggeriment de comissions basat en les
condicions actuals de la xarxa. AixÃ² vol dir que les vostres transaccions
poden patir retards si la comissiÃ³ escollida Ã©s massa baixa o que podeu
pagar una comissiÃ³ massa alta.
...
[InstalÂ·lar](https://itunes.apple.com/us/app/bither/id899478936) [ Codi
font](https://github.com/bither/bither-ios)

![screenshot](/img/screenshots/bithermobile.png)

[InstalÂ·lar](https://play.google.com/store/apps/details?id=net.bither) [ Codi
font](https://github.com/bither/bither-android)

![screenshot](/img/screenshots/bithermobile.png)

[Visita el web](https://bither.net) [ Codi
font](https://github.com/bither/bither-desktop-java)
