...
Coldcard is an easy to use, ultra-secure, open-source and affordable hardware
wallet that is easy to back up via an encrypted microSD card. Your private key
is stored in a dedicated security chip. MicroPython software design allows you
to make changes.
...
[ÐÐ¾ÑÐµÑÐµÑÐµ ÑÐµÐ±ÑÐ°Ð¹ÑÐ°](https://coldcardwallet.com/) [
ÐÑÐ²Ð¾ÑÐµÐ½ ÐºÐ¾Ð´](https://github.com/Coldcard/firmware)
