...
The BitBox02 is a hardware wallet, developed and manufactured in Switzerland.
It is equipped with an OLED display, invisible touch sensors, USB-C and USB-A
support, offline backups to both microSD card and BIP39 mnemonic. Setting up a
BitBox02 wallet and managing your coins is made easy via the companion
BitBoxApp.
...
[ÐÐ¾ÑÐµÑÐµÑÐµ ÑÐµÐ±ÑÐ°Ð¹ÑÐ°](https://shiftcrypto.ch/bitbox02/) [
ÐÑÐ²Ð¾ÑÐµÐ½ ÐºÐ¾Ð´](https://github.com/BitBoxSwiss/bitbox02-firmware)
