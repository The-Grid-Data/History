...
Bitcoin.org postoji kako bi pomogao Å¡irenju svesti i odrÅ¾ivosti Bitkoina.

## Ko je vlasnik bitcoin.org sajta?
...
### Satoshi Nakamoto i Martti Malmi

Bitcoin.org prvobitno je registrovan i bio vlasniÅ¡tvu dva programera [Satoshi
Nakamoto-a](https://en.bitcoin.it/wiki/Satoshi_Nakamoto) i [Martti
Malmi-a](https://en.bitcoin.it/wiki/Sirius). Kada je Nakamoto napustio
projekat, prepustio je vlasniÅ¡tvo nad domenom ljudima koji nisu bili povezani
sa programerima Bitkoina, kako bi proÅ¡irio odgovornosti i tako onemoguÄio
pojedinca ili grupu da olako steknu kontrolu nad Bitkoin projektom.
...
Od 2011. do 2013. godine, sajt je primarno koriÅ¡Äen za objavljivanje novih
verzija softvera koji je sada poznat kao Bitcoin Core. U 2013. godini, sajt je
redizajniran uz dodavanje velikog broja stranica i dodatnog Bitcoin softvera i
kreiranjem sistema za prevoÄenje.
...
### Dokumentacija za programere dodata je 2014.

AÅ¾uriranja, ispravke i poboljÅ¡anja od strane zajednice uvek su dobrodoÅ¡la.
...
### Sajt je nezavisni projekat potpuno otvorenog tipa.

Sajt je danas nezavisan projekat otvorenog koda sa saradnicima Å¡irom sveta.
KonaÄnu reÄ za objavljivanje imaju suvlasnici, ali su sve redovne aktivnosti
organizovane preko javnih [pull request procesa](https://github.com/bitcoin-
dot-org/bitcoin.org/blob/master/docs/working-with-github.md) i njima
upravljaju suodrÅ¾avaÄi sajta.

Bitcoin.org nije zvaniÄan sajt Bitkoina. Kao Å¡to niko ne poseduje imejl
tehnologiju, tako niko ne poseduje ni Bitcoin mreÅ¾u. Sa obzirom na to, niko
ne moÅ¾e govoriti sa autoritetom u ime Bitkoina.

## Ko onda kontroliÅ¡e Bitkoin?

Bitkoin kontroliÅ¡u svi njegovi korisnici Å¡irom sveta. Programeri unapreÄuju
softver ali oni ne mogu prisilno promeniti pravila Bitkoin protokola, jer su
svi korisnici slobodni da izaberu koji softver Äe koristiti. Da bi korisnici
ostali u saglasju jedni sa drugima, potrebno je da svi koriste softver koji je
u skladu sa istim pravilima. Bitkoin moÅ¾e funkcionisati ispravno jedino ako
postoji apsolutni konsenzus meÄu svim korisnicima. Stoga, svi korisnici i
programeri imaju jaku motivaciju da usvoje i Äuvaju ovaj konsenzus.

## Misija

  * Informisanje korisnika kako bi izbegli uobiÄajene greÅ¡ke.
  * PruÅ¾iti taÄan opis Bitkoinovih osobina, potencijalnih upotreba i ograniÄenja.
  * Transparento prikazivanje upozorenja i dogaÄaja u Bitkoin mreÅ¾i.
  * UkljuÄiti talentovane ljude da pomognu razvoj Bitkoina na razliÄite naÄine.
  * Obezbediti vidljivost i prilagodljivost Bitkoin ekosistema na u veÄoj meri.
  * Unaprediti dostupnost Bitkoina Å¡irom sveta pomoÄu internacionalizacije.
  * Ostati nepristrasan izvor informacija o Bitkoinu.

## Pomozite nam

MoÅ¾ete prijaviti problem ili poboljÅ¡ati bitcoin.org na
[GitHub-u](https://github.com/bitcoin-dot-org/bitcoin.org#how-to-participate)
tako Å¡to Äete otvoriti "pull request" na Engleskom jeziku. Kada podnosite
zahtev za povlaÄenjem (pull request), molimo da pojasnite predloÅ¾ene
promene. MoÅ¾ete pomoÄi prevodjenjem, tako Å¡to Äete se pridruÅ¾iti timu na
[Transifex-u.](https://github.com/bitcoin-dot-
org/bitcoin.org/blob/master/docs/assisting-with-translations.md) Molimo,
nemojte pitati za promociju vaÅ¡eg projekta ili biznisa, osim u specijalnim
okolnostima, kao Å¡to su konferencije. Veliko hvala svim dobrovoljcima koji
ulaÅ¾u vreme, trud i pomaÅ¾u nam da poboljÅ¡amo bitcoin.org!
...
ALL TOPICS
  ...
  * Saradnici koji pruÅ¾aju usluge
  * Neaktivni dobrovoljci
  * Vlasnici Domena
  * Doprinosioci na GitHub-u
