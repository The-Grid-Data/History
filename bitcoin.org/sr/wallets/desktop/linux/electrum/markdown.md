...
Electrum je fokusiran na brzinu i jednostavnost i ne konzumira mnogo resursa.
Koristi servere koji mogu da podnesu i najzahtevnije delove Bitkoin sistema,
takodje ima i opciju da oporaviti svoj novÄanik uz pomoÄ tajne fraze.
...
Ovaj novÄanik koristi SPV i nasumiÄno odabrane servere sa liste. To znaÄi
da je vrlo malo poverenja potrebno u treÄe lice prilikom verifikovanja
uplate. MeÄutim, nije siguran koliko i full node poput [Bitcoin
Core](/sr/preuzimanje).
...
Overavanje autentiÄnosti u dva koraka

Ovaj novÄanik se moÅ¾e koristiti u nesigurnom okruÅ¾enju. Ova usluga zatheva
autentikaciju u dva koraka, Å¡to znaÄi da je pristup veÄem broju ureÄaja
potreban kako bi se bitkoini ukrali.
...
[Poseti Web sajt](https://electrum.org) [ Izvorni
kod](https://github.com/spesmilo/electrum)
...
[Instaliraj](https://play.google.com/store/apps/details?id=org.electrum.electrum)
[ Izvorni kod](https://github.com/spesmilo/electrum)
