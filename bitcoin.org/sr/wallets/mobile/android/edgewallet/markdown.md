...
Edge je mobilni Bitkoin novÄanik kompatibilan sa Segwit-om sa visokim nivoom
privatnosti, bezbednosti i decentralizacije koji je veoma poznat i lak za
koriÅ¡Äenje. Edge novÄanici su uvek automatski enkriptovani, sa rezervnom
kopijom podataka, i funkcioniÅ¡u Äak i kada Edge serveri padnu.
...
Hostovana kontrola nad vaÅ¡im novcem

Ovaj novÄanik vam daje kontrolu nad vaÅ¡im bitkoinima. MeÄutim, ovaj servis
zadrÅ¾ava kriptovanu kopiju vaÅ¡eg novÄanika. To znaÄi da vam bitkoini mogu
biti ukradeni ukoliko ne koristite jaku Å¡ifru a servis bude kompromitovan.

Decentralizovana validacija

Ovaj novÄanik konektuje se nasumiÄno na server sa liste. Ovaj naÄin zahteva
neko poverenje u treÄe lice kada se upalte verifikiju. MeÄutim,nije siguran
koliko i full node poput [Bitcoin Core](/sr/preuzimanje).
...
Otkriva informacije treÄoj strani

Ova usluga moÅ¾e da poveÅ¾e uplate, Äuva log vaÅ¡e IP adrese i zna vaÅ¡ pravi
identitet ukiliko pruÅ¾ite informacije o identitetu, kao Å¡to su email adresa,
ime i bankovni raÄun.
...
DinamiÄka provizija sa opcijom menjanja

Ovaj novÄanik pruÅ¾a procenu provizije zasnovanu na trenutnom stanju i
uslovima na mreÅ¾i koju moÅ¾ete menjati sami. Ovo znaÄi da Äe vam novÄanik
pomoÄi da odaberete odgovarajuÄi iznos provizije kako bi vaÅ¡a transakcije
bila potrvrÄjena u odgovarajuÄem vremenskom periodu, bez potrebe da platite
viÅ¡e nego Å¡to treba, ali vam u krajnoj meri daje potpunu slobodu prilikom
odabira provizije.
...
[Instaliraj](https://play.google.com/store/apps/details?id=co.edgesecure.app)
[ Izvorni kod](https://github.com/EdgeApp/edge-react-gui)

![screenshot](/img/screenshots/edgewalletandroid.png)

[Instaliraj](https://itunes.apple.com/us/app/edge-bitcoin-wallet/id1344400091)
[ Izvorni kod](https://github.com/EdgeApp/edge-react-gui)
