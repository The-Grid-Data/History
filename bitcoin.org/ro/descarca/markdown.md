...
# DescarcÄ Bitcoin Core

## Ultima versiune: 27.0

[ DescarcÄ Bitcoin Core ](https://bitcoin.org/bin/bitcoin-
...
## Va trebui sÄ ai rÄbdare

Sincronizarea iniÅ£ialÄ a Bitcoin Core poate dura mult timp. Ar trebui sÄ te
asiguri de la Ã®nceput cÄ dispui de destulÄ lÄÅ£ime de bandÄ Åi spaÅ£iu
de stocare suficient pentru mÄrimea lanÅ£ului de blocuri(peste 65GB). DacÄ
Åtii cum sÄ descarci un fiÅier torrent, poÅ£i grÄbi acest proces prin
adÄugarea [bootstrap.dat](/bin/blockchain/bootstrap.dat.torrent) (o copie
anterioarÄ a lanÅ£ului de blocuri) Ã®n directorul data al Bitcoin Core
Ã®nainte de a porni programul. Read the [full node guide](/en/full-node) for
details.

Bitcoin Core este proiect comunitar [software
gratis](https://www.fsf.org/about/what-is-free-software) creat de comunitate,
eliberat sub [licenÅ£Ä MIT](http://opensource.org/licenses/mit-license.php).

[VerificÄ semnÄturile versiunilor](/bin/bitcoin-core-27.0/SHA256SUMS.asc)
[Download torrent](/bin/bitcoin-core-27.0/bitcoin-27.0.torrent)
...
[Source code](https://github.com/bitcoin/bitcoin) [Vezi istoric
versiuni](/en/version-history)

Sau alege sistemul tÄu de operare
