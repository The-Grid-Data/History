...
Verificare variabilÄ

FuncÅ£ionalitatea de verificare a plÄÅ£ilor este oferitÄ de software-ul
portofelului pe care Ã®l foloseÅti pe acest dispozitiv. Te rugÄm sÄ
verifici punctajul de Validare pentru softwareul portofelului pe care
intenÅ£ionezi sÄ-l foloseÅti.

TransparenÅ£Ä de bazÄ

SpecificaÅ£iile acestui portofel sunt publice. Asta Ã®nseamnÄ cÄ orice
dezvoltator din lume poate face testare de tip blackbox. TotuÅi, tot trebuie
sÄ ai Ã®ncredere Ã®n dezvoltatorii acestui portofel deoarece dispozitivul nu
poate fi verificat cÄ genereaz seed-uri sigure Åi aleatorii, Åi codul
sursÄ nu poate fi auditat. Actualizarea firmware-ului dispozitivului tÄu,
generarea proprie a unui seed sigur Åi aleatoriu sau folosirea semnÄturii
multiple poate face dificil furtul bitcoinilor tÄi.

Un mediu foarte securizat

Acest portofel este incÄrcat dintr-un mediu specializat sigur oferit de
dispozitiv. Asta oferÄ o protecÅ£ie foarte puternicÄ Ã®mpotriva
vulnerabilitÄÅ£ilor informatice Åi malware din moment ce pe acest mediu nu
se poate instala nici un software.

ConfidenÅ£ialitate variabilÄ

OpÅ£iunile de confindentialitate sunt oferite de cÄtre portofelul software pe
care Ã®l foloseÅti pe acest dispozitiv. Te rugÄm sÄ verifici Scorul de
confindentialitate pentru portofelul software pe care intenÅ£ionezi sÄ-l
foloseÅti.
...
[ViziteazÄ site-ul web](https://www.ledgerwallet.com/) [ Codul
sursa](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
