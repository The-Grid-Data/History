...
TREZOR este un portofel hardware ce oferÄ un grad Ã®nalt de securitate fÄrÄ
a sacrifica convenienÅ£a. Spre deosebire de stocarea la rece, TREZOR este
capabil sÄ semneze tranzacÅ£ii Ã®n timp ce este conectat la un dispozitiv
online. Asta Ã®nseamnÄ cÄ bitcoinii pot fi cheltuiÅ£i Ã®ntr-un mod sigur
chiar dacÄ este folosit un computer compromis.
...
[ViziteazÄ site-ul web](https://trezor.io/) [ Codul
sursa](https://github.com/trezor/trezor-firmware)
