...
Electrum se bazeazÄ pe rapiditate Åi simplitate, consumÃ¢nd puÅ£ine resurse.
FoloseÅte servere la distanÅ£Ä ce se ocupÄ de majoritatea pÄrÅ£ilor
complicate ale sistemului Bitcoin Åi Ã®Å£i permit sÄ-Å£i recuperezi
portofelul folosind o frazÄ secretÄ.
...
Ã®nseamnÄ o Ã®ncredere scÄzutÄ Ã®n pÄrÅ£i terÅ£e Ã®n momentul verificÄrii
...
Acest portofel poate fi folosit pe medii nesigure. TotuÅi, acest serviciu
necesitÄ autentificarea pe douÄ niveluri. Asta Ã®nseamnÄ cÄ este necesar
accesul la mai multe dispozitive sau conturi pentru a putea fura bitcoinii
tÄi.
...
[ViziteazÄ site-ul web](https://electrum.org) [ Codul
sursa](https://github.com/spesmilo/electrum)
...
[Instaleaza](https://play.google.com/store/apps/details?id=org.electrum.electrum)
[ Codul sursa](https://github.com/spesmilo/electrum)
