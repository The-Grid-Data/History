...
[Bitcoin](/en/) > [Core](/en/bitcoin-core/) > Contribute

# Contributing To Bitcoin Core

Thank you for considering contributing to Bitcoin Core! We have instructions
below to help you get started contributing in several different ways.

If want to contribute in another way, please visit the [#bitcoin-
dev](https://webchat.freenode.net/?channels=bitcoin-dev&uio=d4) IRC chatroom
and discuss your plan with a developer.

![icon](/img/icons/ico_bugs.svg?1716491272)

[Bug reports](/en/bitcoin-core/contribute/issues)

Report bugs, including security issues

![icon](/img/icons/ico_code.svg?1716491272)
...
![icon](/img/icons/ico_translation.svg?1716491272)

[Translations](/en/bitcoin-core/contribute/translations)

Translate the user interface

![icon](/img/icons/ico_support.svg?1716491272)
