...
RPC:
  ...
  * Avoid a segfault on getblock if it canât read a block from disk
  * Add paranoid return value checks in base58

Protocol and network code:

  * Donât poll showmyip.com, it doesnât exist anymore
...
GUI:
  ...
  * fix âopens in testnet mode when presented with a BIP-72 link with no fallbackâ
