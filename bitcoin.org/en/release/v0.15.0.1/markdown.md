...
### GUI
  ...
  * [#10660](https://github.com/bitcoin/bitcoin/pull/10660) [`0c3542e`](https://github.com/bitcoin/bitcoin/commit/0c3542e) Allow to cancel the txdb upgrade via splashscreen keypress âqâ (jonasschnelli)
...
### Tests and QA
  ...
  * [#10052](https://github.com/bitcoin/bitcoin/pull/10052) [`a0b1e57`](https://github.com/bitcoin/bitcoin/commit/a0b1e57) [test] Run extended tests once daily in Travis (jnewbery)
  ...
  * [#10264](https://github.com/bitcoin/bitcoin/pull/10264) [`492d22f`](https://github.com/bitcoin/bitcoin/commit/492d22f) [test] Add tests for getconnectioncount, getnettotals and ping (jimmysong)
  ...
  * [#10321](https://github.com/bitcoin/bitcoin/pull/10321) [`e801084`](https://github.com/bitcoin/bitcoin/commit/e801084) Use FastRandomContext for all tests (sipa)
  ...
  * [#11032](https://github.com/bitcoin/bitcoin/pull/11032) [`aeb3175`](https://github.com/bitcoin/bitcoin/commit/aeb3175) [qa] Fix block message processing error in sendheaders.py (sdaftuar)
...
### Miscellaneous
  ...
  * [#9932](https://github.com/bitcoin/bitcoin/pull/9932) [`00c13ea`](https://github.com/bitcoin/bitcoin/commit/00c13ea) Fix verify-commits on travis and always check top commitâs tree (TheBlueMatt)
  ...
  * [#10085](https://github.com/bitcoin/bitcoin/pull/10085) [`db1ae54`](https://github.com/bitcoin/bitcoin/commit/db1ae54) Docs: remove ânoconnectâ option (jlopp)
  ...
  * [#9424](https://github.com/bitcoin/bitcoin/pull/9424) [`1a5aaab`](https://github.com/bitcoin/bitcoin/commit/1a5aaab) Change LogAcceptCategory to use uint32_t rather than sets of strings (gmaxwell)
  * [#10036](https://github.com/bitcoin/bitcoin/pull/10036) [`fbf36ca`](https://github.com/bitcoin/bitcoin/commit/fbf36ca) Fix init README format to render correctly on github (jlopp)
  * [#10058](https://github.com/bitcoin/bitcoin/pull/10058) [`a2cd0b0`](https://github.com/bitcoin/bitcoin/commit/a2cd0b0) No need to use OpenSSL malloc/free (tjps)
  * [#10123](https://github.com/bitcoin/bitcoin/pull/10123) [`471ed00`](https://github.com/bitcoin/bitcoin/commit/471ed00) Allow debug logs to be excluded from specified component (jnewbery)
  * [#10104](https://github.com/bitcoin/bitcoin/pull/10104) [`fadf078`](https://github.com/bitcoin/bitcoin/commit/fadf078) linearize script: Option to use RPC cookie (achow101)
  * [#10162](https://github.com/bitcoin/bitcoin/pull/10162) [`a3a2160`](https://github.com/bitcoin/bitcoin/commit/a3a2160) [trivial] Log calls to getblocktemplate (jnewbery)
  * [#10155](https://github.com/bitcoin/bitcoin/pull/10155) [`928695b`](https://github.com/bitcoin/bitcoin/commit/928695b) build: Deduplicate version numbers (laanwj)
  * [#10211](https://github.com/bitcoin/bitcoin/pull/10211) [`a86255b`](https://github.com/bitcoin/bitcoin/commit/a86255b) [doc] Contributor fixes & new âfinding reviewersâ section (kallewoof)
  * [#10250](https://github.com/bitcoin/bitcoin/pull/10250) [`1428f30`](https://github.com/bitcoin/bitcoin/commit/1428f30) Fix some empty vector references (sipa)
  * [#10270](https://github.com/bitcoin/bitcoin/pull/10270) [`95f5e44`](https://github.com/bitcoin/bitcoin/commit/95f5e44) Remove Clang workaround for Boost 1.46 (fanquake)
  * [#10263](https://github.com/bitcoin/bitcoin/pull/10263) [`cb007e4`](https://github.com/bitcoin/bitcoin/commit/cb007e4) Trivial: fix fee estimate write error log message (CryptAxe)
  * [#9670](https://github.com/bitcoin/bitcoin/pull/9670) [`bd9ec0e`](https://github.com/bitcoin/bitcoin/commit/bd9ec0e) contrib: github-merge improvements (laanwj)
  * [#10260](https://github.com/bitcoin/bitcoin/pull/10260) [`1d75597`](https://github.com/bitcoin/bitcoin/commit/1d75597) [doc] Minor corrections to osx dependencies (fanquake)
  * [#10189](https://github.com/bitcoin/bitcoin/pull/10189) [`750c5a5`](https://github.com/bitcoin/bitcoin/commit/750c5a5) devtools/net: add a verifier for scriptable changes. Use it to make CNode::id private (theuni)
  * [#10322](https://github.com/bitcoin/bitcoin/pull/10322) [`bc64b5a`](https://github.com/bitcoin/bitcoin/commit/bc64b5a) Use hardware timestamps in RNG seeding (sipa)
  * [#10381](https://github.com/bitcoin/bitcoin/pull/10381) [`7f2b9e0`](https://github.com/bitcoin/bitcoin/commit/7f2b9e0) Shadowing warnings are not enabled by default, update doc accordingly (paveljanik)
  * [#10380](https://github.com/bitcoin/bitcoin/pull/10380) [`b6ee855`](https://github.com/bitcoin/bitcoin/commit/b6ee855) [doc] Removing comments about dirty entries on txmempool (madeo)
  * [#10383](https://github.com/bitcoin/bitcoin/pull/10383) [`d0c37ee`](https://github.com/bitcoin/bitcoin/commit/d0c37ee) [logging] log system time and mock time (jnewbery)
  * [#10404](https://github.com/bitcoin/bitcoin/pull/10404) [`b45a52a`](https://github.com/bitcoin/bitcoin/commit/b45a52a) doc: Add logging to FinalizeNode() (sdaftuar)
  * [#10388](https://github.com/bitcoin/bitcoin/pull/10388) [`526e839`](https://github.com/bitcoin/bitcoin/commit/526e839) Output line to debug.log when IsInitialBlockDownload latches to false (morcos)
  * [#10372](https://github.com/bitcoin/bitcoin/pull/10372) [`15254e9`](https://github.com/bitcoin/bitcoin/commit/15254e9) Add perf counter data to GetStrongRandBytes state in scheduler (TheBlueMatt)
  * [#10461](https://github.com/bitcoin/bitcoin/pull/10461) [`55b72f3`](https://github.com/bitcoin/bitcoin/commit/55b72f3) Update style guide (sipa)
  * [#10486](https://github.com/bitcoin/bitcoin/pull/10486) [`10e8c0a`](https://github.com/bitcoin/bitcoin/commit/10e8c0a) devtools: Retry after signing fails in github-merge (laanwj)
  * [#10447](https://github.com/bitcoin/bitcoin/pull/10447) [`f259263`](https://github.com/bitcoin/bitcoin/commit/f259263) Make bitcoind invalid argument error message specific (laanwj)
  * [#10495](https://github.com/bitcoin/bitcoin/pull/10495) [`6a38b79`](https://github.com/bitcoin/bitcoin/commit/6a38b79) contrib: Update location of seeds.txt (laanwj)
  * [#10469](https://github.com/bitcoin/bitcoin/pull/10469) [`b6b150b`](https://github.com/bitcoin/bitcoin/commit/b6b150b) Fixing typo in rpcdump.cpp help message (keystrike)
  * [#10451](https://github.com/bitcoin/bitcoin/pull/10451) [`27b9931`](https://github.com/bitcoin/bitcoin/commit/27b9931) contrib/init/bitcoind.openrcconf: Donât disable wallet by default (luke-jr)
  * [#10323](https://github.com/bitcoin/bitcoin/pull/10323) [`00d3692`](https://github.com/bitcoin/bitcoin/commit/00d3692) Update to latest libsecp256k1 master (sipa)
  * [#10422](https://github.com/bitcoin/bitcoin/pull/10422) [`cec9e1e`](https://github.com/bitcoin/bitcoin/commit/cec9e1e) Fix timestamp in fee estimate debug message (morcos)
  * [#10566](https://github.com/bitcoin/bitcoin/pull/10566) [`5d034ee`](https://github.com/bitcoin/bitcoin/commit/5d034ee) [docs] Use the âdomain name setupâ image (previously unused) in the gitian docs (practicalswift)
  * [#10534](https://github.com/bitcoin/bitcoin/pull/10534) [`a514ac3`](https://github.com/bitcoin/bitcoin/commit/a514ac3) Clarify prevector::erase and avoid swap-to-clear (sipa)
  * [#10575](https://github.com/bitcoin/bitcoin/pull/10575) [`22ec768`](https://github.com/bitcoin/bitcoin/commit/22ec768) Header include guideline (sipa)
  * [#10480](https://github.com/bitcoin/bitcoin/pull/10480) [`fbf5d3b`](https://github.com/bitcoin/bitcoin/commit/fbf5d3b) Improve commit-check-script.sh (sipa)
  * [#10502](https://github.com/bitcoin/bitcoin/pull/10502) [`1ad3d4e`](https://github.com/bitcoin/bitcoin/commit/1ad3d4e) scripted-diff: Remove BOOST_FOREACH, Q_FOREACH and PAIRTYPE (jtimon)
  * [#10377](https://github.com/bitcoin/bitcoin/pull/10377) [`b63be2c`](https://github.com/bitcoin/bitcoin/commit/b63be2c) Use rdrand as entropy source on supported platforms (sipa)
  * [#9895](https://github.com/bitcoin/bitcoin/pull/9895) [`228c319`](https://github.com/bitcoin/bitcoin/commit/228c319) Turn TryCreateDirectory() into TryCreateDirectories() (benma)
  * [#10602](https://github.com/bitcoin/bitcoin/pull/10602) [`d76e84a`](https://github.com/bitcoin/bitcoin/commit/d76e84a) Make clang-format use C++11 features (practicalswift)
  * [#10623](https://github.com/bitcoin/bitcoin/pull/10623) [`c38f540`](https://github.com/bitcoin/bitcoin/commit/c38f540) doc: Add 0.14.2 release notes (MarcoFalke)
  * [#10276](https://github.com/bitcoin/bitcoin/pull/10276) [`b750b33`](https://github.com/bitcoin/bitcoin/commit/b750b33) contrib/verifybinaries: allow filtering by platform (knocte)
  * [#10248](https://github.com/bitcoin/bitcoin/pull/10248) [`01c4b14`](https://github.com/bitcoin/bitcoin/commit/01c4b14) Rewrite addrdb with less duplication using CHashVerifier (sipa)
  * [#10577](https://github.com/bitcoin/bitcoin/pull/10577) [`232508f`](https://github.com/bitcoin/bitcoin/commit/232508f) Add an explanation of quickly hashing onto a non-power of two range (gmaxwell)
  * [#10608](https://github.com/bitcoin/bitcoin/pull/10608) [`eee398f`](https://github.com/bitcoin/bitcoin/commit/eee398f) Add a comment explaining the use of MAX_BLOCK_BASE_SIZE (gmaxwell)
  * [#10728](https://github.com/bitcoin/bitcoin/pull/10728) [`7397af9`](https://github.com/bitcoin/bitcoin/commit/7397af9) fix typo in help text for removeprunedfunds (AkioNak)
  * [#10193](https://github.com/bitcoin/bitcoin/pull/10193) [`6dbcc74`](https://github.com/bitcoin/bitcoin/commit/6dbcc74) scripted-diff: Remove #include <boost/foreach.hpp> (jtimon)
  * [#10676](https://github.com/bitcoin/bitcoin/pull/10676) [`379aed0`](https://github.com/bitcoin/bitcoin/commit/379aed0) document script-based return fields for validateaddress (instagibbs)
  * [#10651](https://github.com/bitcoin/bitcoin/pull/10651) [`cef4b5c`](https://github.com/bitcoin/bitcoin/commit/cef4b5c) Verify binaries from bitcoincore.org and bitcoin.org (TheBlueMatt)
  * [#10786](https://github.com/bitcoin/bitcoin/pull/10786) [`ca4c545`](https://github.com/bitcoin/bitcoin/commit/ca4c545) Add PR description to merge commit in github-merge.py (sipa)
  * [#10812](https://github.com/bitcoin/bitcoin/pull/10812) [`c5904e8`](https://github.com/bitcoin/bitcoin/commit/c5904e8) [utils] Allow bitcoin-cliâs -rpcconnect option to be used with square brackets (jnewbery)
  * [#10842](https://github.com/bitcoin/bitcoin/pull/10842) [`3895e25`](https://github.com/bitcoin/bitcoin/commit/3895e25) Fix incorrect Doxygen tag (@ince â @since). Doxygen parameter name matching (practicalswift)
  * [#10681](https://github.com/bitcoin/bitcoin/pull/10681) [`df0793f`](https://github.com/bitcoin/bitcoin/commit/df0793f) add gdb attach process to test README (instagibbs)
  * [#10789](https://github.com/bitcoin/bitcoin/pull/10789) [`1124328`](https://github.com/bitcoin/bitcoin/commit/1124328) Punctuation/grammer fixes in rpcwallet.cpp (stevendlander)
  * [#10655](https://github.com/bitcoin/bitcoin/pull/10655) [`78f307b`](https://github.com/bitcoin/bitcoin/commit/78f307b) Properly document target_confirmations in listsinceblock (RHavar)
  * [#10917](https://github.com/bitcoin/bitcoin/pull/10917) [`5c003cb`](https://github.com/bitcoin/bitcoin/commit/5c003cb) developer-notes: add reference to snake_case and PascalCase (benma)
  * [#11003](https://github.com/bitcoin/bitcoin/pull/11003) [`4b5a7ce`](https://github.com/bitcoin/bitcoin/commit/4b5a7ce) Docs: Capitalize bullet points in CONTRIBUTING guide (eklitzke)
  * [#10968](https://github.com/bitcoin/bitcoin/pull/10968) [`98aa3f6`](https://github.com/bitcoin/bitcoin/commit/98aa3f6) Add instructions for parallel gitian builds (coblee)
  * [#11076](https://github.com/bitcoin/bitcoin/pull/11076) [`1c4b9b3`](https://github.com/bitcoin/bitcoin/commit/1c4b9b3) 0.15 release-notes nits: fix redundancy, remove accidental parenthesis & fix range style (practicalswift)
  * [#11090](https://github.com/bitcoin/bitcoin/pull/11090) [`8f0121c`](https://github.com/bitcoin/bitcoin/commit/8f0121c) Update contributor names in release-notes.md (Derek701)
  * [#11056](https://github.com/bitcoin/bitcoin/pull/11056) [`cbdd338`](https://github.com/bitcoin/bitcoin/commit/cbdd338) disable jni in builds (instagibbs)
  * [#11080](https://github.com/bitcoin/bitcoin/pull/11080) [`2b59cfb`](https://github.com/bitcoin/bitcoin/commit/2b59cfb) doc: Update build-openbsd for 6.1 (laanwj)
  * [#11119](https://github.com/bitcoin/bitcoin/pull/11119) [`0a6af47`](https://github.com/bitcoin/bitcoin/commit/0a6af47) [doc] build-windows: Mention that only trusty works (MarcoFalke)
  * [#11108](https://github.com/bitcoin/bitcoin/pull/11108) [`e8ad101`](https://github.com/bitcoin/bitcoin/commit/e8ad101) Changing -txindex requires -reindex, not -reindex-chainstate (TheBlueMatt)
  * [#9792](https://github.com/bitcoin/bitcoin/pull/9792) [`342b9bc`](https://github.com/bitcoin/bitcoin/commit/342b9bc) FastRandomContext improvements and switch to ChaCha20 (sipa)
  * [#9505](https://github.com/bitcoin/bitcoin/pull/9505) [`67ed40e`](https://github.com/bitcoin/bitcoin/commit/67ed40e) Prevector Quick Destruct (JeremyRubin)
  * [#10820](https://github.com/bitcoin/bitcoin/pull/10820) [`ef37f20`](https://github.com/bitcoin/bitcoin/commit/ef37f20) Use cpuid intrinsics instead of asm code (sipa)
  * [#9999](https://github.com/bitcoin/bitcoin/pull/9999) [`a328904`](https://github.com/bitcoin/bitcoin/commit/a328904) [LevelDB] Plug leveldb logs to bitcoin logs (NicolasDorier)
  * [#9693](https://github.com/bitcoin/bitcoin/pull/9693) [`c5e9e42`](https://github.com/bitcoin/bitcoin/commit/c5e9e42) Prevent integer overflow in ReadVarInt (gmaxwell)
  * [#10129](https://github.com/bitcoin/bitcoin/pull/10129) [`351d0ad`](https://github.com/bitcoin/bitcoin/commit/351d0ad) scheduler: fix sub-second precision with boost < 1.50 (theuni)
  * [#10153](https://github.com/bitcoin/bitcoin/pull/10153) [`fade788`](https://github.com/bitcoin/bitcoin/commit/fade788) logging: Fix off-by-one for shrinkdebugfile default (MarcoFalke)
  * [#10305](https://github.com/bitcoin/bitcoin/pull/10305) [`c45da32`](https://github.com/bitcoin/bitcoin/commit/c45da32) Fix potential NPD introduced in b297426c (TheBlueMatt)
  * [#10338](https://github.com/bitcoin/bitcoin/pull/10338) [`daf3e7d`](https://github.com/bitcoin/bitcoin/commit/daf3e7d) Maintain state across GetStrongRandBytes calls (sipa)
  * [#10544](https://github.com/bitcoin/bitcoin/pull/10544) [`a4fe077`](https://github.com/bitcoin/bitcoin/commit/a4fe077) Update to LevelDB 1.20 (sipa)
  * [#10614](https://github.com/bitcoin/bitcoin/pull/10614) [`cafe24f`](https://github.com/bitcoin/bitcoin/commit/cafe24f) random: fix crash on some 64bit platforms (theuni)
  * [#10714](https://github.com/bitcoin/bitcoin/pull/10714) [`2a09a38`](https://github.com/bitcoin/bitcoin/commit/2a09a38) Avoid printing incorrect block indexing time due to uninitialized variable (practicalswift)
  * [#10837](https://github.com/bitcoin/bitcoin/pull/10837) [`8bc6d1f`](https://github.com/bitcoin/bitcoin/commit/8bc6d1f) Fix resource leak on error in GetDevURandom (corebob)
  * [#10832](https://github.com/bitcoin/bitcoin/pull/10832) [`89bb036`](https://github.com/bitcoin/bitcoin/commit/89bb036) init: Factor out AppInitLockDataDirectory and fix startup core dump issue (laanwj)
  * [#10914](https://github.com/bitcoin/bitcoin/pull/10914) [`b995a37`](https://github.com/bitcoin/bitcoin/commit/b995a37) Add missing lock in CScheduler::AreThreadsServicingQueue() (TheBlueMatt)
  * [#10958](https://github.com/bitcoin/bitcoin/pull/10958) [`659c096`](https://github.com/bitcoin/bitcoin/commit/659c096) Update to latest Bitcoin patches for LevelDB (sipa)
  * [#10919](https://github.com/bitcoin/bitcoin/pull/10919) [`c1c671f`](https://github.com/bitcoin/bitcoin/commit/c1c671f) Fix more init bugs (TheBlueMatt)
