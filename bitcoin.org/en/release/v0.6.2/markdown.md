...
file then run with the new -detachdb=1 option or the âDetach databases at
shutdownâ GUI preference.
...
Network protocol changes:
  ...
  * added nonce value to âpingâ message (BIP 31)
  * added new âpongâ message (BIP 31)
