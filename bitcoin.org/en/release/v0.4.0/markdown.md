...
start because bdb 4.7 cannot read bdb 4.8 âlogâ files.
...
file donât automatically get access to all of your Bitcoins. In order to
enable this feature, chose âEncrypt Walletâ from the Options menu. You
will be prompted to enter a passphrase, which will be used as the key to
encrypt your wallet and will be needed every time you wish to send Bitcoins.
If you lose this passphrase, you will lose access to spend all of the bitcoins
in your wallet, no one, not even the Bitcoin developers can recover your
Bitcoins. This means you are responsible for your own security, store your
