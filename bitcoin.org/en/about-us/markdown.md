...
developers, [Satoshi Nakamoto](https://en.bitcoin.it/wiki/Satoshi_Nakamoto)
and [Martti Malmi](https://en.bitcoin.it/wiki/Sirius). When Nakamoto left the
project, he gave ownership of the domain to additional people, separate from
the Bitcoin developers, to spread responsibility and prevent any one person or
...
improving the software but they can't force a change in the rules of the
Bitcoin protocol because all users are free to choose what software they use.
In order to stay compatible with each other, all users need to use software
complying with the same rules. Bitcoin can only work decently with a complete
