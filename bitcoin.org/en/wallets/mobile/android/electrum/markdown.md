...
Electrum's focus is speed and simplicity, with low resource usage. It uses
remote servers that handle the most complicated parts of the Bitcoin system,
and it allows you to recover your wallet from a secret phrase.
...
This wallet uses SPV and random servers from a list. This means little trust
in third parties is required when verifying payments. However, it is not as
...
This service can associate your payments together, log your IP address and
know your real identity if you provide personal information like your email,
name or banking account.
...
[Visit website](https://electrum.org) [ Source
...
[Install](https://play.google.com/store/apps/details?id=org.electrum.electrum)
