...
## New and Updated RPCs
  ...
  * When creating a hex-encoded bitcoin transaction using the `bitcoin-tx` utility with the `-json` option set, the following fields: `addresses`, `reqSigs` are no longer returned in the tx output of the response. ([#20286](https://github.com/bitcoin/bitcoin/pull/20286))
...
### Block and transaction handling
  ...
  * [#14501](https://github.com/bitcoin/bitcoin/pull/14501) Fix possible data race when committing block files (luke-jr)
  ...
  * [#22415](https://github.com/bitcoin/bitcoin/pull/22415) Make `m_mempool` optional in CChainState (jamesob)
...
### P2P protocol and network code
  ...
  * [#20661](https://github.com/bitcoin/bitcoin/pull/20661) Only select from addrv2-capable peers for torv3 address relay (sipa)
  ...
  * [#21563](https://github.com/bitcoin/bitcoin/pull/21563) Restrict period when `cs_vNodes` mutex is locked (hebasto)
...
### Wallet
  ...
  * [#15710](https://github.com/bitcoin/bitcoin/pull/15710) Catch `ios_base::failure` specifically (Bushstar)
  ...
  * [#22042](https://github.com/bitcoin/bitcoin/pull/22042) Replace size/weight estimate tuple with struct for named fields (instagibbs)
...
### RPC and other APIs
  ...
  * [#20941](https://github.com/bitcoin/bitcoin/pull/20941) Document `RPC_TRANSACTION_ALREADY_IN_CHAIN` exception (jarolrod)
...
### GUI
  ...
  * gui[#118](https://github.com/bitcoin/bitcoin/pull/118) Remove BDB version from the Information tab (hebasto)
  ...
  * gui[#251](https://github.com/bitcoin/bitcoin/pull/251) Improve URI/file handling message (hebasto)
...
### Build system
  ...
  * [#20650](https://github.com/bitcoin/bitcoin/pull/20650) Drop workaround for a fixed bug in Qt build system (hebasto)
  ...
  * [#21363](https://github.com/bitcoin/bitcoin/pull/21363) build, qt: Improve Qt static plugins/libs check code (hebasto)
  ...
  * [#22075](https://github.com/bitcoin/bitcoin/pull/22075) guix: Misc leftover usability improvements (dongcarl)
...
### Tests and QA
  ...
  * [#19893](https://github.com/bitcoin/bitcoin/pull/19893) Remove or explain syncwithvalidationinterfacequeue (MarcoFalke)
  ...
  * [#20745](https://github.com/bitcoin/bitcoin/pull/20745) Correct `epoll_ctl` data race suppression (hebasto)
  ...
  * [#21100](https://github.com/bitcoin/bitcoin/pull/21100) Remove unused function `xor_bytes` (theStack)
  ...
  * [#21443](https://github.com/bitcoin/bitcoin/pull/21443) fuzz: Implement `fuzzed_dns_lookup_function` as a lambda (practicalswift)
  ...
  * [#21785](https://github.com/bitcoin/bitcoin/pull/21785) Fix intermittent issue in `p2p_addr_relay.py` (MarcoFalke)
  ...
  * [#22004](https://github.com/bitcoin/bitcoin/pull/22004) fuzz: Speed up transaction fuzz target (MarcoFalke)
  ...
  * [#22310](https://github.com/bitcoin/bitcoin/pull/22310) Add functional test for replacement relay fee check (ariard)
...
### Miscellaneous
  ...
  * [#20602](https://github.com/bitcoin/bitcoin/pull/20602) util: Allow use of c++14 chrono literals (MarcoFalke)
  * [#20605](https://github.com/bitcoin/bitcoin/pull/20605) init: Signal-safe instant shutdown (laanwj)
  * [#20608](https://github.com/bitcoin/bitcoin/pull/20608) contrib: Add symbol check test for PE binaries (fanquake)
  * [#20689](https://github.com/bitcoin/bitcoin/pull/20689) contrib: Replace binary verification script verify.sh with python rewrite (theStack)
  * [#20715](https://github.com/bitcoin/bitcoin/pull/20715) util: Add argsmanager::getcommand() and use it in bitcoin-wallet (MarcoFalke)
  * [#20735](https://github.com/bitcoin/bitcoin/pull/20735) script: Remove outdated extract-osx-sdk.sh (hebasto)
  * [#20817](https://github.com/bitcoin/bitcoin/pull/20817) lint: Update list of spelling linter false positives, bump to codespell 2.0.0 (theStack)
  * [#20884](https://github.com/bitcoin/bitcoin/pull/20884) script: Improve robustness of bitcoind.service on startup (hebasto)
  * [#20906](https://github.com/bitcoin/bitcoin/pull/20906) contrib: Embed c++11 patch in `install_db4.sh` (gruve-p)
  * [#21004](https://github.com/bitcoin/bitcoin/pull/21004) contrib: Fix docker args conditional in gitian-build (setpill)
  * [#21007](https://github.com/bitcoin/bitcoin/pull/21007) bitcoind: Add -daemonwait option to wait for initialization (laanwj)
  * [#21041](https://github.com/bitcoin/bitcoin/pull/21041) log: Move âPre-allocating up to position 0x[â¦] in [â¦].datâ log message to debug category (practicalswift)
  * [#21059](https://github.com/bitcoin/bitcoin/pull/21059) Drop boost/preprocessor dependencies (hebasto)
  * [#21087](https://github.com/bitcoin/bitcoin/pull/21087) guix: Passthrough `BASE_CACHE` into container (dongcarl)
  * [#21088](https://github.com/bitcoin/bitcoin/pull/21088) guix: Jump forwards in time-machine and adapt (dongcarl)
  * [#21089](https://github.com/bitcoin/bitcoin/pull/21089) guix: Add support for powerpc64{,le} (dongcarl)
  * [#21110](https://github.com/bitcoin/bitcoin/pull/21110) util: Remove boost `posix_time` usage from `gettime*` (fanquake)
  * [#21111](https://github.com/bitcoin/bitcoin/pull/21111) Improve OpenRC initscript (parazyd)
  * [#21123](https://github.com/bitcoin/bitcoin/pull/21123) code style: Add EditorConfig file (kiminuo)
  * [#21173](https://github.com/bitcoin/bitcoin/pull/21173) util: Faster hexstr => 13% faster blocktojson (martinus)
  * [#21221](https://github.com/bitcoin/bitcoin/pull/21221) tools: Allow argument/parameter bin packing in clang-format (jnewbery)
  * [#21244](https://github.com/bitcoin/bitcoin/pull/21244) Move GetDataDir to ArgsManager (kiminuo)
  * [#21255](https://github.com/bitcoin/bitcoin/pull/21255) contrib: Run test-symbol-check for risc-v (fanquake)
  * [#21271](https://github.com/bitcoin/bitcoin/pull/21271) guix: Explicitly set umask in build container (dongcarl)
  * [#21300](https://github.com/bitcoin/bitcoin/pull/21300) script: Add explanatory comment to tc.sh (dscotese)
  * [#21317](https://github.com/bitcoin/bitcoin/pull/21317) util: Make assume() usable as unary expression (MarcoFalke)
  * [#21336](https://github.com/bitcoin/bitcoin/pull/21336) Make .gitignore ignore src/test/fuzz/fuzz.exe (hebasto)
  * [#21337](https://github.com/bitcoin/bitcoin/pull/21337) guix: Update darwin native packages dependencies (hebasto)
  * [#21405](https://github.com/bitcoin/bitcoin/pull/21405) compat: remove memcpy -> memmove backwards compatibility alias (fanquake)
  * [#21418](https://github.com/bitcoin/bitcoin/pull/21418) contrib: Make systemd invoke dependencies only when ready (laanwj)
  * [#21447](https://github.com/bitcoin/bitcoin/pull/21447) Always add -daemonwait to known command line arguments (hebasto)
  * [#21471](https://github.com/bitcoin/bitcoin/pull/21471) bugfix: Fix `bech32_encode` calls in `gen_key_io_test_vectors.py` (sipa)
  * [#21615](https://github.com/bitcoin/bitcoin/pull/21615) script: Add trusted key for hebasto (hebasto)
  * [#21664](https://github.com/bitcoin/bitcoin/pull/21664) contrib: Use lief for macos and windows symbol & security checks (fanquake)
  * [#21695](https://github.com/bitcoin/bitcoin/pull/21695) contrib: Remove no longer used contrib/bitcoin-qt.pro (hebasto)
  * [#21711](https://github.com/bitcoin/bitcoin/pull/21711) guix: Add full installation and usage documentation (dongcarl)
  * [#21799](https://github.com/bitcoin/bitcoin/pull/21799) guix: Use `gcc-8` across the board (dongcarl)
  * [#21802](https://github.com/bitcoin/bitcoin/pull/21802) Avoid UB in util/asmap (advance a dereferenceable iterator outside its valid range) (MarcoFalke)
  * [#21823](https://github.com/bitcoin/bitcoin/pull/21823) script: Update reviewers (jonatack)
  * [#21850](https://github.com/bitcoin/bitcoin/pull/21850) Remove `GetDataDir(net_specific)` function (kiminuo)
  * [#21871](https://github.com/bitcoin/bitcoin/pull/21871) scripts: Add checks for minimum required os versions (fanquake)
  * [#21966](https://github.com/bitcoin/bitcoin/pull/21966) Remove double serialization; use software encoder for fee estimation (sipa)
  * [#22060](https://github.com/bitcoin/bitcoin/pull/22060) contrib: Add torv3 seed nodes for testnet, drop v2 ones (laanwj)
  * [#22244](https://github.com/bitcoin/bitcoin/pull/22244) devtools: Correctly extract symbol versions in symbol-check (laanwj)
  * [#22533](https://github.com/bitcoin/bitcoin/pull/22533) guix/build: Remove vestigial SKIPATTEST.TAG (dongcarl)
  * [#22643](https://github.com/bitcoin/bitcoin/pull/22643) guix-verify: Non-zero exit code when anything fails (dongcarl)
  * [#22654](https://github.com/bitcoin/bitcoin/pull/22654) guix: Donât include directory name in SHA256SUMS (achow101)

### Documentation

  * [#15451](https://github.com/bitcoin/bitcoin/pull/15451) clarify getdata limit after [#14897](https://github.com/bitcoin/bitcoin/pull/14897) (HashUnlimited)
  * [#15545](https://github.com/bitcoin/bitcoin/pull/15545) Explain why CheckBlock() is called before AcceptBlock (Sjors)
  * [#17350](https://github.com/bitcoin/bitcoin/pull/17350) Add developer documentation to isminetype (HAOYUatHZ)
  * [#17934](https://github.com/bitcoin/bitcoin/pull/17934) Use `CONFIG_SITE` variable instead of âprefix option (hebasto)
  * [#18030](https://github.com/bitcoin/bitcoin/pull/18030) Coin::IsSpent() can also mean never existed (Sjors)
  * [#18096](https://github.com/bitcoin/bitcoin/pull/18096) IsFinalTx comment about nSequence & `OP_CLTV` (nothingmuch)
  * [#18568](https://github.com/bitcoin/bitcoin/pull/18568) Clarify developer notes about constant naming (ryanofsky)
  * [#19961](https://github.com/bitcoin/bitcoin/pull/19961) doc: tor.md updates (jonatack)
  * [#19968](https://github.com/bitcoin/bitcoin/pull/19968) Clarify CRollingBloomFilter size estimate (robot-dreams)
  * [#20200](https://github.com/bitcoin/bitcoin/pull/20200) Rename CODEOWNERS to REVIEWERS (adamjonas)
  * [#20329](https://github.com/bitcoin/bitcoin/pull/20329) docs/descriptors.md: Remove hardened marker in the path after xpub (dgpv)
  * [#20380](https://github.com/bitcoin/bitcoin/pull/20380) Add instructions on how to fuzz the P2P layer using Honggfuzz NetDriver (practicalswift)
  * [#20414](https://github.com/bitcoin/bitcoin/pull/20414) Remove generated manual pages from master branch (laanwj)
  * [#20473](https://github.com/bitcoin/bitcoin/pull/20473) Document current boost dependency as 1.71.0 (laanwj)
  * [#20512](https://github.com/bitcoin/bitcoin/pull/20512) Add bash as an OpenBSD dependency (emilengler)
  * [#20568](https://github.com/bitcoin/bitcoin/pull/20568) Use FeeModes doc helper in estimatesmartfee (MarcoFalke)
  * [#20577](https://github.com/bitcoin/bitcoin/pull/20577) libconsensus: add missing error code description, fix NBitcoin link (theStack)
  * [#20587](https://github.com/bitcoin/bitcoin/pull/20587) Tidy up Tor doc (more stringent) (wodry)
  * [#20592](https://github.com/bitcoin/bitcoin/pull/20592) Update wtxidrelay documentation per BIP339 (jonatack)
  * [#20601](https://github.com/bitcoin/bitcoin/pull/20601) Update for FreeBSD 12.2, add GUI Build Instructions (jarolrod)
  * [#20635](https://github.com/bitcoin/bitcoin/pull/20635) fix misleading comment about call to non-existing function (pox)
  * [#20646](https://github.com/bitcoin/bitcoin/pull/20646) Refer to BIPs 339/155 in feature negotiation (jonatack)
  * [#20653](https://github.com/bitcoin/bitcoin/pull/20653) Move addr relay comment in net to correct place (MarcoFalke)
  * [#20677](https://github.com/bitcoin/bitcoin/pull/20677) Remove shouty enums in `net_processing` comments (sdaftuar)
  * [#20741](https://github.com/bitcoin/bitcoin/pull/20741) Update âSecure string handlingâ (prayank23)
  * [#20757](https://github.com/bitcoin/bitcoin/pull/20757) tor.md and -onlynet help updates (jonatack)
  * [#20829](https://github.com/bitcoin/bitcoin/pull/20829) Add -netinfo help (jonatack)
  * [#20830](https://github.com/bitcoin/bitcoin/pull/20830) Update developer notes with signet (jonatack)
  * [#20890](https://github.com/bitcoin/bitcoin/pull/20890) Add explicit macdeployqtplus dependencies install step (hebasto)
  * [#20913](https://github.com/bitcoin/bitcoin/pull/20913) Add manual page generation for bitcoin-util (laanwj)
  * [#20985](https://github.com/bitcoin/bitcoin/pull/20985) Add xorriso to macOS depends packages (fanquake)
  * [#20986](https://github.com/bitcoin/bitcoin/pull/20986) Update developer notes to discourage very long lines (jnewbery)
  * [#20987](https://github.com/bitcoin/bitcoin/pull/20987) Add instructions for generating RPC docs (ben-kaufman)
  * [#21026](https://github.com/bitcoin/bitcoin/pull/21026) Document use of make-tag script to make tags (laanwj)
  * [#21028](https://github.com/bitcoin/bitcoin/pull/21028) doc/bips: Add BIPs 43, 44, 49, and 84 (luke-jr)
  * [#21049](https://github.com/bitcoin/bitcoin/pull/21049) Add release notes for listdescriptors RPC (S3RK)
  * [#21060](https://github.com/bitcoin/bitcoin/pull/21060) More precise -debug and -debugexclude doc (wodry)
  * [#21077](https://github.com/bitcoin/bitcoin/pull/21077) Clarify -timeout and -peertimeout config options (glozow)
  * [#21105](https://github.com/bitcoin/bitcoin/pull/21105) Correctly identify script type (niftynei)
  * [#21163](https://github.com/bitcoin/bitcoin/pull/21163) Guix is shipped in Debian and Ubuntu (MarcoFalke)
  * [#21210](https://github.com/bitcoin/bitcoin/pull/21210) Rework internal and external links (MarcoFalke)
  * [#21246](https://github.com/bitcoin/bitcoin/pull/21246) Correction for VerifyTaprootCommitment comments (roconnor-blockstream)
  * [#21263](https://github.com/bitcoin/bitcoin/pull/21263) Clarify that squashing should happen before review (MarcoFalke)
  * [#21323](https://github.com/bitcoin/bitcoin/pull/21323) guix, doc: Update default HOSTS value (hebasto)
  * [#21324](https://github.com/bitcoin/bitcoin/pull/21324) Update build instructions for Fedora (hebasto)
  * [#21343](https://github.com/bitcoin/bitcoin/pull/21343) Revamp macOS build doc (jarolrod)
  * [#21346](https://github.com/bitcoin/bitcoin/pull/21346) install qt5 when building on macOS (fanquake)
  * [#21384](https://github.com/bitcoin/bitcoin/pull/21384) doc: add signet to bitcoin.conf documentation (jonatack)
  * [#21394](https://github.com/bitcoin/bitcoin/pull/21394) Improve comment about protected peers (amitiuttarwar)
  * [#21398](https://github.com/bitcoin/bitcoin/pull/21398) Update fuzzing docs for afl-clang-lto (MarcoFalke)
  * [#21444](https://github.com/bitcoin/bitcoin/pull/21444) net, doc: Doxygen updates and fixes in netbase.{h,cpp} (jonatack)
  * [#21481](https://github.com/bitcoin/bitcoin/pull/21481) Tell howto install clang-format on Debian/Ubuntu (wodry)
  * [#21567](https://github.com/bitcoin/bitcoin/pull/21567) Fix various misleading comments (glozow)
  * [#21661](https://github.com/bitcoin/bitcoin/pull/21661) Fix name of script guix-build (Emzy)
  * [#21672](https://github.com/bitcoin/bitcoin/pull/21672) Remove boostrap info from `GUIX_COMMON_FLAGS` doc (fanquake)
  * [#21688](https://github.com/bitcoin/bitcoin/pull/21688) Note on SDK for macOS depends cross-compile (jarolrod)
  * [#21709](https://github.com/bitcoin/bitcoin/pull/21709) Update reduce-memory.md and bitcoin.conf -maxconnections info (jonatack)
  * [#21710](https://github.com/bitcoin/bitcoin/pull/21710) update helps for addnode rpc and -addnode/-maxconnections config options (jonatack)
  * [#21752](https://github.com/bitcoin/bitcoin/pull/21752) Clarify that feerates are per virtual size (MarcoFalke)
  * [#21811](https://github.com/bitcoin/bitcoin/pull/21811) Remove Visual Studio 2017 reference from readme (sipsorcery)
  * [#21818](https://github.com/bitcoin/bitcoin/pull/21818) Fixup -coinstatsindex help, update bitcoin.conf and files.md (jonatack)
  * [#21856](https://github.com/bitcoin/bitcoin/pull/21856) add OSS-Fuzz section to fuzzing.md doc (adamjonas)
  * [#21912](https://github.com/bitcoin/bitcoin/pull/21912) Remove mention of priority estimation (MarcoFalke)
  * [#21925](https://github.com/bitcoin/bitcoin/pull/21925) Update bips.md for 0.21.1 (MarcoFalke)
  * [#21942](https://github.com/bitcoin/bitcoin/pull/21942) improve make with parallel jobs description (klementtan)
  * [#21947](https://github.com/bitcoin/bitcoin/pull/21947) Fix OSS-Fuzz links (MarcoFalke)
  * [#21988](https://github.com/bitcoin/bitcoin/pull/21988) note that brew installed qt is not supported (jarolrod)
  * [#22056](https://github.com/bitcoin/bitcoin/pull/22056) describe in fuzzing.md how to reproduce a CI crash (jonatack)
  * [#22080](https://github.com/bitcoin/bitcoin/pull/22080) add maxuploadtarget to bitcoin.conf example (jarolrod)
  * [#22088](https://github.com/bitcoin/bitcoin/pull/22088) Improve note on choosing posix mingw32 (jarolrod)
  * [#22109](https://github.com/bitcoin/bitcoin/pull/22109) Fix external links (IRC, â¦) (MarcoFalke)
  * [#22121](https://github.com/bitcoin/bitcoin/pull/22121) Various validation doc fixups (MarcoFalke)
  * [#22172](https://github.com/bitcoin/bitcoin/pull/22172) Update tor.md, release notes with removal of tor v2 support (jonatack)
  * [#22204](https://github.com/bitcoin/bitcoin/pull/22204) Remove obsolete `okSafeMode` RPC guideline from developer notes (theStack)
  * [#22208](https://github.com/bitcoin/bitcoin/pull/22208) Update `REVIEWERS` (practicalswift)
  * [#22250](https://github.com/bitcoin/bitcoin/pull/22250) add basic I2P documentation (vasild)
  * [#22296](https://github.com/bitcoin/bitcoin/pull/22296) Final merge of release notes snippets, mv to wiki (MarcoFalke)
  * [#22335](https://github.com/bitcoin/bitcoin/pull/22335) recommend `--disable-external-signer` in OpenBSD build guide (theStack)
  * [#22339](https://github.com/bitcoin/bitcoin/pull/22339) Document minimum required libc++ version (hebasto)
  * [#22349](https://github.com/bitcoin/bitcoin/pull/22349) Repository IRC updates (jonatack)
  * [#22360](https://github.com/bitcoin/bitcoin/pull/22360) Remove unused section from release process (MarcoFalke)
  * [#22369](https://github.com/bitcoin/bitcoin/pull/22369) Add steps for Transifex to release process (jonatack)
  * [#22393](https://github.com/bitcoin/bitcoin/pull/22393) Added info to bitcoin.conf doc (bliotti)
  * [#22402](https://github.com/bitcoin/bitcoin/pull/22402) Install Rosetta on M1-macOS for qt in depends (hebasto)
  * [#22432](https://github.com/bitcoin/bitcoin/pull/22432) Fix incorrect `testmempoolaccept` doc (glozow)
  * [#22648](https://github.com/bitcoin/bitcoin/pull/22648) doc, test: improve i2p/tor docs and i2p reachable unit tests (jonatack)
