...
Åu anki aÃ§Ä±klama, yazÄ±lÄ±m ve geliÅtiriciler hakkÄ±nda daha fazla bilgi
edinin.

ALL TOPICS

  * Belgeleme
  * GeliÅtirici topluluklarÄ±
  * Bitcoin Core katÄ±lÄ±mcÄ±larÄ±
  * Daha fazla Ã¼cretsiz yazÄ±lÄ±m projeleri

Bitcoin Ã¼cretsiz bir yazÄ±lÄ±mdÄ±r ve herhangi bir geliÅtirici projeye
katkÄ±da bulunabilir. Gerek duyacaÄÄ±nÄ±z her Åey [GitHub
havuzundadÄ±r](https://github.com/bitcoin/bitcoin). LÃ¼tfen BENÄ°OKU'daki
geliÅtirme sÃ¼recini okuyun ve takip edin, kaliteli kod saÄlayÄ±n ve bÃ¼tÃ¼n
yÃ¶nergelere uyun.

GeliÅtirme tartÄ±ÅmalarÄ± GitHub'da ve sourceforge'da [bitcoin-
geliÅtirme](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev)
e-posta listesinde gerÃ§ekleÅir. Daha az resmiyet taÅÄ±yan tartÄ±Åmalar ise
irc.freedode.net #bitcoin-dev (web ara yÃ¼zÃ¼ndedir,
[logs](http://bitcoinstats.com)).

## Belgeleme

Bitcoin'in teknik detaylarÄ±nÄ± veya var olan araÃ§ ve APIleri nasÄ±l
kullanacaÄÄ±nÄ±zÄ± Ã¶Ärenmek istiyorsanÄ±z [geliÅtirici
belgelemesini](https://developer.bitcoin.org/) okuyarak baÅlamanÄ±zÄ±
Ã¶neririz.

## GeliÅtirici topluluklarÄ±

AÅaÄÄ±daki sohbet odalarÄ± ve websiteleri Bitcoin geliÅtirmeleri hakkÄ±nda
tartÄ±Åmalara ev sahipliÄi yapmaktadÄ±r. LÃ¼tfen mesaj gÃ¶ndermeden Ã¶nce
davranÄ±Å kurallarÄ±nÄ± okuyunuz.

  * Freenode Ã¼zerinde [IRC KanalÄ± #bitcoin-dev](https://webchat.freenode.net/?channels=bitcoin-dev).
  * [Bitcoin YÄ±ÄÄ±n AlÄ±ÅveriÅi](https://bitcoin.stackexchange.com/)
  * [BitcoinTalk GeliÅimi & Teknik TartÄ±Åma Forumu](https://bitcointalk.org/index.php?board=6.0)

## Bitcoin Core katÄ±lÄ±mcÄ±larÄ±

(Teslim sayÄ±sÄ±na gÃ¶re sÄ±ralÄ±)
