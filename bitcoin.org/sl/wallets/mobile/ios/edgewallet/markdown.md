...
Gostovanje nadzora nad vaÅ¡im denarjem

Ta denarnica vam daje nadzor na vaÅ¡imi bitcoini. Hkrati pa ponudnik storitve
drÅ¾i Å¡ifrirano kopijo vaÅ¡e denarnice; to pomeni, da lahko ob morebitnem
vdoru v storitve ponudnika izgubite svoja sredstva, Äe ne uporabljate
moÄnega gesla.

Decentralizirano preverjanje

Ta denarnica se poveÅ¾e z nakljuÄnim streÅ¾nikom s seznama. To pomeni, da je
pri preverjanju plaÄil potrebnega nekaj zaupanja do tretjih oseb. Vseeno pa
ni tako varna kot polno vozliÅ¡Äe, npr. [Bitcoin Core](/sl/prenos).
...
[Namesti](https://play.google.com/store/apps/details?id=co.edgesecure.app) [
Izvorna koda](https://github.com/EdgeApp/edge-react-gui)

![screenshot](/img/screenshots/edgewalletandroid.png)

[Namesti](https://itunes.apple.com/us/app/edge-bitcoin-wallet/id1344400091) [
Izvorna koda](https://github.com/EdgeApp/edge-react-gui)
