...
Spremenljivo preverjanje

NaÄin preverjanja doloÄa programska denarnica, ki jo uporabljate s to
napravo. Prosimo, oglejte si opis naÄina preverjanja pri denarnici, ki jo
...
Ta denarnica se naloÅ¾i iz posebnega varnega okolja, ki ga nudi sama naprava.
To nudi visoko stopnjo zaÅ¡Äite proti ranljivostim raÄunalnika in zlonamerno
programsko opremo, saj v tem okolju ni mogoÄe namestiti nobene dodatne
programske opreme.

RazliÄna stopnja zasebnosti

Stopnjo zasebnosti doloÄa programska denarnica, ki jo uporabljate s to
napravo. Prosimo, oglejte si oceno zasebnosti programske denarnice, ki jo
nameravate uporabljati.
...
[ObiÅ¡Äite spletno stran](https://www.ledgerwallet.com/) [ Izvorna
koda](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
