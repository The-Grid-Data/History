...
Izvedite veÄ o trenutni specifikaciji, programski opremi in razvijalcih.
...
Bitcoin je prosta programska oprema in vsak programer lahko prispeva k
projektu. Vse potrebno je v [odlagaliÅ¡Äu na
GitHubu](https://github.com/bitcoin/bitcoin). Äe Å¾elite prispevati, prosimo,
sledite navodilom, smernicam in postopku, opisanem v datoteki README, in
stremite k visoki kvaliteti kode.

Razvojne debate potekajo na GitHubu in v skupini [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev) na
Sourceforgeu. Bolj neformalni pogovori potekajo na IRC-u na irc.freenode.net
na #bitcoin-dev (spletni vmesnik, [zgodovina](http://bitcoinstats.com)).

## Dokumentacija

Äe Å¾elite izvedeti veÄ o tehniÄnih podrobnostih bitcoina in o uporabi
obstojeÄih orodij in programskih vmesnikov (API-jev), si lahko ogledate
[dokumentacijo za razvijalce](https://developer.bitcoin.org/).

## Skupnosti razvijalcev

Spodaj je seznam klepetalnic in spletnih strani, ki gostijo debate o razvoju
bitcoina. Prosimo, da pred vkljuÄitvijo v pogovor najprej preberete njihova
pravila in pogoje za sodelovanje v debatah.

  * [IRC-kanal #bitcoin-dev](https://webchat.freenode.net/?channels=bitcoin-dev) na freenode.net.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [Bitcoin razvojne debate & Forum za tehniÄne razprave](https://bitcointalk.org/index.php?board=6.0)

## Bitcoin Core razvijalci

(RazvrÅ¡Äeno po Å¡tevilu prispevkov)
