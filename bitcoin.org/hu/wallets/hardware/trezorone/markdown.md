...
Trezor is a hardware wallet providing a high level of security without
sacrificing convenience. Unlike cold storage, Trezor is able to sign
transactions while connected to an online device. That means spending bitcoins
is secure even when using a compromised computer.
...
[TovÃ¡bb a weboldalra](https://trezor.io/) [
ForrÃ¡skÃ³d](https://github.com/trezor/trezor-firmware)
