...
Betalingsvalideringsfunktioner stilles til rÃ¥dighed af den software-tegnebog,
du bruger pÃ¥ denne enhed. Se venligst valideringsscoren for den software-
tegnebog, du planlÃ¦gger at bruge.

Basal gennemsigtighed

Specificeringen af denne tegnebog er offentlig. Dette betyder, at enhver
udvikler i verden kan lave blackbox-tests. Du er dog stadig nÃ¸dt til at stole
pÃ¥ udviklerne af denne tegnebog, fordi det ikke kan verificeres, at enheden
genererer sikre tilfÃ¦ldige seeds, og kildekoden kan ikke gennemses. Det kan
gÃ¸re det svÃ¦rere at stjÃ¦le dine bitcoin, hvis du opdaterer din enheds
firmware og genererer din egen sikre tilfÃ¦ldige seed eller bruger
multisignaturer.

Meget sikkert miljÃ¸

Denne tegnebog indlÃ¦ses fra et sikkert specialiseret miljÃ¸, der stilles til
rÃ¥dighed af enheden. Dette giver meget stÃ¦rk beskyttelse imod
computersÃ¥rbarheder og malware, da intet software kan installeres i dette
miljÃ¸.

Variabel privatlivsbeskyttelse

Funktioner til privatlivsbeskyttelse stilles til rÃ¥dighed af den software-
tegnebog, du bruger pÃ¥ denne enhed. Se venligst privatlivsscoren for den
software-tegnebog, du planlÃ¦gger at bruge.
...
[BesÃ¸g hjemmeside](https://www.ledgerwallet.com/) [
Kildekode](https://github.com/LedgerHQ/nanos-nonsecure-firmware-releases)
