...
ALL TOPICS
  ...
  * Dokumentation
  * UdviklerfÃ¦llesskaber
  * Bitcoin Core-bidragsydere
  * Flere projekter med fri software

Bitcoin er frit programmel og enhver udvikler kan bidrage til projektet. Alt
hvad du behÃ¸ver er i [GitHub-arkivet](https://github.com/bitcoin/bitcoin).
SÃ¸rg venligst for at lÃ¦se og fÃ¸lge udviklingsprocessen, der er beskrevet i
README-filen, samt at bidrage med kode i god kvalitet og at respektere alle
retningslinjer.

Diskussion om udviklingen foregÃ¥r pÃ¥ GitHub og postlisten [bitcoin-
dev](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev) hos
Sourceforge. Mindre formel diskussion on udviklen sker pÃ¥ irc.freenode.net
#bitcoin-dev (netudgave, [logbÃ¸ger](http://bitcoinstats.com)).

## Dokumentation

Hvis du er interesseret i at lÃ¦re mere om de tekniske detaljer om Bitcoin og
hvordan de eksisterende vÃ¦rktÃ¸jer og API'er kan bruges, kan det anbefales,
at du starter med at udforske
[udviklerdokumentationen](https://developer.bitcoin.org/).

## UdviklerfÃ¦llesskaber

De fÃ¸lgende chat-rum og websider indeholder diskussioner om Bitcoin-
udvikling. VÃ¦r venligst sikker pÃ¥ at lÃ¦se deres etiske regelsÃ¦t, fÃ¸r du
laver indlÃ¦g.

  * [IRC-kanal #bitcoin-dev](https://webchat.freenode.net/?channels=bitcoin-dev) pÃ¥ freenode.
  * [Bitcoin StackExchange](https://bitcoin.stackexchange.com/)
  * [BitcoinTalk diskussionsforum om udvikling og teknisk diskussion](https://bitcointalk.org/index.php?board=6.0)
