...
íì¬ ì¤ê³, ìíí¸ì¨ì´, ê°ë°ìë¤ì ëí´ ë ììë³´ê¸°

ALL TOPICS

  * ë¤íë©í ì´ì 
  * ê°ë°ì ì»¤ë®¤ëí°
  * Bitcoin Core ê¸°ì¬ìë¤
  * ê¸°í ìì ìíí¸ì¨ì´ íë¡ì í¸ë¤

ë¹í¸ì½ì¸ ê°ë°ì ì¤í ìì¤ë¡ ì§íëë©° ê°ë°ìë¼ë©´ ëêµ¬ë
íë¡ì í¸ì ê¸°ì¬í ì ììµëë¤. ëª¨ë íìí ë´ì©ì [Github
repository](https://github.com/bitcoin/bitcoin) ì¬ì´í¸ì ììµëë¤.
READMEì ê¸°ì ë ê°ë° ì ì°¨ë¥¼ ì½ê³ ë°ë¥´ë©´ì, ì¢ì íì§ì
ì½ëë¥¼ ì ê³µíê³ ëª¨ë ì§ì¹¨ì ì¤ìíìê¸° ë°ëëë¤.

ê°ë°ê´ë ¨ í ë¡ ì Githubì sourceforgeì [ë¹í¸ì½ì¸
ê°ë°](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-dev)
ë©ì¼ë§ ë¦¬ì¤í¸ìì ì´ë£¨ì´ì§ëë¤. ì¢ ë ë¹ê³µìì ì¸ í ë¡
ë¤ì irc.freenode.net #bitcoin-dev (ì¹ ì¸í°íì´ì¤,
[logs](http://bitcoinstats.com))ìì ì´ë£¨ì´ì§ëë¤.

## ë¤íë©í ì´ì 

ë¹í¸ì½ì¸ ìì¤í ì ìì¸ ê¸°ì ê³¼ íì¬ ëììë ê°ì¢ í´,
APIì ì¬ì©ë²ì ëí´ ë ìì¸í ìê³ ì¶ë¤ë©´ [ê°ë°ìì© ë¬¸ì
íì´ì§](https://developer.bitcoin.org/) íìì ì¶ì²ëë¦½ëë¤.

## ê°ë°ì ì»¤ë®¤ëí°

ë¤ìì ì±í ë°©ê³¼ ì¹ì¬ì´í¸ë ë¹í¸ì½ì¸ ê°ë°ìëí í ë¡ ì
ì´ëì´ë ëë¤. ë±ë¡íê¸° ì ì ë°ë¼ì¼íë ê·ì¹ì¬í­ë¤ì
ë°ëì ì½ì´ì£¼ìê¸° ë°ëëë¤.

  * [IRC ì±ë #bitcoin-dev](https://webchat.freenode.net/?channels=bitcoin-dev) ë¬´ë£ë ¸ë.
  * [ë¹í¸ì½ì¸ ì¤íê±°ëì](https://bitcoin.stackexchange.com/)
  * [ë¹í¸ì½ì¸í¡ ê°ë° & ê¸°ì í ë¡ í¬ë¼](https://bitcointalk.org/index.php?board=6.0)
