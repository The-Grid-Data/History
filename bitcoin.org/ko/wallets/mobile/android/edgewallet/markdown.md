...
ì´ ì§ê°ì ê·íìê² ë¹í¸ì½ì¸ ê´ë¦¬ë¥¼ ì ê³µí©ëë¤. ê·¸ë¬ë,
ì´ ìë¹ì¤ë ê·íì ì§ê°ì ìí¸í ë ë³µì¬ë³¸ì ë³´ì
í©ëë¤. ì¦, ê·íê° ê°ë ¥í ìí¸ë¥¼ ì¬ì©íì§ ìê³ ìë¹ì¤ê°
ììëë¤ë©´ ê·íì ë¹í¸ì½ì¸ì´ ëëë¹í ì ìë¤ë ê²ì
ìë¯¸í©ëë¤.

ë¶ì°í ì í¨ì± ê²ì¦

ë³¸ ì§ê°ì ëª©ë¡ìì ììì ìë²ì ì°ê²°í©ëë¤. ì¦, ê²°ì ë¥¼
íì¸í ë ì  3ìì ì ë¢°ê° ì´ëì ë íìí©ëë¤. íì§ë§,
[ë¹í¸ì½ì¸ ì½ì´](/ko/download)ì ê°ì´ í ë ¸ëë§í¼ ë³´ìì ìì
íì§ ìì ì ììµëë¤.
...
ë³¸ ì§ê°ì ìì© íë¡ê·¸ë¨ì´ íµìì ì¼ë¡ ê²©ë¦¬ë ëª¨ë°ì¼ìì
ë¡ëë©ëë¤. ëª¨ë°ì¼ì´ íµìì ì¼ë¡ ëì© ëë ë¶ì¤ì´ ë
ì½ì§ë§, ë³¸ ì§ê°ì ë©ì¨ì´ì ê´í´ìë íë¥­í ë³´í¸ ê¸°ë¥ì
ì ê³µí©ëë¤. ëª¨ë°ì¼ ìí¸í íê¸° ë° ê·íì ì§ê°ì ë°±ì
íë ê²ì ì´ë¬í ìí ë°ìì ì¤ì¬ì¤ ì ììµëë¤.
...
ì´ ìë²ë ë¹ì ì ì§ë¶ê¸ê³¼ í¨ê» ê´ë ¨ë ì ìì¼ë©°, ë¹ì ì
IPì£¼ìë¡ ë¡ê·¸ì¸í ì ìì¼ë©°, ë¹ì ì ì´ë©ì¼, ì´ë¦ ëë
ìí ê³ì¢ì²ë¼ ê°ì¸ ì ë³´ë¥¼ ì ê³µíë ê²½ì° ë¹ì ì ì¤ì  ì
ë¶ì ì ì ììµëë¤.

Torê° ì§ìëì§ ììµëë¤

ì´ ì§ê°ì ê³µê²©ì´ë ë¹ì ì ì§ë¶ê¸ê³¼ IPì£¼ìê° ê´ë
¨ëì´ìë ì¸í°ë· ìë¹ì¤ ì ê³µìë¥¼ ë§ìì£¼ë Torë¥¼ ì¬ì©í
ì ìê² í©ëë¤.
...
[ì¤ì¹](https://play.google.com/store/apps/details?id=co.edgesecure.app) [
ìì¤ ì½ë](https://github.com/EdgeApp/edge-react-gui)

![screenshot](/img/screenshots/edgewalletandroid.png)

[ì¤ì¹](https://itunes.apple.com/us/app/edge-bitcoin-wallet/id1344400091) [
ìì¤ ì½ë](https://github.com/EdgeApp/edge-react-gui)
